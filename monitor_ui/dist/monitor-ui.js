...
`)}var pb=new Ht;function cR(e){Kt._getMatrix(pb,Kt.workingColorSpace,e);let t=`mat3( ${pb.elements.map(n=>n.toFixed(4))} )`;switch(Kt.getTransfer(e)){case Ll:return[t,"LinearTransferOETF"];case re:return[t,"sRGBTransferOETF"];default:return Ut("WebGLProgram: Unsupported color space: ",e),[t,"LinearTransferOETF"]}}function mb(e,t,n){let i=e.getShaderParameter(t,e.COMPILE_STATUS),a=(e.getShaderInfoLog(t)||"").trim();if(i&&a==="")return"";let r=/ERROR: 0:(\d+)/.exec(a);if(r){let o=parseInt(r[1]);return n.toUpperCase()+`

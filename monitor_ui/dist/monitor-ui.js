...
`)+`
`+h);let _=m+g+r,S=m+h+o,A=fb(s,s.VERTEX_SHADER,_),C=fb(s,s.FRAGMENT_SHADER,S);s.attachShader(b,A),s.attachShader(b,C),n.index0AttributeName!==void 0?s.bindAttribLocation(b,0,n.index0AttributeName):n.morphTargets===!0&&s.bindAttribLocation(b,0,"position"),s.linkProgram(b);function w(R){if(e.debug.checkShaderErrors){let O=s.getProgramInfoLog(b)||"",z=s.getShaderInfoLog(A)||"",k=s.getShaderInfoLog(C)||"",G=O.trim(),V=z.trim(),B=k.trim(),tt=!0,K=!0;if(s.getProgramParameter(b,s.LINK_STATUS)===!1)if(tt=!1,typeof e.debug.onShaderError=="function")e.debug.onShaderError(s,b,A,C);else{let dt=mb(s,A,"vertex"),et=mb(s,C,"fragment");Rt("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(b,s.VALIDATE_STATUS)+`
...
}`,WR=[new H(1,0,0),new H(-1,0,0),new H(0,1,0),new H(0,-1,0),new H(0,0,1),new H(0,0,-1)],qR=[new H(0,-1,0),new H(0,-1,0),new H(0,0,1),new H(0,0,-1),new H(0,-1,0),new H(0,-1,0)],Mb=new Ue,sc=new H,Fg=new H;function YR(e,t,n){let i=new mo,s=new Qt,a=new Qt,r=new Ae,o=new wh,l=new Ch,c={},d=n.maxTextureSize,p={[gs]:Ne,[Ne]:gs,[Pi]:Pi},u=new qn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Qt},radius:{value:4}},vertexShader:kR,fragmentShader:XR}),f=u.clone();f.defines.HORIZONTAL_PASS=1;let v=new Oi;v.setAttribute("position",new kn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let b=new we(v,u),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Zl;let h=this.type;this.render=function(C,w,x){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||C.length===0)return;this.type===yS&&(Dt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Zl);let E=e.getRenderTarget(),I=e.getActiveCubeFace(),R=e.getActiveMipmapLevel(),O=e.state;O.setBlending(Bi),O.buffers.depth.getReversed()===!0?O.buffers.color.setClear(0,0,0,0):O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);let z=h!==this.type;z&&w.traverse(function(k){k.material&&(Array.isArray(k.material)?k.material.forEach(G=>G.needsUpdate=!0):k.material.needsUpdate=!0)});for(let k=0,G=C.length;k<G;k++){let V=C[k],B=V.shadow;if(B===void 0){Dt("WebGLShadowMap:",V,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;s.copy(B.mapSize);let tt=B.getFrameExtents();s.multiply(tt),a.copy(B.mapSize),(s.x>d||s.y>d)&&(s.x>d&&(a.x=Math.floor(d/tt.x),s.x=a.x*tt.x,B.mapSize.x=a.x),s.y>d&&(a.y=Math.floor(d/tt.y),s.y=a.y*tt.y,B.mapSize.y=a.y));let K=e.state.buffers.depth.getReversed();if(B.camera._reversedDepth=K,B.map===null||z===!0){if(B.map!==null&&(B.map.depthTexture!==null&&(B.map.depthTexture.dispose(),B.map.depthTexture=null),B.map.dispose()),this.type===vo){if(V.isPointLight){Dt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}B.map=new Xn(s.x,s.y,{format:Za,type:Fi,minFilter:ln,magFilter:ln,generateMipmaps:!1}),B.map.texture.name=V.name+".shadowMap",B.map.depthTexture=new ra(s.x,s.y,xi),B.map.depthTexture.name=V.name+".shadowMapDepth",B.map.depthTexture.format=Li,B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=Be,B.map.depthTexture.magFilter=Be}else V.isPointLight?(B.map=new Nd(s.x),B.map.depthTexture=new Th(s.x,yi)):(B.map=new Xn(s.x,s.y),B.map.depthTexture=new ra(s.x,s.y,yi)),B.map.depthTexture.name=V.name+".shadowMap",B.map.depthTexture.format=Li,this.type===Zl?(B.map.depthTexture.compareFunction=K?Rd:Cd,B.map.depthTexture.minFilter=ln,B.map.depthTexture.magFilter=ln):(B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=Be,B.map.depthTexture.magFilter=Be);B.camera.updateProjectionMatrix()}let dt=B.map.isWebGLCubeRenderTarget?6:1;for(let et=0;et<dt;et++){if(B.map.isWebGLCubeRenderTarget)e.setRenderTarget(B.map,et),e.clear();else{et===0&&(e.setRenderTarget(B.map),e.clear());let lt=B.getViewport(et);r.set(a.x*lt.x,a.y*lt.y,a.x*lt.z,a.y*lt.w),O.viewport(r)}if(V.isPointLight){let lt=B.camera,Ut=B.matrix,me=V.distance||lt.far;me!==lt.far&&(lt.far=me,lt.updateProjectionMatrix()),sc.setFromMatrixPosition(V.matrixWorld),lt.position.copy(sc),Fg.copy(lt.position),Fg.add(WR[et]),lt.up.copy(qR[et]),lt.lookAt(Fg),lt.updateMatrixWorld(),Ut.makeTranslation(-sc.x,-sc.y,-sc.z),Mb.multiplyMatrices(lt.projectionMatrix,lt.matrixWorldInverse),B._frustum.setFromProjectionMatrix(Mb,lt.coordinateSystem,lt.reversedDepth)}else B.updateMatrices(V);i=B.getFrustum(),S(w,x,B.camera,V,this.type)}B.isPointLightShadow!==!0&&this.type===vo&&m(B,x),B.needsUpdate=!1}h=this.type,g.needsUpdate=!1,e.setRenderTarget(E,I,R)};function m(C,w){let x=t.update(b);u.defines.VSM_SAMPLES!==C.blurSamples&&(u.defines.VSM_SAMPLES=C.blurSamples,f.defines.VSM_SAMPLES=C.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Xn(s.x,s.y,{format:Za,type:Fi})),u.uniforms.shadow_pass.value=C.map.depthTexture,u.uniforms.resolution.value=C.mapSize,u.uniforms.radius.value=C.radius,e.setRenderTarget(C.mapPass),e.clear(),e.renderBufferDirect(w,null,x,u,b,null),f.uniforms.shadow_pass.value=C.mapPass.texture,f.uniforms.resolution.value=C.mapSize,f.uniforms.radius.value=C.radius,e.setRenderTarget(C.map),e.clear(),e.renderBufferDirect(w,null,x,f,b,null)}function _(C,w,x,E){let I=null,R=x.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(R!==void 0)I=R;else if(I=x.isPointLight===!0?l:o,e.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let O=I.uuid,z=w.uuid,k=c[O];k===void 0&&(k={},c[O]=k);let G=k[z];G===void 0&&(G=I.clone(),k[z]=G,w.addEventListener("dispose",A)),I=G}if(I.visible=w.visible,I.wireframe=w.wireframe,E===vo?I.side=w.shadowSide!==null?w.shadowSide:w.side:I.side=w.shadowSide!==null?w.shadowSide:p[w.side],I.alphaMap=w.alphaMap,I.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,I.map=w.map,I.clipShadows=w.clipShadows,I.clippingPlanes=w.clippingPlanes,I.clipIntersection=w.clipIntersection,I.displacementMap=w.displacementMap,I.displacementScale=w.displacementScale,I.displacementBias=w.displacementBias,I.wireframeLinewidth=w.wireframeLinewidth,I.linewidth=w.linewidth,x.isPointLight===!0&&I.isMeshDistanceMaterial===!0){let O=e.properties.get(I);O.light=x}return I}function S(C,w,x,E,I){if(C.visible===!1)return;if(C.layers.test(w.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&I===vo)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,C.matrixWorld);let z=t.update(C),k=C.material;if(Array.isArray(k)){let G=z.groups;for(let V=0,B=G.length;V<B;V++){let tt=G[V],K=k[tt.materialIndex];if(K&&K.visible){let dt=_(C,K,E,I);C.onBeforeShadow(e,C,w,x,z,dt,tt),e.renderBufferDirect(x,null,z,dt,C,tt),C.onAfterShadow(e,C,w,x,z,dt,tt)}}}else if(k.visible){let G=_(C,k,E,I);C.onBeforeShadow(e,C,w,x,z,G,null),e.renderBufferDirect(x,null,z,G,C,null),C.onAfterShadow(e,C,w,x,z,G,null)}}let O=C.children;for(let z=0,k=O.length;z<k;z++)S(O[z],w,x,E,I)}function A(C){C.target.removeEventListener("dispose",A);for(let x in c){let E=c[x],I=C.target.uuid;I in E&&(E[I].dispose(),delete E[I])}}}function ZR(e,t){function n(){let U=!1,rt=new Ae,it=null,mt=new Ae(0,0,0,0);return{setMask:function($){it!==$&&!U&&(e.colorMask($,$,$,$),it=$)},setLocked:function($){U=$},setClear:function($,W,_t,Lt,ve){ve===!0&&($*=Lt,W*=Lt,_t*=Lt),rt.set($,W,_t,Lt),mt.equals(rt)===!1&&(e.clearColor($,W,_t,Lt),mt.copy(rt))},reset:function(){U=!1,it=null,mt.set(-1,0,0,0)}}}function i(){let U=!1,rt=!1,it=null,mt=null,$=null;return{setReversed:function(W){if(rt!==W){let _t=t.get("EXT_clip_control");W?_t.clipControlEXT(_t.LOWER_LEFT_EXT,_t.ZERO_TO_ONE_EXT):_t.clipControlEXT(_t.LOWER_LEFT_EXT,_t.NEGATIVE_ONE_TO_ONE_EXT),rt=W;let Lt=$;$=null,this.setClear(Lt)}},getReversed:function(){return rt},setTest:function(W){W?st(e.DEPTH_TEST):ot(e.DEPTH_TEST)},setMask:function(W){it!==W&&!U&&(e.depthMask(W),it=W)},setFunc:function(W){if(rt&&(W=QS[W]),mt!==W){switch(W){case ch:e.depthFunc(e.NEVER);break;case uh:e.depthFunc(e.ALWAYS);break;case hh:e.depthFunc(e.LESS);break;case Wa:e.depthFunc(e.LEQUAL);break;case dh:e.depthFunc(e.EQUAL);break;case fh:e.depthFunc(e.GEQUAL);break;case ph:e.depthFunc(e.GREATER);break;case mh:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}mt=W}},setLocked:function(W){U=W},setClear:function(W){$!==W&&($=W,rt&&(W=1-W),e.clearDepth(W))},reset:function(){U=!1,it=null,mt=null,$=null,rt=!1}}}function s(){let U=!1,rt=null,it=null,mt=null,$=null,W=null,_t=null,Lt=null,ve=null;return{setTest:function(se){U||(se?st(e.STENCIL_TEST):ot(e.STENCIL_TEST))},setMask:function(se){rt!==se&&!U&&(e.stencilMask(se),rt=se)},setFunc:function(se,Hi,Gi){(it!==se||mt!==Hi||$!==Gi)&&(e.stencilFunc(se,Hi,Gi),it=se,mt=Hi,$=Gi)},setOp:function(se,Hi,Gi){(W!==se||_t!==Hi||Lt!==Gi)&&(e.stencilOp(se,Hi,Gi),W=se,_t=Hi,Lt=Gi)},setLocked:function(se){U=se},setClear:function(se){ve!==se&&(e.clearStencil(se),ve=se)},reset:function(){U=!1,rt=null,it=null,mt=null,$=null,W=null,_t=null,Lt=null,ve=null}}}let a=new n,r=new i,o=new s,l=new WeakMap,c=new WeakMap,d={},p={},u=new WeakMap,f=[],v=null,b=!1,g=null,h=null,m=null,_=null,S=null,A=null,C=null,w=new kt(0,0,0),x=0,E=!1,I=null,R=null,O=null,z=null,k=null,G=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS),V=!1,B=0,tt=e.getParameter(e.VERSION);tt.indexOf("WebGL")!==-1?(B=parseFloat(/^WebGL (\d)/.exec(tt)[1]),V=B>=1):tt.indexOf("OpenGL ES")!==-1&&(B=parseFloat(/^OpenGL ES (\d)/.exec(tt)[1]),V=B>=2);let K=null,dt={},et=e.getParameter(e.SCISSOR_BOX),lt=e.getParameter(e.VIEWPORT),Ut=new Ae().fromArray(et),me=new Ae().fromArray(lt);function he(U,rt,it,mt){let $=new Uint8Array(4),W=e.createTexture();e.bindTexture(U,W),e.texParameteri(U,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(U,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let _t=0;_t<it;_t++)U===e.TEXTURE_3D||U===e.TEXTURE_2D_ARRAY?e.texImage3D(rt,0,e.RGBA,1,1,mt,0,e.RGBA,e.UNSIGNED_BYTE,$):e.texImage2D(rt+_t,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,$);return W}let Z={};Z[e.TEXTURE_2D]=he(e.TEXTURE_2D,e.TEXTURE_2D,1),Z[e.TEXTURE_CUBE_MAP]=he(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[e.TEXTURE_2D_ARRAY]=he(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),Z[e.TEXTURE_3D]=he(e.TEXTURE_3D,e.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),st(e.DEPTH_TEST),r.setFunc(Wa),Vt(!1),Le(og),st(e.CULL_FACE),ie(Bi);function st(U){d[U]!==!0&&(e.enable(U),d[U]=!0)}function ot(U){d[U]!==!1&&(e.disable(U),d[U]=!1)}function Ft(U,rt){return p[U]!==rt?(e.bindFramebuffer(U,rt),p[U]=rt,U===e.DRAW_FRAMEBUFFER&&(p[e.FRAMEBUFFER]=rt),U===e.FRAMEBUFFER&&(p[e.DRAW_FRAMEBUFFER]=rt),!0):!1}function At(U,rt){let it=f,mt=!1;if(U){it=u.get(rt),it===void 0&&(it=[],u.set(rt,it));let $=U.textures;if(it.length!==$.length||it[0]!==e.COLOR_ATTACHMENT0){for(let W=0,_t=$.length;W<_t;W++)it[W]=e.COLOR_ATTACHMENT0+W;it.length=$.length,mt=!0}}else it[0]!==e.BACK&&(it[0]=e.BACK,mt=!0);mt&&e.drawBuffers(it)}function Nt(U){return v!==U?(e.useProgram(U),v=U,!0):!1}let Ze={[ia]:e.FUNC_ADD,[SS]:e.FUNC_SUBTRACT,[bS]:e.FUNC_REVERSE_SUBTRACT};Ze[MS]=e.MIN,Ze[ES]=e.MAX;let jt={[TS]:e.ZERO,[AS]:e.ONE,[wS]:e.SRC_COLOR,[oh]:e.SRC_ALPHA,[LS]:e.SRC_ALPHA_SATURATE,[US]:e.DST_COLOR,[RS]:e.DST_ALPHA,[CS]:e.ONE_MINUS_SRC_COLOR,[lh]:e.ONE_MINUS_SRC_ALPHA,[NS]:e.ONE_MINUS_DST_COLOR,[DS]:e.ONE_MINUS_DST_ALPHA,[IS]:e.CONSTANT_COLOR,[OS]:e.ONE_MINUS_CONSTANT_COLOR,[PS]:e.CONSTANT_ALPHA,[BS]:e.ONE_MINUS_CONSTANT_ALPHA};function ie(U,rt,it,mt,$,W,_t,Lt,ve,se){if(U===Bi){b===!0&&(ot(e.BLEND),b=!1);return}if(b===!1&&(st(e.BLEND),b=!0),U!==xS){if(U!==g||se!==E){if((h!==ia||S!==ia)&&(e.blendEquation(e.FUNC_ADD),h=ia,S=ia),se)switch(U){case Xa:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case lg:e.blendFunc(e.ONE,e.ONE);break;case cg:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case ug:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:Rt("WebGLState: Invalid blending: ",U);break}else switch(U){case Xa:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case lg:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case cg:Rt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ug:Rt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Rt("WebGLState: Invalid blending: ",U);break}m=null,_=null,A=null,C=null,w.set(0,0,0),x=0,g=U,E=se}return}$=$||rt,W=W||it,_t=_t||mt,(rt!==h||$!==S)&&(e.blendEquationSeparate(Ze[rt],Ze[$]),h=rt,S=$),(it!==m||mt!==_||W!==A||_t!==C)&&(e.blendFuncSeparate(jt[it],jt[mt],jt[W],jt[_t]),m=it,_=mt,A=W,C=_t),(Lt.equals(w)===!1||ve!==x)&&(e.blendColor(Lt.r,Lt.g,Lt.b,ve),w.copy(Lt),x=ve),g=U,E=!1}function de(U,rt){U.side===Pi?ot(e.CULL_FACE):st(e.CULL_FACE);let it=U.side===Ne;rt&&(it=!it),Vt(it),U.blending===Xa&&U.transparent===!1?ie(Bi):ie(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),r.setFunc(U.depthFunc),r.setTest(U.depthTest),r.setMask(U.depthWrite),a.setMask(U.colorWrite);let mt=U.stencilWrite;o.setTest(mt),mt&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),Fe(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?st(e.SAMPLE_ALPHA_TO_COVERAGE):ot(e.SAMPLE_ALPHA_TO_COVERAGE)}function Vt(U){I!==U&&(U?e.frontFace(e.CW):e.frontFace(e.CCW),I=U)}function Le(U){U!==vS?(st(e.CULL_FACE),U!==R&&(U===og?e.cullFace(e.BACK):U===_S?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):ot(e.CULL_FACE),R=U}function D(U){U!==O&&(V&&e.lineWidth(U),O=U)}function Fe(U,rt,it){U?(st(e.POLYGON_OFFSET_FILL),(z!==rt||k!==it)&&(z=rt,k=it,r.getReversed()&&(rt=-rt),e.polygonOffset(rt,it))):ot(e.POLYGON_OFFSET_FILL)}function ee(U){U?st(e.SCISSOR_TEST):ot(e.SCISSOR_TEST)}function ge(U){U===void 0&&(U=e.TEXTURE0+G-1),K!==U&&(e.activeTexture(U),K=U)}function St(U,rt,it){it===void 0&&(K===null?it=e.TEXTURE0+G-1:it=K);let mt=dt[it];mt===void 0&&(mt={type:void 0,texture:void 0},dt[it]=mt),(mt.type!==U||mt.texture!==rt)&&(K!==it&&(e.activeTexture(it),K=it),e.bindTexture(U,rt||Z[U]),mt.type=U,mt.texture=rt)}function T(){let U=dt[K];U!==void 0&&U.type!==void 0&&(e.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function y(){try{e.compressedTexImage2D(...arguments)}catch(U){Rt("WebGLState:",U)}}function N(){try{e.compressedTexImage3D(...arguments)}catch(U){Rt("WebGLState:",U)}}function Y(){try{e.texSubImage2D(...arguments)}catch(U){Rt("WebGLState:",U)}}function j(){try{e.texSubImage3D(...arguments)}catch(U){Rt("WebGLState:",U)}}function q(){try{e.compressedTexSubImage2D(...arguments)}catch(U){Rt("WebGLState:",U)}}function gt(){try{e.compressedTexSubImage3D(...arguments)}catch(U){Rt("WebGLState:",U)}}function at(){try{e.texStorage2D(...arguments)}catch(U){Rt("WebGLState:",U)}}function Tt(){try{e.texStorage3D(...arguments)}catch(U){Rt("WebGLState:",U)}}function wt(){try{e.texImage2D(...arguments)}catch(U){Rt("WebGLState:",U)}}function Q(){try{e.texImage3D(...arguments)}catch(U){Rt("WebGLState:",U)}}function nt(U){Ut.equals(U)===!1&&(e.scissor(U.x,U.y,U.z,U.w),Ut.copy(U))}function vt(U){me.equals(U)===!1&&(e.viewport(U.x,U.y,U.z,U.w),me.copy(U))}function yt(U,rt){let it=c.get(rt);it===void 0&&(it=new WeakMap,c.set(rt,it));let mt=it.get(U);mt===void 0&&(mt=e.getUniformBlockIndex(rt,U.name),it.set(U,mt))}function ft(U,rt){let mt=c.get(rt).get(U);l.get(rt)!==mt&&(e.uniformBlockBinding(rt,mt,U.__bindingPointIndex),l.set(rt,mt))}function Ht(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),r.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),d={},K=null,dt={},p={},u=new WeakMap,f=[],v=null,b=!1,g=null,h=null,m=null,_=null,S=null,A=null,C=null,w=new kt(0,0,0),x=0,E=!1,I=null,R=null,O=null,z=null,k=null,Ut.set(0,0,e.canvas.width,e.canvas.height),me.set(0,0,e.canvas.width,e.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:st,disable:ot,bindFramebuffer:Ft,drawBuffers:At,useProgram:Nt,setBlending:ie,setMaterial:de,setFlipSided:Vt,setCullFace:Le,setLineWidth:D,setPolygonOffset:Fe,setScissorTest:ee,activeTexture:ge,bindTexture:St,unbindTexture:T,compressedTexImage2D:y,compressedTexImage3D:N,texImage2D:wt,texImage3D:Q,updateUBOMapping:yt,uniformBlockBinding:ft,texStorage2D:at,texStorage3D:Tt,texSubImage2D:Y,texSubImage3D:j,compressedTexSubImage2D:q,compressedTexSubImage3D:gt,scissor:nt,viewport:vt,reset:Ht}}function JR(e,t,n,i,s,a,r){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Qt,d=new WeakMap,p,u=new WeakMap,f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(T,y){return f?new OffscreenCanvas(T,y):lo("canvas")}function b(T,y,N){let Y=1,j=St(T);if((j.width>N||j.height>N)&&(Y=N/Math.max(j.width,j.height)),Y<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){let q=Math.floor(Y*j.width),gt=Math.floor(Y*j.height);p===void 0&&(p=v(q,gt));let at=y?v(q,gt):p;return at.width=q,at.height=gt,at.getContext("2d").drawImage(T,0,0,q,gt),Dt("WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+q+"x"+gt+")."),at}else return"data"in T&&Dt("WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),T;return T}function g(T){return T.generateMipmaps}function h(T){e.generateMipmap(T)}function m(T){return T.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?e.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function _(T,y,N,Y,j=!1){if(T!==null){if(e[T]!==void 0)return e[T];Dt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let q=y;if(y===e.RED&&(N===e.FLOAT&&(q=e.R32F),N===e.HALF_FLOAT&&(q=e.R16F),N===e.UNSIGNED_BYTE&&(q=e.R8)),y===e.RED_INTEGER&&(N===e.UNSIGNED_BYTE&&(q=e.R8UI),N===e.UNSIGNED_SHORT&&(q=e.R16UI),N===e.UNSIGNED_INT&&(q=e.R32UI),N===e.BYTE&&(q=e.R8I),N===e.SHORT&&(q=e.R16I),N===e.INT&&(q=e.R32I)),y===e.RG&&(N===e.FLOAT&&(q=e.RG32F),N===e.HALF_FLOAT&&(q=e.RG16F),N===e.UNSIGNED_BYTE&&(q=e.RG8)),y===e.RG_INTEGER&&(N===e.UNSIGNED_BYTE&&(q=e.RG8UI),N===e.UNSIGNED_SHORT&&(q=e.RG16UI),N===e.UNSIGNED_INT&&(q=e.RG32UI),N===e.BYTE&&(q=e.RG8I),N===e.SHORT&&(q=e.RG16I),N===e.INT&&(q=e.RG32I)),y===e.RGB_INTEGER&&(N===e.UNSIGNED_BYTE&&(q=e.RGB8UI),N===e.UNSIGNED_SHORT&&(q=e.RGB16UI),N===e.UNSIGNED_INT&&(q=e.RGB32UI),N===e.BYTE&&(q=e.RGB8I),N===e.SHORT&&(q=e.RGB16I),N===e.INT&&(q=e.RGB32I)),y===e.RGBA_INTEGER&&(N===e.UNSIGNED_BYTE&&(q=e.RGBA8UI),N===e.UNSIGNED_SHORT&&(q=e.RGBA16UI),N===e.UNSIGNED_INT&&(q=e.RGBA32UI),N===e.BYTE&&(q=e.RGBA8I),N===e.SHORT&&(q=e.RGBA16I),N===e.INT&&(q=e.RGBA32I)),y===e.RGB&&(N===e.UNSIGNED_INT_5_9_9_9_REV&&(q=e.RGB9_E5),N===e.UNSIGNED_INT_10F_11F_11F_REV&&(q=e.R11F_G11F_B10F)),y===e.RGBA){let gt=j?Nl:Jt.getTransfer(Y);N===e.FLOAT&&(q=e.RGBA32F),N===e.HALF_FLOAT&&(q=e.RGBA16F),N===e.UNSIGNED_BYTE&&(q=gt===ne?e.SRGB8_ALPHA8:e.RGBA8),N===e.UNSIGNED_SHORT_4_4_4_4&&(q=e.RGBA4),N===e.UNSIGNED_SHORT_5_5_5_1&&(q=e.RGB5_A1)}return(q===e.R16F||q===e.R32F||q===e.RG16F||q===e.RG32F||q===e.RGBA16F||q===e.RGBA32F)&&t.get("EXT_color_buffer_float"),q}function S(T,y){let N;return T?y===null||y===yi||y===yo?N=e.DEPTH24_STENCIL8:y===xi?N=e.DEPTH32F_STENCIL8:y===_o&&(N=e.DEPTH24_STENCIL8,Dt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===yi||y===yo?N=e.DEPTH_COMPONENT24:y===xi?N=e.DEPTH_COMPONENT32F:y===_o&&(N=e.DEPTH_COMPONENT16),N}function A(T,y){return g(T)===!0||T.isFramebufferTexture&&T.minFilter!==Be&&T.minFilter!==ln?Math.log2(Math.max(y.width,y.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?y.mipmaps.length:1}function C(T){let y=T.target;y.removeEventListener("dispose",C),x(y),y.isVideoTexture&&d.delete(y)}function w(T){let y=T.target;y.removeEventListener("dispose",w),I(y)}function x(T){let y=i.get(T);if(y.__webglInit===void 0)return;let N=T.source,Y=u.get(N);if(Y){let j=Y[y.__cacheKey];j.usedTimes--,j.usedTimes===0&&E(T),Object.keys(Y).length===0&&u.delete(N)}i.remove(T)}function E(T){let y=i.get(T);e.deleteTexture(y.__webglTexture);let N=T.source,Y=u.get(N);delete Y[y.__cacheKey],r.memory.textures--}function I(T){let y=i.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),i.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(y.__webglFramebuffer[Y]))for(let j=0;j<y.__webglFramebuffer[Y].length;j++)e.deleteFramebuffer(y.__webglFramebuffer[Y][j]);else e.deleteFramebuffer(y.__webglFramebuffer[Y]);y.__webglDepthbuffer&&e.deleteRenderbuffer(y.__webglDepthbuffer[Y])}else{if(Array.isArray(y.__webglFramebuffer))for(let Y=0;Y<y.__webglFramebuffer.length;Y++)e.deleteFramebuffer(y.__webglFramebuffer[Y]);else e.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&e.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&e.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let Y=0;Y<y.__webglColorRenderbuffer.length;Y++)y.__webglColorRenderbuffer[Y]&&e.deleteRenderbuffer(y.__webglColorRenderbuffer[Y]);y.__webglDepthRenderbuffer&&e.deleteRenderbuffer(y.__webglDepthRenderbuffer)}let N=T.textures;for(let Y=0,j=N.length;Y<j;Y++){let q=i.get(N[Y]);q.__webglTexture&&(e.deleteTexture(q.__webglTexture),r.memory.textures--),i.remove(N[Y])}i.remove(T)}let R=0;function O(){R=0}function z(){let T=R;return T>=s.maxTextures&&Dt("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),R+=1,T}function k(T){let y=[];return y.push(T.wrapS),y.push(T.wrapT),y.push(T.wrapR||0),y.push(T.magFilter),y.push(T.minFilter),y.push(T.anisotropy),y.push(T.internalFormat),y.push(T.format),y.push(T.type),y.push(T.generateMipmaps),y.push(T.premultiplyAlpha),y.push(T.flipY),y.push(T.unpackAlignment),y.push(T.colorSpace),y.join()}function G(T,y){let N=i.get(T);if(T.isVideoTexture&&ee(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&N.__version!==T.version){let Y=T.image;if(Y===null)Dt("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Dt("WebGLRenderer: Texture marked for update but image is incomplete");else{Z(N,T,y);return}}else T.isExternalTexture&&(N.__webglTexture=T.sourceTexture?T.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,N.__webglTexture,e.TEXTURE0+y)}function V(T,y){let N=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&N.__version!==T.version){Z(N,T,y);return}else T.isExternalTexture&&(N.__webglTexture=T.sourceTexture?T.sourceTexture:null);n.bindTexture(e.TEXTURE_2D_ARRAY,N.__webglTexture,e.TEXTURE0+y)}function B(T,y){let N=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&N.__version!==T.version){Z(N,T,y);return}n.bindTexture(e.TEXTURE_3D,N.__webglTexture,e.TEXTURE0+y)}function tt(T,y){let N=i.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&N.__version!==T.version){st(N,T,y);return}n.bindTexture(e.TEXTURE_CUBE_MAP,N.__webglTexture,e.TEXTURE0+y)}let K={[gh]:e.REPEAT,[Ni]:e.CLAMP_TO_EDGE,[vh]:e.MIRRORED_REPEAT},dt={[Be]:e.NEAREST,[VS]:e.NEAREST_MIPMAP_NEAREST,[Kl]:e.NEAREST_MIPMAP_LINEAR,[ln]:e.LINEAR,[kh]:e.LINEAR_MIPMAP_NEAREST,[da]:e.LINEAR_MIPMAP_LINEAR},et={[kS]:e.NEVER,[ZS]:e.ALWAYS,[XS]:e.LESS,[Cd]:e.LEQUAL,[WS]:e.EQUAL,[Rd]:e.GEQUAL,[qS]:e.GREATER,[YS]:e.NOTEQUAL};function lt(T,y){if(y.type===xi&&t.has("OES_texture_float_linear")===!1&&(y.magFilter===ln||y.magFilter===kh||y.magFilter===Kl||y.magFilter===da||y.minFilter===ln||y.minFilter===kh||y.minFilter===Kl||y.minFilter===da)&&Dt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(T,e.TEXTURE_WRAP_S,K[y.wrapS]),e.texParameteri(T,e.TEXTURE_WRAP_T,K[y.wrapT]),(T===e.TEXTURE_3D||T===e.TEXTURE_2D_ARRAY)&&e.texParameteri(T,e.TEXTURE_WRAP_R,K[y.wrapR]),e.texParameteri(T,e.TEXTURE_MAG_FILTER,dt[y.magFilter]),e.texParameteri(T,e.TEXTURE_MIN_FILTER,dt[y.minFilter]),y.compareFunction&&(e.texParameteri(T,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(T,e.TEXTURE_COMPARE_FUNC,et[y.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===Be||y.minFilter!==Kl&&y.minFilter!==da||y.type===xi&&t.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||i.get(y).__currentAnisotropy){let N=t.get("EXT_texture_filter_anisotropic");e.texParameterf(T,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,s.getMaxAnisotropy())),i.get(y).__currentAnisotropy=y.anisotropy}}}function Ut(T,y){let N=!1;T.__webglInit===void 0&&(T.__webglInit=!0,y.addEventListener("dispose",C));let Y=y.source,j=u.get(Y);j===void 0&&(j={},u.set(Y,j));let q=k(y);if(q!==T.__cacheKey){j[q]===void 0&&(j[q]={texture:e.createTexture(),usedTimes:0},r.memory.textures++,N=!0),j[q].usedTimes++;let gt=j[T.__cacheKey];gt!==void 0&&(j[T.__cacheKey].usedTimes--,gt.usedTimes===0&&E(y)),T.__cacheKey=q,T.__webglTexture=j[q].texture}return N}function me(T,y,N){return Math.floor(Math.floor(T/N)/y)}function he(T,y,N,Y){let q=T.updateRanges;if(q.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,y.width,y.height,N,Y,y.data);else{q.sort((Q,nt)=>Q.start-nt.start);let gt=0;for(let Q=1;Q<q.length;Q++){let nt=q[gt],vt=q[Q],yt=nt.start+nt.count,ft=me(vt.start,y.width,4),Ht=me(nt.start,y.width,4);vt.start<=yt+1&&ft===Ht&&me(vt.start+vt.count-1,y.width,4)===ft?nt.count=Math.max(nt.count,vt.start+vt.count-nt.start):(++gt,q[gt]=vt)}q.length=gt+1;let at=e.getParameter(e.UNPACK_ROW_LENGTH),Tt=e.getParameter(e.UNPACK_SKIP_PIXELS),wt=e.getParameter(e.UNPACK_SKIP_ROWS);e.pixelStorei(e.UNPACK_ROW_LENGTH,y.width);for(let Q=0,nt=q.length;Q<nt;Q++){let vt=q[Q],yt=Math.floor(vt.start/4),ft=Math.ceil(vt.count/4),Ht=yt%y.width,U=Math.floor(yt/y.width),rt=ft,it=1;e.pixelStorei(e.UNPACK_SKIP_PIXELS,Ht),e.pixelStorei(e.UNPACK_SKIP_ROWS,U),n.texSubImage2D(e.TEXTURE_2D,0,Ht,U,rt,it,N,Y,y.data)}T.clearUpdateRanges(),e.pixelStorei(e.UNPACK_ROW_LENGTH,at),e.pixelStorei(e.UNPACK_SKIP_PIXELS,Tt),e.pixelStorei(e.UNPACK_SKIP_ROWS,wt)}}function Z(T,y,N){let Y=e.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(Y=e.TEXTURE_2D_ARRAY),y.isData3DTexture&&(Y=e.TEXTURE_3D);let j=Ut(T,y),q=y.source;n.bindTexture(Y,T.__webglTexture,e.TEXTURE0+N);let gt=i.get(q);if(q.version!==gt.__version||j===!0){n.activeTexture(e.TEXTURE0+N);let at=Jt.getPrimaries(Jt.workingColorSpace),Tt=y.colorSpace===_s?null:Jt.getPrimaries(y.colorSpace),wt=y.colorSpace===_s||at===Tt?e.NONE:e.BROWSER_DEFAULT_WEBGL;e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,y.flipY),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),e.pixelStorei(e.UNPACK_ALIGNMENT,y.unpackAlignment),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,wt);let Q=b(y.image,!1,s.maxTextureSize);Q=ge(y,Q);let nt=a.convert(y.format,y.colorSpace),vt=a.convert(y.type),yt=_(y.internalFormat,nt,vt,y.colorSpace,y.isVideoTexture);lt(Y,y);let ft,Ht=y.mipmaps,U=y.isVideoTexture!==!0,rt=gt.__version===void 0||j===!0,it=q.dataReady,mt=A(y,Q);if(y.isDepthTexture)yt=S(y.format===fa,y.type),rt&&(U?n.texStorage2D(e.TEXTURE_2D,1,yt,Q.width,Q.height):n.texImage2D(e.TEXTURE_2D,0,yt,Q.width,Q.height,0,nt,vt,null));else if(y.isDataTexture)if(Ht.length>0){U&&rt&&n.texStorage2D(e.TEXTURE_2D,mt,yt,Ht[0].width,Ht[0].height);for(let $=0,W=Ht.length;$<W;$++)ft=Ht[$],U?it&&n.texSubImage2D(e.TEXTURE_2D,$,0,0,ft.width,ft.height,nt,vt,ft.data):n.texImage2D(e.TEXTURE_2D,$,yt,ft.width,ft.height,0,nt,vt,ft.data);y.generateMipmaps=!1}else U?(rt&&n.texStorage2D(e.TEXTURE_2D,mt,yt,Q.width,Q.height),it&&he(y,Q,nt,vt)):n.texImage2D(e.TEXTURE_2D,0,yt,Q.width,Q.height,0,nt,vt,Q.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){U&&rt&&n.texStorage3D(e.TEXTURE_2D_ARRAY,mt,yt,Ht[0].width,Ht[0].height,Q.depth);for(let $=0,W=Ht.length;$<W;$++)if(ft=Ht[$],y.format!==oi)if(nt!==null)if(U){if(it)if(y.layerUpdates.size>0){let _t=Ng(ft.width,ft.height,y.format,y.type);for(let Lt of y.layerUpdates){let ve=ft.data.subarray(Lt*_t/ft.data.BYTES_PER_ELEMENT,(Lt+1)*_t/ft.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,$,0,0,Lt,ft.width,ft.height,1,nt,ve)}y.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,$,0,0,0,ft.width,ft.height,Q.depth,nt,ft.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,$,yt,ft.width,ft.height,Q.depth,0,ft.data,0,0);else Dt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else U?it&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,$,0,0,0,ft.width,ft.height,Q.depth,nt,vt,ft.data):n.texImage3D(e.TEXTURE_2D_ARRAY,$,yt,ft.width,ft.height,Q.depth,0,nt,vt,ft.data)}else{U&&rt&&n.texStorage2D(e.TEXTURE_2D,mt,yt,Ht[0].width,Ht[0].height);for(let $=0,W=Ht.length;$<W;$++)ft=Ht[$],y.format!==oi?nt!==null?U?it&&n.compressedTexSubImage2D(e.TEXTURE_2D,$,0,0,ft.width,ft.height,nt,ft.data):n.compressedTexImage2D(e.TEXTURE_2D,$,yt,ft.width,ft.height,0,ft.data):Dt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?it&&n.texSubImage2D(e.TEXTURE_2D,$,0,0,ft.width,ft.height,nt,vt,ft.data):n.texImage2D(e.TEXTURE_2D,$,yt,ft.width,ft.height,0,nt,vt,ft.data)}else if(y.isDataArrayTexture)if(U){if(rt&&n.texStorage3D(e.TEXTURE_2D_ARRAY,mt,yt,Q.width,Q.height,Q.depth),it)if(y.layerUpdates.size>0){let $=Ng(Q.width,Q.height,y.format,y.type);for(let W of y.layerUpdates){let _t=Q.data.subarray(W*$/Q.data.BYTES_PER_ELEMENT,(W+1)*$/Q.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,W,Q.width,Q.height,1,nt,vt,_t)}y.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,nt,vt,Q.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,yt,Q.width,Q.height,Q.depth,0,nt,vt,Q.data);else if(y.isData3DTexture)U?(rt&&n.texStorage3D(e.TEXTURE_3D,mt,yt,Q.width,Q.height,Q.depth),it&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,nt,vt,Q.data)):n.texImage3D(e.TEXTURE_3D,0,yt,Q.width,Q.height,Q.depth,0,nt,vt,Q.data);else if(y.isFramebufferTexture){if(rt)if(U)n.texStorage2D(e.TEXTURE_2D,mt,yt,Q.width,Q.height);else{let $=Q.width,W=Q.height;for(let _t=0;_t<mt;_t++)n.texImage2D(e.TEXTURE_2D,_t,yt,$,W,0,nt,vt,null),$>>=1,W>>=1}}else if(Ht.length>0){if(U&&rt){let $=St(Ht[0]);n.texStorage2D(e.TEXTURE_2D,mt,yt,$.width,$.height)}for(let $=0,W=Ht.length;$<W;$++)ft=Ht[$],U?it&&n.texSubImage2D(e.TEXTURE_2D,$,0,0,nt,vt,ft):n.texImage2D(e.TEXTURE_2D,$,yt,nt,vt,ft);y.generateMipmaps=!1}else if(U){if(rt){let $=St(Q);n.texStorage2D(e.TEXTURE_2D,mt,yt,$.width,$.height)}it&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,nt,vt,Q)}else n.texImage2D(e.TEXTURE_2D,0,yt,nt,vt,Q);g(y)&&h(Y),gt.__version=q.version,y.onUpdate&&y.onUpdate(y)}T.__version=y.version}function st(T,y,N){if(y.image.length!==6)return;let Y=Ut(T,y),j=y.source;n.bindTexture(e.TEXTURE_CUBE_MAP,T.__webglTexture,e.TEXTURE0+N);let q=i.get(j);if(j.version!==q.__version||Y===!0){n.activeTexture(e.TEXTURE0+N);let gt=Jt.getPrimaries(Jt.workingColorSpace),at=y.colorSpace===_s?null:Jt.getPrimaries(y.colorSpace),Tt=y.colorSpace===_s||gt===at?e.NONE:e.BROWSER_DEFAULT_WEBGL;e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,y.flipY),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),e.pixelStorei(e.UNPACK_ALIGNMENT,y.unpackAlignment),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,Tt);let wt=y.isCompressedTexture||y.image[0].isCompressedTexture,Q=y.image[0]&&y.image[0].isDataTexture,nt=[];for(let W=0;W<6;W++)!wt&&!Q?nt[W]=b(y.image[W],!0,s.maxCubemapSize):nt[W]=Q?y.image[W].image:y.image[W],nt[W]=ge(y,nt[W]);let vt=nt[0],yt=a.convert(y.format,y.colorSpace),ft=a.convert(y.type),Ht=_(y.internalFormat,yt,ft,y.colorSpace),U=y.isVideoTexture!==!0,rt=q.__version===void 0||Y===!0,it=j.dataReady,mt=A(y,vt);lt(e.TEXTURE_CUBE_MAP,y);let $;if(wt){U&&rt&&n.texStorage2D(e.TEXTURE_CUBE_MAP,mt,Ht,vt.width,vt.height);for(let W=0;W<6;W++){$=nt[W].mipmaps;for(let _t=0;_t<$.length;_t++){let Lt=$[_t];y.format!==oi?yt!==null?U?it&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,_t,0,0,Lt.width,Lt.height,yt,Lt.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,_t,Ht,Lt.width,Lt.height,0,Lt.data):Dt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?it&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,_t,0,0,Lt.width,Lt.height,yt,ft,Lt.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,_t,Ht,Lt.width,Lt.height,0,yt,ft,Lt.data)}}}else{if($=y.mipmaps,U&&rt){$.length>0&&mt++;let W=St(nt[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,mt,Ht,W.width,W.height)}for(let W=0;W<6;W++)if(Q){U?it&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,0,0,0,nt[W].width,nt[W].height,yt,ft,nt[W].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,0,Ht,nt[W].width,nt[W].height,0,yt,ft,nt[W].data);for(let _t=0;_t<$.length;_t++){let ve=$[_t].image[W].image;U?it&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,_t+1,0,0,ve.width,ve.height,yt,ft,ve.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,_t+1,Ht,ve.width,ve.height,0,yt,ft,ve.data)}}else{U?it&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,0,0,0,yt,ft,nt[W]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,0,Ht,yt,ft,nt[W]);for(let _t=0;_t<$.length;_t++){let Lt=$[_t];U?it&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,_t+1,0,0,yt,ft,Lt.image[W]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,_t+1,Ht,yt,ft,Lt.image[W])}}}g(y)&&h(e.TEXTURE_CUBE_MAP),q.__version=j.version,y.onUpdate&&y.onUpdate(y)}T.__version=y.version}function ot(T,y,N,Y,j,q){let gt=a.convert(N.format,N.colorSpace),at=a.convert(N.type),Tt=_(N.internalFormat,gt,at,N.colorSpace),wt=i.get(y),Q=i.get(N);if(Q.__renderTarget=y,!wt.__hasExternalTextures){let nt=Math.max(1,y.width>>q),vt=Math.max(1,y.height>>q);j===e.TEXTURE_3D||j===e.TEXTURE_2D_ARRAY?n.texImage3D(j,q,Tt,nt,vt,y.depth,0,gt,at,null):n.texImage2D(j,q,Tt,nt,vt,0,gt,at,null)}n.bindFramebuffer(e.FRAMEBUFFER,T),Fe(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,Y,j,Q.__webglTexture,0,D(y)):(j===e.TEXTURE_2D||j>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,Y,j,Q.__webglTexture,q),n.bindFramebuffer(e.FRAMEBUFFER,null)}function Ft(T,y,N){if(e.bindRenderbuffer(e.RENDERBUFFER,T),y.depthBuffer){let Y=y.depthTexture,j=Y&&Y.isDepthTexture?Y.type:null,q=S(y.stencilBuffer,j),gt=y.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;Fe(y)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,D(y),q,y.width,y.height):N?e.renderbufferStorageMultisample(e.RENDERBUFFER,D(y),q,y.width,y.height):e.renderbufferStorage(e.RENDERBUFFER,q,y.width,y.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,gt,e.RENDERBUFFER,T)}else{let Y=y.textures;for(let j=0;j<Y.length;j++){let q=Y[j],gt=a.convert(q.format,q.colorSpace),at=a.convert(q.type),Tt=_(q.internalFormat,gt,at,q.colorSpace);Fe(y)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,D(y),Tt,y.width,y.height):N?e.renderbufferStorageMultisample(e.RENDERBUFFER,D(y),Tt,y.width,y.height):e.renderbufferStorage(e.RENDERBUFFER,Tt,y.width,y.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function At(T,y,N){let Y=y.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(e.FRAMEBUFFER,T),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let j=i.get(y.depthTexture);if(j.__renderTarget=y,(!j.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),Y){if(j.__webglInit===void 0&&(j.__webglInit=!0,y.depthTexture.addEventListener("dispose",C)),j.__webglTexture===void 0){j.__webglTexture=e.createTexture(),n.bindTexture(e.TEXTURE_CUBE_MAP,j.__webglTexture),lt(e.TEXTURE_CUBE_MAP,y.depthTexture);let wt=a.convert(y.depthTexture.format),Q=a.convert(y.depthTexture.type),nt;y.depthTexture.format===Li?nt=e.DEPTH_COMPONENT24:y.depthTexture.format===fa&&(nt=e.DEPTH24_STENCIL8);for(let vt=0;vt<6;vt++)e.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+vt,0,nt,y.width,y.height,0,wt,Q,null)}}else G(y.depthTexture,0);let q=j.__webglTexture,gt=D(y),at=Y?e.TEXTURE_CUBE_MAP_POSITIVE_X+N:e.TEXTURE_2D,Tt=y.depthTexture.format===fa?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;if(y.depthTexture.format===Li)Fe(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,Tt,at,q,0,gt):e.framebufferTexture2D(e.FRAMEBUFFER,Tt,at,q,0);else if(y.depthTexture.format===fa)Fe(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,Tt,at,q,0,gt):e.framebufferTexture2D(e.FRAMEBUFFER,Tt,at,q,0);else throw new Error("Unknown depthTexture format")}function Nt(T){let y=i.get(T),N=T.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==T.depthTexture){let Y=T.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),Y){let j=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,Y.removeEventListener("dispose",j)};Y.addEventListener("dispose",j),y.__depthDisposeCallback=j}y.__boundDepthTexture=Y}if(T.depthTexture&&!y.__autoAllocateDepthBuffer)if(N)for(let Y=0;Y<6;Y++)At(y.__webglFramebuffer[Y],T,Y);else{let Y=T.texture.mipmaps;Y&&Y.length>0?At(y.__webglFramebuffer[0],T,0):At(y.__webglFramebuffer,T,0)}else if(N){y.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer[Y]),y.__webglDepthbuffer[Y]===void 0)y.__webglDepthbuffer[Y]=e.createRenderbuffer(),Ft(y.__webglDepthbuffer[Y],T,!1);else{let j=T.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,q=y.__webglDepthbuffer[Y];e.bindRenderbuffer(e.RENDERBUFFER,q),e.framebufferRenderbuffer(e.FRAMEBUFFER,j,e.RENDERBUFFER,q)}}else{let Y=T.texture.mipmaps;if(Y&&Y.length>0?n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=e.createRenderbuffer(),Ft(y.__webglDepthbuffer,T,!1);else{let j=T.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,q=y.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,q),e.framebufferRenderbuffer(e.FRAMEBUFFER,j,e.RENDERBUFFER,q)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function Ze(T,y,N){let Y=i.get(T);y!==void 0&&ot(Y.__webglFramebuffer,T,T.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),N!==void 0&&Nt(T)}function jt(T){let y=T.texture,N=i.get(T),Y=i.get(y);T.addEventListener("dispose",w);let j=T.textures,q=T.isWebGLCubeRenderTarget===!0,gt=j.length>1;if(gt||(Y.__webglTexture===void 0&&(Y.__webglTexture=e.createTexture()),Y.__version=y.version,r.memory.textures++),q){N.__webglFramebuffer=[];for(let at=0;at<6;at++)if(y.mipmaps&&y.mipmaps.length>0){N.__webglFramebuffer[at]=[];for(let Tt=0;Tt<y.mipmaps.length;Tt++)N.__webglFramebuffer[at][Tt]=e.createFramebuffer()}else N.__webglFramebuffer[at]=e.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){N.__webglFramebuffer=[];for(let at=0;at<y.mipmaps.length;at++)N.__webglFramebuffer[at]=e.createFramebuffer()}else N.__webglFramebuffer=e.createFramebuffer();if(gt)for(let at=0,Tt=j.length;at<Tt;at++){let wt=i.get(j[at]);wt.__webglTexture===void 0&&(wt.__webglTexture=e.createTexture(),r.memory.textures++)}if(T.samples>0&&Fe(T)===!1){N.__webglMultisampledFramebuffer=e.createFramebuffer(),N.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let at=0;at<j.length;at++){let Tt=j[at];N.__webglColorRenderbuffer[at]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,N.__webglColorRenderbuffer[at]);let wt=a.convert(Tt.format,Tt.colorSpace),Q=a.convert(Tt.type),nt=_(Tt.internalFormat,wt,Q,Tt.colorSpace,T.isXRRenderTarget===!0),vt=D(T);e.renderbufferStorageMultisample(e.RENDERBUFFER,vt,nt,T.width,T.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+at,e.RENDERBUFFER,N.__webglColorRenderbuffer[at])}e.bindRenderbuffer(e.RENDERBUFFER,null),T.depthBuffer&&(N.__webglDepthRenderbuffer=e.createRenderbuffer(),Ft(N.__webglDepthRenderbuffer,T,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(q){n.bindTexture(e.TEXTURE_CUBE_MAP,Y.__webglTexture),lt(e.TEXTURE_CUBE_MAP,y);for(let at=0;at<6;at++)if(y.mipmaps&&y.mipmaps.length>0)for(let Tt=0;Tt<y.mipmaps.length;Tt++)ot(N.__webglFramebuffer[at][Tt],T,y,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+at,Tt);else ot(N.__webglFramebuffer[at],T,y,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+at,0);g(y)&&h(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(gt){for(let at=0,Tt=j.length;at<Tt;at++){let wt=j[at],Q=i.get(wt),nt=e.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(nt=T.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(nt,Q.__webglTexture),lt(nt,wt),ot(N.__webglFramebuffer,T,wt,e.COLOR_ATTACHMENT0+at,nt,0),g(wt)&&h(nt)}n.unbindTexture()}else{let at=e.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(at=T.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(at,Y.__webglTexture),lt(at,y),y.mipmaps&&y.mipmaps.length>0)for(let Tt=0;Tt<y.mipmaps.length;Tt++)ot(N.__webglFramebuffer[Tt],T,y,e.COLOR_ATTACHMENT0,at,Tt);else ot(N.__webglFramebuffer,T,y,e.COLOR_ATTACHMENT0,at,0);g(y)&&h(at),n.unbindTexture()}T.depthBuffer&&Nt(T)}function ie(T){let y=T.textures;for(let N=0,Y=y.length;N<Y;N++){let j=y[N];if(g(j)){let q=m(T),gt=i.get(j).__webglTexture;n.bindTexture(q,gt),h(q),n.unbindTexture()}}}let de=[],Vt=[];function Le(T){if(T.samples>0){if(Fe(T)===!1){let y=T.textures,N=T.width,Y=T.height,j=e.COLOR_BUFFER_BIT,q=T.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,gt=i.get(T),at=y.length>1;if(at)for(let wt=0;wt<y.length;wt++)n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+wt,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+wt,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,gt.__webglMultisampledFramebuffer);let Tt=T.texture.mipmaps;Tt&&Tt.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglFramebuffer);for(let wt=0;wt<y.length;wt++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(j|=e.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(j|=e.STENCIL_BUFFER_BIT)),at){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,gt.__webglColorRenderbuffer[wt]);let Q=i.get(y[wt]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,Q,0)}e.blitFramebuffer(0,0,N,Y,0,0,N,Y,j,e.NEAREST),l===!0&&(de.length=0,Vt.length=0,de.push(e.COLOR_ATTACHMENT0+wt),T.depthBuffer&&T.resolveDepthBuffer===!1&&(de.push(q),Vt.push(q),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,Vt)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,de))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),at)for(let wt=0;wt<y.length;wt++){n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+wt,e.RENDERBUFFER,gt.__webglColorRenderbuffer[wt]);let Q=i.get(y[wt]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+wt,e.TEXTURE_2D,Q,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){let y=T.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[y])}}}function D(T){return Math.min(s.maxSamples,T.samples)}function Fe(T){let y=i.get(T);return T.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function ee(T){let y=r.render.frame;d.get(T)!==y&&(d.set(T,y),T.update())}function ge(T,y){let N=T.colorSpace,Y=T.format,j=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||N!==qa&&N!==_s&&(Jt.getTransfer(N)===ne?(Y!==oi||j!==Rn)&&Dt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Rt("WebGLTextures: Unsupported texture color space:",N)),y}function St(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=z,this.resetTextureUnits=O,this.setTexture2D=G,this.setTexture2DArray=V,this.setTexture3D=B,this.setTextureCube=tt,this.rebindTextures=Ze,this.setupRenderTarget=jt,this.updateRenderTargetMipmap=ie,this.updateMultisampleRenderTarget=Le,this.setupDepthRenderbuffer=Nt,this.setupFrameBufferTexture=ot,this.useMultisampledRTT=Fe,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function jR(e,t){function n(i,s=_s){let a,r=Jt.getTransfer(s);if(i===Rn)return e.UNSIGNED_BYTE;if(i===Wh)return e.UNSIGNED_SHORT_4_4_4_4;if(i===qh)return e.UNSIGNED_SHORT_5_5_5_1;if(i===Sg)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===bg)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===yg)return e.BYTE;if(i===xg)return e.SHORT;if(i===_o)return e.UNSIGNED_SHORT;if(i===Xh)return e.INT;if(i===yi)return e.UNSIGNED_INT;if(i===xi)return e.FLOAT;if(i===Fi)return e.HALF_FLOAT;if(i===Mg)return e.ALPHA;if(i===Eg)return e.RGB;if(i===oi)return e.RGBA;if(i===Li)return e.DEPTH_COMPONENT;if(i===fa)return e.DEPTH_STENCIL;if(i===Tg)return e.RED;if(i===Yh)return e.RED_INTEGER;if(i===Za)return e.RG;if(i===Zh)return e.RG_INTEGER;if(i===Jh)return e.RGBA_INTEGER;if(i===Ql||i===$l||i===tc||i===ec)if(r===ne)if(a=t.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===Ql)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===$l)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===tc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ec)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=t.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===Ql)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===$l)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===tc)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ec)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===jh||i===Kh||i===Qh||i===$h)if(a=t.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===jh)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Kh)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Qh)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===$h)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===td||i===ed||i===nd||i===id||i===sd||i===ad||i===rd)if(a=t.get("WEBGL_compressed_texture_etc"),a!==null){if(i===td||i===ed)return r===ne?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===nd)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(i===id)return a.COMPRESSED_R11_EAC;if(i===sd)return a.COMPRESSED_SIGNED_R11_EAC;if(i===ad)return a.COMPRESSED_RG11_EAC;if(i===rd)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===od||i===ld||i===cd||i===ud||i===hd||i===dd||i===fd||i===pd||i===md||i===gd||i===vd||i===_d||i===yd||i===xd)if(a=t.get("WEBGL_compressed_texture_astc"),a!==null){if(i===od)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ld)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===cd)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ud)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===hd)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===dd)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===fd)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===pd)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===md)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===gd)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===vd)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===_d)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===yd)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===xd)return r===ne?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Sd||i===bd||i===Md)if(a=t.get("EXT_texture_compression_bptc"),a!==null){if(i===Sd)return r===ne?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===bd)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Md)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Ed||i===Td||i===Ad||i===wd)if(a=t.get("EXT_texture_compression_rgtc"),a!==null){if(i===Ed)return a.COMPRESSED_RED_RGTC1_EXT;if(i===Td)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Ad)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===wd)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===yo?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}var KR=`
void main() {
...
}`,qg=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,n){if(this.texture===null){let i=new Vl(t.texture);(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){let n=t.cameras[0].viewport,i=new qn({vertexShader:KR,fragmentShader:QR,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new we(new oa(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Yg=class extends vs{constructor(t,n){super();let i=this,s=null,a=1,r=null,o="local-floor",l=1,c=null,d=null,p=null,u=null,f=null,v=null,b=typeof XRWebGLBinding<"u",g=new qg,h={},m=n.getContextAttributes(),_=null,S=null,A=[],C=[],w=new Qt,x=null,E=new on;E.viewport=new Ae;let I=new on;I.viewport=new Ae;let R=[E,I],O=new Vh,z=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let st=A[Z];return st===void 0&&(st=new ho,A[Z]=st),st.getTargetRaySpace()},this.getControllerGrip=function(Z){let st=A[Z];return st===void 0&&(st=new ho,A[Z]=st),st.getGripSpace()},this.getHand=function(Z){let st=A[Z];return st===void 0&&(st=new ho,A[Z]=st),st.getHandSpace()};function G(Z){let st=C.indexOf(Z.inputSource);if(st===-1)return;let ot=A[st];ot!==void 0&&(ot.update(Z.inputSource,Z.frame,c||r),ot.dispatchEvent({type:Z.type,data:Z.inputSource}))}function V(){s.removeEventListener("select",G),s.removeEventListener("selectstart",G),s.removeEventListener("selectend",G),s.removeEventListener("squeeze",G),s.removeEventListener("squeezestart",G),s.removeEventListener("squeezeend",G),s.removeEventListener("end",V),s.removeEventListener("inputsourceschange",B);for(let Z=0;Z<A.length;Z++){let st=C[Z];st!==null&&(C[Z]=null,A[Z].disconnect(st))}z=null,k=null,g.reset();for(let Z in h)delete h[Z];t.setRenderTarget(_),f=null,u=null,p=null,s=null,S=null,he.stop(),i.isPresenting=!1,t.setPixelRatio(x),t.setSize(w.width,w.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){a=Z,i.isPresenting===!0&&Dt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,i.isPresenting===!0&&Dt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||r},this.setReferenceSpace=function(Z){c=Z},this.getBaseLayer=function(){return u!==null?u:f},this.getBinding=function(){return p===null&&b&&(p=new XRWebGLBinding(s,n)),p},this.getFrame=function(){return v},this.getSession=function(){return s},this.setSession=async function(Z){if(s=Z,s!==null){if(_=t.getRenderTarget(),s.addEventListener("select",G),s.addEventListener("selectstart",G),s.addEventListener("selectend",G),s.addEventListener("squeeze",G),s.addEventListener("squeezestart",G),s.addEventListener("squeezeend",G),s.addEventListener("end",V),s.addEventListener("inputsourceschange",B),m.xrCompatible!==!0&&await n.makeXRCompatible(),x=t.getPixelRatio(),t.getSize(w),b&&"createProjectionLayer"in XRWebGLBinding.prototype){let ot=null,Ft=null,At=null;m.depth&&(At=m.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,ot=m.stencil?fa:Li,Ft=m.stencil?yo:yi);let Nt={colorFormat:n.RGBA8,depthFormat:At,scaleFactor:a};p=this.getBinding(),u=p.createProjectionLayer(Nt),s.updateRenderState({layers:[u]}),t.setPixelRatio(1),t.setSize(u.textureWidth,u.textureHeight,!1),S=new Xn(u.textureWidth,u.textureHeight,{format:oi,type:Rn,depthTexture:new ra(u.textureWidth,u.textureHeight,Ft,void 0,void 0,void 0,void 0,void 0,void 0,ot),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{let ot={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:a};f=new XRWebGLLayer(s,n,ot),s.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),S=new Xn(f.framebufferWidth,f.framebufferHeight,{format:oi,type:Rn,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(l),c=null,r=await s.requestReferenceSpace(o),he.setContext(s),he.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function B(Z){for(let st=0;st<Z.removed.length;st++){let ot=Z.removed[st],Ft=C.indexOf(ot);Ft>=0&&(C[Ft]=null,A[Ft].disconnect(ot))}for(let st=0;st<Z.added.length;st++){let ot=Z.added[st],Ft=C.indexOf(ot);if(Ft===-1){for(let Nt=0;Nt<A.length;Nt++)if(Nt>=C.length){C.push(ot),Ft=Nt;break}else if(C[Nt]===null){C[Nt]=ot,Ft=Nt;break}if(Ft===-1)break}let At=A[Ft];At&&At.connect(ot)}}let tt=new H,K=new H;function dt(Z,st,ot){tt.setFromMatrixPosition(st.matrixWorld),K.setFromMatrixPosition(ot.matrixWorld);let Ft=tt.distanceTo(K),At=st.projectionMatrix.elements,Nt=ot.projectionMatrix.elements,Ze=At[14]/(At[10]-1),jt=At[14]/(At[10]+1),ie=(At[9]+1)/At[5],de=(At[9]-1)/At[5],Vt=(At[8]-1)/At[0],Le=(Nt[8]+1)/Nt[0],D=Ze*Vt,Fe=Ze*Le,ee=Ft/(-Vt+Le),ge=ee*-Vt;if(st.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(ge),Z.translateZ(ee),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),At[10]===-1)Z.projectionMatrix.copy(st.projectionMatrix),Z.projectionMatrixInverse.copy(st.projectionMatrixInverse);else{let St=Ze+ee,T=jt+ee,y=D-ge,N=Fe+(Ft-ge),Y=ie*jt/T*St,j=de*jt/T*St;Z.projectionMatrix.makePerspective(y,N,Y,j,St,T),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function et(Z,st){st===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(st.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(s===null)return;let st=Z.near,ot=Z.far;g.texture!==null&&(g.depthNear>0&&(st=g.depthNear),g.depthFar>0&&(ot=g.depthFar)),O.near=I.near=E.near=st,O.far=I.far=E.far=ot,(z!==O.near||k!==O.far)&&(s.updateRenderState({depthNear:O.near,depthFar:O.far}),z=O.near,k=O.far),O.layers.mask=Z.layers.mask|6,E.layers.mask=O.layers.mask&-5,I.layers.mask=O.layers.mask&-3;let Ft=Z.parent,At=O.cameras;et(O,Ft);for(let Nt=0;Nt<At.length;Nt++)et(At[Nt],Ft);At.length===2?dt(O,E,I):O.projectionMatrix.copy(E.projectionMatrix),lt(Z,O,Ft)};function lt(Z,st,ot){ot===null?Z.matrix.copy(st.matrixWorld):(Z.matrix.copy(ot.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(st.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(st.projectionMatrix),Z.projectionMatrixInverse.copy(st.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=yh*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return O},this.getFoveation=function(){if(!(u===null&&f===null))return l},this.setFoveation=function(Z){l=Z,u!==null&&(u.fixedFoveation=Z),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=Z)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(O)},this.getCameraTexture=function(Z){return h[Z]};let Ut=null;function me(Z,st){if(d=st.getViewerPose(c||r),v=st,d!==null){let ot=d.views;f!==null&&(t.setRenderTargetFramebuffer(S,f.framebuffer),t.setRenderTarget(S));let Ft=!1;ot.length!==O.cameras.length&&(O.cameras.length=0,Ft=!0);for(let jt=0;jt<ot.length;jt++){let ie=ot[jt],de=null;if(f!==null)de=f.getViewport(ie);else{let Le=p.getViewSubImage(u,ie);de=Le.viewport,jt===0&&(t.setRenderTargetTextures(S,Le.colorTexture,Le.depthStencilTexture),t.setRenderTarget(S))}let Vt=R[jt];Vt===void 0&&(Vt=new on,Vt.layers.enable(jt),Vt.viewport=new Ae,R[jt]=Vt),Vt.matrix.fromArray(ie.transform.matrix),Vt.matrix.decompose(Vt.position,Vt.quaternion,Vt.scale),Vt.projectionMatrix.fromArray(ie.projectionMatrix),Vt.projectionMatrixInverse.copy(Vt.projectionMatrix).invert(),Vt.viewport.set(de.x,de.y,de.width,de.height),jt===0&&(O.matrix.copy(Vt.matrix),O.matrix.decompose(O.position,O.quaternion,O.scale)),Ft===!0&&O.cameras.push(Vt)}let At=s.enabledFeatures;if(At&&At.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&b){p=i.getBinding();let jt=p.getDepthInformation(ot[0]);jt&&jt.isValid&&jt.texture&&g.init(jt,s.renderState)}if(At&&At.includes("camera-access")&&b){t.state.unbindTexture(),p=i.getBinding();for(let jt=0;jt<ot.length;jt++){let ie=ot[jt].camera;if(ie){let de=h[ie];de||(de=new Vl,h[ie]=de);let Vt=p.getCameraImage(ie);de.sourceTexture=Vt}}}}for(let ot=0;ot<A.length;ot++){let Ft=C[ot],At=A[ot];Ft!==null&&At!==void 0&&At.update(Ft,st,c||r)}Ut&&Ut(Z,st),st.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:st}),v=null}let he=new Eb;he.setAnimationLoop(me),this.setAnimationLoop=function(Z){Ut=Z},this.dispose=function(){}}},Ka=new gi,$R=new Ue;function t2(e,t){function n(g,h){g.matrixAutoUpdate===!0&&g.updateMatrix(),h.value.copy(g.matrix)}function i(g,h){h.color.getRGB(g.fogColor.value,Rg(e)),h.isFog?(g.fogNear.value=h.near,g.fogFar.value=h.far):h.isFogExp2&&(g.fogDensity.value=h.density)}function s(g,h,m,_,S){h.isMeshBasicMaterial?a(g,h):h.isMeshLambertMaterial?(a(g,h),h.envMap&&(g.envMapIntensity.value=h.envMapIntensity)):h.isMeshToonMaterial?(a(g,h),p(g,h)):h.isMeshPhongMaterial?(a(g,h),d(g,h),h.envMap&&(g.envMapIntensity.value=h.envMapIntensity)):h.isMeshStandardMaterial?(a(g,h),u(g,h),h.isMeshPhysicalMaterial&&f(g,h,S)):h.isMeshMatcapMaterial?(a(g,h),v(g,h)):h.isMeshDepthMaterial?a(g,h):h.isMeshDistanceMaterial?(a(g,h),b(g,h)):h.isMeshNormalMaterial?a(g,h):h.isLineBasicMaterial?(r(g,h),h.isLineDashedMaterial&&o(g,h)):h.isPointsMaterial?l(g,h,m,_):h.isSpriteMaterial?c(g,h):h.isShadowMaterial?(g.color.value.copy(h.color),g.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function a(g,h){g.opacity.value=h.opacity,h.color&&g.diffuse.value.copy(h.color),h.emissive&&g.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(g.map.value=h.map,n(h.map,g.mapTransform)),h.alphaMap&&(g.alphaMap.value=h.alphaMap,n(h.alphaMap,g.alphaMapTransform)),h.bumpMap&&(g.bumpMap.value=h.bumpMap,n(h.bumpMap,g.bumpMapTransform),g.bumpScale.value=h.bumpScale,h.side===Ne&&(g.bumpScale.value*=-1)),h.normalMap&&(g.normalMap.value=h.normalMap,n(h.normalMap,g.normalMapTransform),g.normalScale.value.copy(h.normalScale),h.side===Ne&&g.normalScale.value.negate()),h.displacementMap&&(g.displacementMap.value=h.displacementMap,n(h.displacementMap,g.displacementMapTransform),g.displacementScale.value=h.displacementScale,g.displacementBias.value=h.displacementBias),h.emissiveMap&&(g.emissiveMap.value=h.emissiveMap,n(h.emissiveMap,g.emissiveMapTransform)),h.specularMap&&(g.specularMap.value=h.specularMap,n(h.specularMap,g.specularMapTransform)),h.alphaTest>0&&(g.alphaTest.value=h.alphaTest);let m=t.get(h),_=m.envMap,S=m.envMapRotation;_&&(g.envMap.value=_,Ka.copy(S),Ka.x*=-1,Ka.y*=-1,Ka.z*=-1,_.isCubeTexture&&_.isRenderTargetTexture===!1&&(Ka.y*=-1,Ka.z*=-1),g.envMapRotation.value.setFromMatrix4($R.makeRotationFromEuler(Ka)),g.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,g.reflectivity.value=h.reflectivity,g.ior.value=h.ior,g.refractionRatio.value=h.refractionRatio),h.lightMap&&(g.lightMap.value=h.lightMap,g.lightMapIntensity.value=h.lightMapIntensity,n(h.lightMap,g.lightMapTransform)),h.aoMap&&(g.aoMap.value=h.aoMap,g.aoMapIntensity.value=h.aoMapIntensity,n(h.aoMap,g.aoMapTransform))}function r(g,h){g.diffuse.value.copy(h.color),g.opacity.value=h.opacity,h.map&&(g.map.value=h.map,n(h.map,g.mapTransform))}function o(g,h){g.dashSize.value=h.dashSize,g.totalSize.value=h.dashSize+h.gapSize,g.scale.value=h.scale}function l(g,h,m,_){g.diffuse.value.copy(h.color),g.opacity.value=h.opacity,g.size.value=h.size*m,g.scale.value=_*.5,h.map&&(g.map.value=h.map,n(h.map,g.uvTransform)),h.alphaMap&&(g.alphaMap.value=h.alphaMap,n(h.alphaMap,g.alphaMapTransform)),h.alphaTest>0&&(g.alphaTest.value=h.alphaTest)}function c(g,h){g.diffuse.value.copy(h.color),g.opacity.value=h.opacity,g.rotation.value=h.rotation,h.map&&(g.map.value=h.map,n(h.map,g.mapTransform)),h.alphaMap&&(g.alphaMap.value=h.alphaMap,n(h.alphaMap,g.alphaMapTransform)),h.alphaTest>0&&(g.alphaTest.value=h.alphaTest)}function d(g,h){g.specular.value.copy(h.specular),g.shininess.value=Math.max(h.shininess,1e-4)}function p(g,h){h.gradientMap&&(g.gradientMap.value=h.gradientMap)}function u(g,h){g.metalness.value=h.metalness,h.metalnessMap&&(g.metalnessMap.value=h.metalnessMap,n(h.metalnessMap,g.metalnessMapTransform)),g.roughness.value=h.roughness,h.roughnessMap&&(g.roughnessMap.value=h.roughnessMap,n(h.roughnessMap,g.roughnessMapTransform)),h.envMap&&(g.envMapIntensity.value=h.envMapIntensity)}function f(g,h,m){g.ior.value=h.ior,h.sheen>0&&(g.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),g.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(g.sheenColorMap.value=h.sheenColorMap,n(h.sheenColorMap,g.sheenColorMapTransform)),h.sheenRoughnessMap&&(g.sheenRoughnessMap.value=h.sheenRoughnessMap,n(h.sheenRoughnessMap,g.sheenRoughnessMapTransform))),h.clearcoat>0&&(g.clearcoat.value=h.clearcoat,g.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(g.clearcoatMap.value=h.clearcoatMap,n(h.clearcoatMap,g.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,n(h.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(g.clearcoatNormalMap.value=h.clearcoatNormalMap,n(h.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Ne&&g.clearcoatNormalScale.value.negate())),h.dispersion>0&&(g.dispersion.value=h.dispersion),h.iridescence>0&&(g.iridescence.value=h.iridescence,g.iridescenceIOR.value=h.iridescenceIOR,g.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(g.iridescenceMap.value=h.iridescenceMap,n(h.iridescenceMap,g.iridescenceMapTransform)),h.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=h.iridescenceThicknessMap,n(h.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),h.transmission>0&&(g.transmission.value=h.transmission,g.transmissionSamplerMap.value=m.texture,g.transmissionSamplerSize.value.set(m.width,m.height),h.transmissionMap&&(g.transmissionMap.value=h.transmissionMap,n(h.transmissionMap,g.transmissionMapTransform)),g.thickness.value=h.thickness,h.thicknessMap&&(g.thicknessMap.value=h.thicknessMap,n(h.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=h.attenuationDistance,g.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(g.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(g.anisotropyMap.value=h.anisotropyMap,n(h.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=h.specularIntensity,g.specularColor.value.copy(h.specularColor),h.specularColorMap&&(g.specularColorMap.value=h.specularColorMap,n(h.specularColorMap,g.specularColorMapTransform)),h.specularIntensityMap&&(g.specularIntensityMap.value=h.specularIntensityMap,n(h.specularIntensityMap,g.specularIntensityMapTransform))}function v(g,h){h.matcap&&(g.matcap.value=h.matcap)}function b(g,h){let m=t.get(h).light;g.referencePosition.value.setFromMatrixPosition(m.matrixWorld),g.nearDistance.value=m.shadow.camera.near,g.farDistance.value=m.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function e2(e,t,n,i){let s={},a={},r=[],o=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function l(m,_){let S=_.program;i.uniformBlockBinding(m,S)}function c(m,_){let S=s[m.id];S===void 0&&(v(m),S=d(m),s[m.id]=S,m.addEventListener("dispose",g));let A=_.program;i.updateUBOMapping(m,A);let C=t.render.frame;a[m.id]!==C&&(u(m),a[m.id]=C)}function d(m){let _=p();m.__bindingPointIndex=_;let S=e.createBuffer(),A=m.__size,C=m.usage;return e.bindBuffer(e.UNIFORM_BUFFER,S),e.bufferData(e.UNIFORM_BUFFER,A,C),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,_,S),S}function p(){for(let m=0;m<o;m++)if(r.indexOf(m)===-1)return r.push(m),m;return Rt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(m){let _=s[m.id],S=m.uniforms,A=m.__cache;e.bindBuffer(e.UNIFORM_BUFFER,_);for(let C=0,w=S.length;C<w;C++){let x=Array.isArray(S[C])?S[C]:[S[C]];for(let E=0,I=x.length;E<I;E++){let R=x[E];if(f(R,C,E,A)===!0){let O=R.__offset,z=Array.isArray(R.value)?R.value:[R.value],k=0;for(let G=0;G<z.length;G++){let V=z[G],B=b(V);typeof V=="number"||typeof V=="boolean"?(R.__data[0]=V,e.bufferSubData(e.UNIFORM_BUFFER,O+k,R.__data)):V.isMatrix3?(R.__data[0]=V.elements[0],R.__data[1]=V.elements[1],R.__data[2]=V.elements[2],R.__data[3]=0,R.__data[4]=V.elements[3],R.__data[5]=V.elements[4],R.__data[6]=V.elements[5],R.__data[7]=0,R.__data[8]=V.elements[6],R.__data[9]=V.elements[7],R.__data[10]=V.elements[8],R.__data[11]=0):(V.toArray(R.__data,k),k+=B.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,O,R.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function f(m,_,S,A){let C=m.value,w=_+"_"+S;if(A[w]===void 0)return typeof C=="number"||typeof C=="boolean"?A[w]=C:A[w]=C.clone(),!0;{let x=A[w];if(typeof C=="number"||typeof C=="boolean"){if(x!==C)return A[w]=C,!0}else if(x.equals(C)===!1)return x.copy(C),!0}return!1}function v(m){let _=m.uniforms,S=0,A=16;for(let w=0,x=_.length;w<x;w++){let E=Array.isArray(_[w])?_[w]:[_[w]];for(let I=0,R=E.length;I<R;I++){let O=E[I],z=Array.isArray(O.value)?O.value:[O.value];for(let k=0,G=z.length;k<G;k++){let V=z[k],B=b(V),tt=S%A,K=tt%B.boundary,dt=tt+K;S+=K,dt!==0&&A-dt<B.storage&&(S+=A-dt),O.__data=new Float32Array(B.storage/Float32Array.BYTES_PER_ELEMENT),O.__offset=S,S+=B.storage}}}let C=S%A;return C>0&&(S+=A-C),m.__size=S,m.__cache={},this}function b(m){let _={boundary:0,storage:0};return typeof m=="number"||typeof m=="boolean"?(_.boundary=4,_.storage=4):m.isVector2?(_.boundary=8,_.storage=8):m.isVector3||m.isColor?(_.boundary=16,_.storage=12):m.isVector4?(_.boundary=16,_.storage=16):m.isMatrix3?(_.boundary=48,_.storage=48):m.isMatrix4?(_.boundary=64,_.storage=64):m.isTexture?Dt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Dt("WebGLRenderer: Unsupported uniform value type.",m),_}function g(m){let _=m.target;_.removeEventListener("dispose",g);let S=r.indexOf(_.__bindingPointIndex);r.splice(S,1),e.deleteBuffer(s[_.id]),delete s[_.id],delete a[_.id]}function h(){for(let m in s)e.deleteBuffer(s[m]);r=[],s={},a={}}return{bind:l,update:c,dispose:h}}var n2=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),zi=null;function i2(){return zi===null&&(zi=new Eh(n2,16,16,Za,Fi),zi.name="DFG_LUT",zi.minFilter=ln,zi.magFilter=ln,zi.wrapS=Ni,zi.wrapT=Ni,zi.generateMipmaps=!1,zi.needsUpdate=!0),zi}var Ld=class{constructor(t={}){let{canvas:n=JS(),context:i=null,depth:s=!0,stencil:a=!1,alpha:r=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:u=!1,outputBufferType:f=Rn}=t;this.isWebGLRenderer=!0;let v;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=i.getContextAttributes().alpha}else v=r;let b=f,g=new Set([Jh,Zh,Yh]),h=new Set([Rn,yi,_o,yo,Wh,qh]),m=new Uint32Array(4),_=new Int32Array(4),S=null,A=null,C=[],w=[],x=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=_i,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let E=this,I=!1;this._outputColorSpace=fn;let R=0,O=0,z=null,k=-1,G=null,V=new Ae,B=new Ae,tt=null,K=new kt(0),dt=0,et=n.width,lt=n.height,Ut=1,me=null,he=null,Z=new Ae(0,0,et,lt),st=new Ae(0,0,et,lt),ot=!1,Ft=new mo,At=!1,Nt=!1,Ze=new Ue,jt=new H,ie=new Ae,de={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Vt=!1;function Le(){return z===null?Ut:1}let D=i;function Fe(M,L){return n.getContext(M,L)}try{let M={alpha:!0,depth:s,stencil:a,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:p};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${"183"}`),n.addEventListener("webglcontextlost",_t,!1),n.addEventListener("webglcontextrestored",Lt,!1),n.addEventListener("webglcontextcreationerror",ve,!1),D===null){let L="webgl2";if(D=Fe(L,M),D===null)throw Fe(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw Rt("WebGLRenderer: "+M.message),M}let ee,ge,St,T,y,N,Y,j,q,gt,at,Tt,wt,Q,nt,vt,yt,ft,Ht,U,rt,it,mt;function $(){ee=new hC(D),ee.init(),rt=new jR(D,ee),ge=new iC(D,ee,t,rt),St=new ZR(D,ee),ge.reversedDepthBuffer&&u&&St.buffers.depth.setReversed(!0),T=new pC(D),y=new IR,N=new JR(D,ee,St,y,ge,rt,T),Y=new uC(E),j=new yT(D),it=new eC(D,j),q=new dC(D,j,T,it),gt=new gC(D,q,j,it,T),ft=new mC(D,ge,N),nt=new sC(y),at=new LR(E,Y,ee,ge,it,nt),Tt=new t2(E,y),wt=new PR,Q=new GR(ee),yt=new tC(E,Y,St,gt,v,l),vt=new YR(E,gt,ge),mt=new e2(D,T,ge,St),Ht=new nC(D,ee,T),U=new fC(D,ee,T),T.programs=at.programs,E.capabilities=ge,E.extensions=ee,E.properties=y,E.renderLists=wt,E.shadowMap=vt,E.state=St,E.info=T}$(),b!==Rn&&(x=new _C(b,n.width,n.height,s,a));let W=new Yg(E,D);this.xr=W,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){let M=ee.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){let M=ee.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return Ut},this.setPixelRatio=function(M){M!==void 0&&(Ut=M,this.setSize(et,lt,!1))},this.getSize=function(M){return M.set(et,lt)},this.setSize=function(M,L,X=!0){if(W.isPresenting){Dt("WebGLRenderer: Can't change size while VR device is presenting.");return}et=M,lt=L,n.width=Math.floor(M*Ut),n.height=Math.floor(L*Ut),X===!0&&(n.style.width=M+"px",n.style.height=L+"px"),x!==null&&x.setSize(n.width,n.height),this.setViewport(0,0,M,L)},this.getDrawingBufferSize=function(M){return M.set(et*Ut,lt*Ut).floor()},this.setDrawingBufferSize=function(M,L,X){et=M,lt=L,Ut=X,n.width=Math.floor(M*X),n.height=Math.floor(L*X),this.setViewport(0,0,M,L)},this.setEffects=function(M){if(b===Rn){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let L=0;L<M.length;L++)if(M[L].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}x.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(V)},this.getViewport=function(M){return M.copy(Z)},this.setViewport=function(M,L,X,F){M.isVector4?Z.set(M.x,M.y,M.z,M.w):Z.set(M,L,X,F),St.viewport(V.copy(Z).multiplyScalar(Ut).round())},this.getScissor=function(M){return M.copy(st)},this.setScissor=function(M,L,X,F){M.isVector4?st.set(M.x,M.y,M.z,M.w):st.set(M,L,X,F),St.scissor(B.copy(st).multiplyScalar(Ut).round())},this.getScissorTest=function(){return ot},this.setScissorTest=function(M){St.setScissorTest(ot=M)},this.setOpaqueSort=function(M){me=M},this.setTransparentSort=function(M){he=M},this.getClearColor=function(M){return M.copy(yt.getClearColor())},this.setClearColor=function(){yt.setClearColor(...arguments)},this.getClearAlpha=function(){return yt.getClearAlpha()},this.setClearAlpha=function(){yt.setClearAlpha(...arguments)},this.clear=function(M=!0,L=!0,X=!0){let F=0;if(M){let P=!1;if(z!==null){let ut=z.texture.format;P=g.has(ut)}if(P){let ut=z.texture.type,pt=h.has(ut),ht=yt.getClearColor(),xt=yt.getClearAlpha(),Mt=ht.r,Ot=ht.g,Gt=ht.b;pt?(m[0]=Mt,m[1]=Ot,m[2]=Gt,m[3]=xt,D.clearBufferuiv(D.COLOR,0,m)):(_[0]=Mt,_[1]=Ot,_[2]=Gt,_[3]=xt,D.clearBufferiv(D.COLOR,0,_))}else F|=D.COLOR_BUFFER_BIT}L&&(F|=D.DEPTH_BUFFER_BIT),X&&(F|=D.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),F!==0&&D.clear(F)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",_t,!1),n.removeEventListener("webglcontextrestored",Lt,!1),n.removeEventListener("webglcontextcreationerror",ve,!1),yt.dispose(),wt.dispose(),Q.dispose(),y.dispose(),Y.dispose(),gt.dispose(),it.dispose(),mt.dispose(),at.dispose(),W.dispose(),W.removeEventListener("sessionstart",$g),W.removeEventListener("sessionend",t0),va.stop()};function _t(M){M.preventDefault(),Cg("WebGLRenderer: Context Lost."),I=!0}function Lt(){Cg("WebGLRenderer: Context Restored."),I=!1;let M=T.autoReset,L=vt.enabled,X=vt.autoUpdate,F=vt.needsUpdate,P=vt.type;$(),T.autoReset=M,vt.enabled=L,vt.autoUpdate=X,vt.needsUpdate=F,vt.type=P}function ve(M){Rt("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function se(M){let L=M.target;L.removeEventListener("dispose",se),Hi(L)}function Hi(M){Gi(M),y.remove(M)}function Gi(M){let L=y.get(M).programs;L!==void 0&&(L.forEach(function(X){at.releaseProgram(X)}),M.isShaderMaterial&&at.releaseShaderCache(M))}this.renderBufferDirect=function(M,L,X,F,P,ut){L===null&&(L=de);let pt=P.isMesh&&P.matrixWorld.determinant()<0,ht=Pb(M,L,X,F,P);St.setMaterial(F,pt);let xt=X.index,Mt=1;if(F.wireframe===!0){if(xt=q.getWireframeAttribute(X),xt===void 0)return;Mt=2}let Ot=X.drawRange,Gt=X.attributes.position,Et=Ot.start*Mt,oe=(Ot.start+Ot.count)*Mt;ut!==null&&(Et=Math.max(Et,ut.start*Mt),oe=Math.min(oe,(ut.start+ut.count)*Mt)),xt!==null?(Et=Math.max(Et,0),oe=Math.min(oe,xt.count)):Gt!=null&&(Et=Math.max(Et,0),oe=Math.min(oe,Gt.count));let Ie=oe-Et;if(Ie<0||Ie===1/0)return;it.setup(P,F,ht,X,xt);let Ce,le=Ht;if(xt!==null&&(Ce=j.get(xt),le=U,le.setIndex(Ce)),P.isMesh)F.wireframe===!0?(St.setLineWidth(F.wireframeLinewidth*Le()),le.setMode(D.LINES)):le.setMode(D.TRIANGLES);else if(P.isLine){let cn=F.linewidth;cn===void 0&&(cn=1),St.setLineWidth(cn*Le()),P.isLineSegments?le.setMode(D.LINES):P.isLineLoop?le.setMode(D.LINE_LOOP):le.setMode(D.LINE_STRIP)}else P.isPoints?le.setMode(D.POINTS):P.isSprite&&le.setMode(D.TRIANGLES);if(P.isBatchedMesh)if(P._multiDrawInstances!==null)Ll("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),le.renderMultiDrawInstances(P._multiDrawStarts,P._multiDrawCounts,P._multiDrawCount,P._multiDrawInstances);else if(ee.get("WEBGL_multi_draw"))le.renderMultiDraw(P._multiDrawStarts,P._multiDrawCounts,P._multiDrawCount);else{let cn=P._multiDrawStarts,bt=P._multiDrawCounts,Dn=P._multiDrawCount,Kt=xt?j.get(xt).bytesPerElement:1,li=y.get(F).currentProgram.getUniforms();for(let Si=0;Si<Dn;Si++)li.setValue(D,"_gl_DrawID",Si),le.render(cn[Si]/Kt,bt[Si])}else if(P.isInstancedMesh)le.renderInstances(Et,Ie,P.count);else if(X.isInstancedBufferGeometry){let cn=X._maxInstanceCount!==void 0?X._maxInstanceCount:1/0,bt=Math.min(X.instanceCount,cn);le.renderInstances(Et,Ie,bt)}else le.render(Et,Ie)};function Qg(M,L,X){M.transparent===!0&&M.side===Pi&&M.forceSinglePass===!1?(M.side=Ne,M.needsUpdate=!0,lc(M,L,X),M.side=gs,M.needsUpdate=!0,lc(M,L,X),M.side=Pi):lc(M,L,X)}this.compile=function(M,L,X=null){X===null&&(X=M),A=Q.get(X),A.init(L),w.push(A),X.traverseVisible(function(P){P.isLight&&P.layers.test(L.layers)&&(A.pushLight(P),P.castShadow&&A.pushShadow(P))}),M!==X&&M.traverseVisible(function(P){P.isLight&&P.layers.test(L.layers)&&(A.pushLight(P),P.castShadow&&A.pushShadow(P))}),A.setupLights();let F=new Set;return M.traverse(function(P){if(!(P.isMesh||P.isPoints||P.isLine||P.isSprite))return;let ut=P.material;if(ut)if(Array.isArray(ut))for(let pt=0;pt<ut.length;pt++){let ht=ut[pt];Qg(ht,X,P),F.add(ht)}else Qg(ut,X,P),F.add(ut)}),A=w.pop(),F},this.compileAsync=function(M,L,X=null){let F=this.compile(M,L,X);return new Promise(P=>{function ut(){if(F.forEach(function(pt){y.get(pt).currentProgram.isReady()&&F.delete(pt)}),F.size===0){P(M);return}setTimeout(ut,10)}ee.get("KHR_parallel_shader_compile")!==null?ut():setTimeout(ut,10)})};let zd=null;function Ob(M){zd&&zd(M)}function $g(){va.stop()}function t0(){va.start()}let va=new Eb;va.setAnimationLoop(Ob),typeof self<"u"&&va.setContext(self),this.setAnimationLoop=function(M){zd=M,W.setAnimationLoop(M),M===null?va.stop():va.start()},W.addEventListener("sessionstart",$g),W.addEventListener("sessionend",t0),this.render=function(M,L){if(L!==void 0&&L.isCamera!==!0){Rt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;let X=W.enabled===!0&&W.isPresenting===!0,F=x!==null&&(z===null||X)&&x.begin(E,z);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),W.enabled===!0&&W.isPresenting===!0&&(x===null||x.isCompositing()===!1)&&(W.cameraAutoUpdate===!0&&W.updateCamera(L),L=W.getCamera()),M.isScene===!0&&M.onBeforeRender(E,M,L,z),A=Q.get(M,w.length),A.init(L),w.push(A),Ze.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),Ft.setFromProjectionMatrix(Ze,mi,L.reversedDepth),Nt=this.localClippingEnabled,At=nt.init(this.clippingPlanes,Nt),S=wt.get(M,C.length),S.init(),C.push(S),W.enabled===!0&&W.isPresenting===!0){let pt=E.xr.getDepthSensingMesh();pt!==null&&Vd(pt,L,-1/0,E.sortObjects)}Vd(M,L,0,E.sortObjects),S.finish(),E.sortObjects===!0&&S.sort(me,he),Vt=W.enabled===!1||W.isPresenting===!1||W.hasDepthSensing()===!1,Vt&&yt.addToRenderList(S,M),this.info.render.frame++,At===!0&&nt.beginShadows();let P=A.state.shadowsArray;if(vt.render(P,M,L),At===!0&&nt.endShadows(),this.info.autoReset===!0&&this.info.reset(),(F&&x.hasRenderPass())===!1){let pt=S.opaque,ht=S.transmissive;if(A.setupLights(),L.isArrayCamera){let xt=L.cameras;if(ht.length>0)for(let Mt=0,Ot=xt.length;Mt<Ot;Mt++){let Gt=xt[Mt];n0(pt,ht,M,Gt)}Vt&&yt.render(M);for(let Mt=0,Ot=xt.length;Mt<Ot;Mt++){let Gt=xt[Mt];e0(S,M,Gt,Gt.viewport)}}else ht.length>0&&n0(pt,ht,M,L),Vt&&yt.render(M),e0(S,M,L)}z!==null&&O===0&&(N.updateMultisampleRenderTarget(z),N.updateRenderTargetMipmap(z)),F&&x.end(E),M.isScene===!0&&M.onAfterRender(E,M,L),it.resetDefaultState(),k=-1,G=null,w.pop(),w.length>0?(A=w[w.length-1],At===!0&&nt.setGlobalState(E.clippingPlanes,A.state.camera)):A=null,C.pop(),C.length>0?S=C[C.length-1]:S=null};function Vd(M,L,X,F){if(M.visible===!1)return;if(M.layers.test(L.layers)){if(M.isGroup)X=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(L);else if(M.isLight)A.pushLight(M),M.castShadow&&A.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||Ft.intersectsSprite(M)){F&&ie.setFromMatrixPosition(M.matrixWorld).applyMatrix4(Ze);let pt=gt.update(M),ht=M.material;ht.visible&&S.push(M,pt,ht,X,ie.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||Ft.intersectsObject(M))){let pt=gt.update(M),ht=M.material;if(F&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),ie.copy(M.boundingSphere.center)):(pt.boundingSphere===null&&pt.computeBoundingSphere(),ie.copy(pt.boundingSphere.center)),ie.applyMatrix4(M.matrixWorld).applyMatrix4(Ze)),Array.isArray(ht)){let xt=pt.groups;for(let Mt=0,Ot=xt.length;Mt<Ot;Mt++){let Gt=xt[Mt],Et=ht[Gt.materialIndex];Et&&Et.visible&&S.push(M,pt,Et,X,ie.z,Gt)}}else ht.visible&&S.push(M,pt,ht,X,ie.z,null)}}let ut=M.children;for(let pt=0,ht=ut.length;pt<ht;pt++)Vd(ut[pt],L,X,F)}function e0(M,L,X,F){let{opaque:P,transmissive:ut,transparent:pt}=M;A.setupLightsView(X),At===!0&&nt.setGlobalState(E.clippingPlanes,X),F&&St.viewport(V.copy(F)),P.length>0&&oc(P,L,X),ut.length>0&&oc(ut,L,X),pt.length>0&&oc(pt,L,X),St.buffers.depth.setTest(!0),St.buffers.depth.setMask(!0),St.buffers.color.setMask(!0),St.setPolygonOffset(!1)}function n0(M,L,X,F){if((X.isScene===!0?X.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[F.id]===void 0){let Et=ee.has("EXT_color_buffer_half_float")||ee.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[F.id]=new Xn(1,1,{generateMipmaps:!0,type:Et?Fi:Rn,minFilter:da,samples:Math.max(4,ge.samples),stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Jt.workingColorSpace})}let ut=A.state.transmissionRenderTarget[F.id],pt=F.viewport||V;ut.setSize(pt.z*E.transmissionResolutionScale,pt.w*E.transmissionResolutionScale);let ht=E.getRenderTarget(),xt=E.getActiveCubeFace(),Mt=E.getActiveMipmapLevel();E.setRenderTarget(ut),E.getClearColor(K),dt=E.getClearAlpha(),dt<1&&E.setClearColor(16777215,.5),E.clear(),Vt&&yt.render(X);let Ot=E.toneMapping;E.toneMapping=_i;let Gt=F.viewport;if(F.viewport!==void 0&&(F.viewport=void 0),A.setupLightsView(F),At===!0&&nt.setGlobalState(E.clippingPlanes,F),oc(M,X,F),N.updateMultisampleRenderTarget(ut),N.updateRenderTargetMipmap(ut),ee.has("WEBGL_multisampled_render_to_texture")===!1){let Et=!1;for(let oe=0,Ie=L.length;oe<Ie;oe++){let Ce=L[oe],{object:le,geometry:cn,material:bt,group:Dn}=Ce;if(bt.side===Pi&&le.layers.test(F.layers)){let Kt=bt.side;bt.side=Ne,bt.needsUpdate=!0,i0(le,X,F,cn,bt,Dn),bt.side=Kt,bt.needsUpdate=!0,Et=!0}}Et===!0&&(N.updateMultisampleRenderTarget(ut),N.updateRenderTargetMipmap(ut))}E.setRenderTarget(ht,xt,Mt),E.setClearColor(K,dt),Gt!==void 0&&(F.viewport=Gt),E.toneMapping=Ot}function oc(M,L,X){let F=L.isScene===!0?L.overrideMaterial:null;for(let P=0,ut=M.length;P<ut;P++){let pt=M[P],{object:ht,geometry:xt,group:Mt}=pt,Ot=pt.material;Ot.allowOverride===!0&&F!==null&&(Ot=F),ht.layers.test(X.layers)&&i0(ht,L,X,xt,Ot,Mt)}}function i0(M,L,X,F,P,ut){M.onBeforeRender(E,L,X,F,P,ut),M.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),P.onBeforeRender(E,L,X,F,M,ut),P.transparent===!0&&P.side===Pi&&P.forceSinglePass===!1?(P.side=Ne,P.needsUpdate=!0,E.renderBufferDirect(X,L,F,P,M,ut),P.side=gs,P.needsUpdate=!0,E.renderBufferDirect(X,L,F,P,M,ut),P.side=Pi):E.renderBufferDirect(X,L,F,P,M,ut),M.onAfterRender(E,L,X,F,P,ut)}function lc(M,L,X){L.isScene!==!0&&(L=de);let F=y.get(M),P=A.state.lights,ut=A.state.shadowsArray,pt=P.state.version,ht=at.getParameters(M,P.state,ut,L,X),xt=at.getProgramCacheKey(ht),Mt=F.programs;F.environment=M.isMeshStandardMaterial||M.isMeshLambertMaterial||M.isMeshPhongMaterial?L.environment:null,F.fog=L.fog;let Ot=M.isMeshStandardMaterial||M.isMeshLambertMaterial&&!M.envMap||M.isMeshPhongMaterial&&!M.envMap;F.envMap=Y.get(M.envMap||F.environment,Ot),F.envMapRotation=F.environment!==null&&M.envMap===null?L.environmentRotation:M.envMapRotation,Mt===void 0&&(M.addEventListener("dispose",se),Mt=new Map,F.programs=Mt);let Gt=Mt.get(xt);if(Gt!==void 0){if(F.currentProgram===Gt&&F.lightsStateVersion===pt)return a0(M,ht),Gt}else ht.uniforms=at.getUniforms(M),M.onBeforeCompile(ht,E),Gt=at.acquireProgram(ht,xt),Mt.set(xt,Gt),F.uniforms=ht.uniforms;let Et=F.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Et.clippingPlanes=nt.uniform),a0(M,ht),F.needsLights=Fb(M),F.lightsStateVersion=pt,F.needsLights&&(Et.ambientLightColor.value=P.state.ambient,Et.lightProbe.value=P.state.probe,Et.directionalLights.value=P.state.directional,Et.directionalLightShadows.value=P.state.directionalShadow,Et.spotLights.value=P.state.spot,Et.spotLightShadows.value=P.state.spotShadow,Et.rectAreaLights.value=P.state.rectArea,Et.ltc_1.value=P.state.rectAreaLTC1,Et.ltc_2.value=P.state.rectAreaLTC2,Et.pointLights.value=P.state.point,Et.pointLightShadows.value=P.state.pointShadow,Et.hemisphereLights.value=P.state.hemi,Et.directionalShadowMatrix.value=P.state.directionalShadowMatrix,Et.spotLightMatrix.value=P.state.spotLightMatrix,Et.spotLightMap.value=P.state.spotLightMap,Et.pointShadowMatrix.value=P.state.pointShadowMatrix),F.currentProgram=Gt,F.uniformsList=null,Gt}function s0(M){if(M.uniformsList===null){let L=M.currentProgram.getUniforms();M.uniformsList=So.seqWithValue(L.seq,M.uniforms)}return M.uniformsList}function a0(M,L){let X=y.get(M);X.outputColorSpace=L.outputColorSpace,X.batching=L.batching,X.batchingColor=L.batchingColor,X.instancing=L.instancing,X.instancingColor=L.instancingColor,X.instancingMorph=L.instancingMorph,X.skinning=L.skinning,X.morphTargets=L.morphTargets,X.morphNormals=L.morphNormals,X.morphColors=L.morphColors,X.morphTargetsCount=L.morphTargetsCount,X.numClippingPlanes=L.numClippingPlanes,X.numIntersection=L.numClipIntersection,X.vertexAlphas=L.vertexAlphas,X.vertexTangents=L.vertexTangents,X.toneMapping=L.toneMapping}function Pb(M,L,X,F,P){L.isScene!==!0&&(L=de),N.resetTextureUnits();let ut=L.fog,pt=F.isMeshStandardMaterial||F.isMeshLambertMaterial||F.isMeshPhongMaterial?L.environment:null,ht=z===null?E.outputColorSpace:z.isXRRenderTarget===!0?z.texture.colorSpace:qa,xt=F.isMeshStandardMaterial||F.isMeshLambertMaterial&&!F.envMap||F.isMeshPhongMaterial&&!F.envMap,Mt=Y.get(F.envMap||pt,xt),Ot=F.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,Gt=!!X.attributes.tangent&&(!!F.normalMap||F.anisotropy>0),Et=!!X.morphAttributes.position,oe=!!X.morphAttributes.normal,Ie=!!X.morphAttributes.color,Ce=_i;F.toneMapped&&(z===null||z.isXRRenderTarget===!0)&&(Ce=E.toneMapping);let le=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,cn=le!==void 0?le.length:0,bt=y.get(F),Dn=A.state.lights;if(At===!0&&(Nt===!0||M!==G)){let Je=M===G&&F.id===k;nt.setState(F,M,Je)}let Kt=!1;F.version===bt.__version?(bt.needsLights&&bt.lightsStateVersion!==Dn.state.version||bt.outputColorSpace!==ht||P.isBatchedMesh&&bt.batching===!1||!P.isBatchedMesh&&bt.batching===!0||P.isBatchedMesh&&bt.batchingColor===!0&&P.colorTexture===null||P.isBatchedMesh&&bt.batchingColor===!1&&P.colorTexture!==null||P.isInstancedMesh&&bt.instancing===!1||!P.isInstancedMesh&&bt.instancing===!0||P.isSkinnedMesh&&bt.skinning===!1||!P.isSkinnedMesh&&bt.skinning===!0||P.isInstancedMesh&&bt.instancingColor===!0&&P.instanceColor===null||P.isInstancedMesh&&bt.instancingColor===!1&&P.instanceColor!==null||P.isInstancedMesh&&bt.instancingMorph===!0&&P.morphTexture===null||P.isInstancedMesh&&bt.instancingMorph===!1&&P.morphTexture!==null||bt.envMap!==Mt||F.fog===!0&&bt.fog!==ut||bt.numClippingPlanes!==void 0&&(bt.numClippingPlanes!==nt.numPlanes||bt.numIntersection!==nt.numIntersection)||bt.vertexAlphas!==Ot||bt.vertexTangents!==Gt||bt.morphTargets!==Et||bt.morphNormals!==oe||bt.morphColors!==Ie||bt.toneMapping!==Ce||bt.morphTargetsCount!==cn)&&(Kt=!0):(Kt=!0,bt.__version=F.version);let li=bt.currentProgram;Kt===!0&&(li=lc(F,L,P));let Si=!1,_a=!1,$a=!1,fe=li.getUniforms(),tn=bt.uniforms;if(St.useProgram(li.program)&&(Si=!0,_a=!0,$a=!0),F.id!==k&&(k=F.id,_a=!0),Si||G!==M){St.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),fe.setValue(D,"projectionMatrix",M.projectionMatrix),fe.setValue(D,"viewMatrix",M.matrixWorldInverse);let xs=fe.map.cameraPosition;xs!==void 0&&xs.setValue(D,jt.setFromMatrixPosition(M.matrixWorld)),ge.logarithmicDepthBuffer&&fe.setValue(D,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(F.isMeshPhongMaterial||F.isMeshToonMaterial||F.isMeshLambertMaterial||F.isMeshBasicMaterial||F.isMeshStandardMaterial||F.isShaderMaterial)&&fe.setValue(D,"isOrthographic",M.isOrthographicCamera===!0),G!==M&&(G=M,_a=!0,$a=!0)}if(bt.needsLights&&(Dn.state.directionalShadowMap.length>0&&fe.setValue(D,"directionalShadowMap",Dn.state.directionalShadowMap,N),Dn.state.spotShadowMap.length>0&&fe.setValue(D,"spotShadowMap",Dn.state.spotShadowMap,N),Dn.state.pointShadowMap.length>0&&fe.setValue(D,"pointShadowMap",Dn.state.pointShadowMap,N)),P.isSkinnedMesh){fe.setOptional(D,P,"bindMatrix"),fe.setOptional(D,P,"bindMatrixInverse");let Je=P.skeleton;Je&&(Je.boneTexture===null&&Je.computeBoneTexture(),fe.setValue(D,"boneTexture",Je.boneTexture,N))}P.isBatchedMesh&&(fe.setOptional(D,P,"batchingTexture"),fe.setValue(D,"batchingTexture",P._matricesTexture,N),fe.setOptional(D,P,"batchingIdTexture"),fe.setValue(D,"batchingIdTexture",P._indirectTexture,N),fe.setOptional(D,P,"batchingColorTexture"),P._colorsTexture!==null&&fe.setValue(D,"batchingColorTexture",P._colorsTexture,N));let ys=X.morphAttributes;if((ys.position!==void 0||ys.normal!==void 0||ys.color!==void 0)&&ft.update(P,X,li),(_a||bt.receiveShadow!==P.receiveShadow)&&(bt.receiveShadow=P.receiveShadow,fe.setValue(D,"receiveShadow",P.receiveShadow)),(F.isMeshStandardMaterial||F.isMeshLambertMaterial||F.isMeshPhongMaterial)&&F.envMap===null&&L.environment!==null&&(tn.envMapIntensity.value=L.environmentIntensity),tn.dfgLUT!==void 0&&(tn.dfgLUT.value=i2()),_a&&(fe.setValue(D,"toneMappingExposure",E.toneMappingExposure),bt.needsLights&&Bb(tn,$a),ut&&F.fog===!0&&Tt.refreshFogUniforms(tn,ut),Tt.refreshMaterialUniforms(tn,F,Ut,lt,A.state.transmissionRenderTarget[M.id]),So.upload(D,s0(bt),tn,N)),F.isShaderMaterial&&F.uniformsNeedUpdate===!0&&(So.upload(D,s0(bt),tn,N),F.uniformsNeedUpdate=!1),F.isSpriteMaterial&&fe.setValue(D,"center",P.center),fe.setValue(D,"modelViewMatrix",P.modelViewMatrix),fe.setValue(D,"normalMatrix",P.normalMatrix),fe.setValue(D,"modelMatrix",P.matrixWorld),F.isShaderMaterial||F.isRawShaderMaterial){let Je=F.uniformsGroups;for(let xs=0,tr=Je.length;xs<tr;xs++){let r0=Je[xs];mt.update(r0,li),mt.bind(r0,li)}}return li}function Bb(M,L){M.ambientLightColor.needsUpdate=L,M.lightProbe.needsUpdate=L,M.directionalLights.needsUpdate=L,M.directionalLightShadows.needsUpdate=L,M.pointLights.needsUpdate=L,M.pointLightShadows.needsUpdate=L,M.spotLights.needsUpdate=L,M.spotLightShadows.needsUpdate=L,M.rectAreaLights.needsUpdate=L,M.hemisphereLights.needsUpdate=L}function Fb(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return R},this.getActiveMipmapLevel=function(){return O},this.getRenderTarget=function(){return z},this.setRenderTargetTextures=function(M,L,X){let F=y.get(M);F.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,F.__autoAllocateDepthBuffer===!1&&(F.__useRenderToTexture=!1),y.get(M.texture).__webglTexture=L,y.get(M.depthTexture).__webglTexture=F.__autoAllocateDepthBuffer?void 0:X,F.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,L){let X=y.get(M);X.__webglFramebuffer=L,X.__useDefaultFramebuffer=L===void 0};let zb=D.createFramebuffer();this.setRenderTarget=function(M,L=0,X=0){z=M,R=L,O=X;let F=null,P=!1,ut=!1;if(M){let ht=y.get(M);if(ht.__useDefaultFramebuffer!==void 0){St.bindFramebuffer(D.FRAMEBUFFER,ht.__webglFramebuffer),V.copy(M.viewport),B.copy(M.scissor),tt=M.scissorTest,St.viewport(V),St.scissor(B),St.setScissorTest(tt),k=-1;return}else if(ht.__webglFramebuffer===void 0)N.setupRenderTarget(M);else if(ht.__hasExternalTextures)N.rebindTextures(M,y.get(M.texture).__webglTexture,y.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){let Ot=M.depthTexture;if(ht.__boundDepthTexture!==Ot){if(Ot!==null&&y.has(Ot)&&(M.width!==Ot.image.width||M.height!==Ot.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");N.setupDepthRenderbuffer(M)}}let xt=M.texture;(xt.isData3DTexture||xt.isDataArrayTexture||xt.isCompressedArrayTexture)&&(ut=!0);let Mt=y.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Mt[L])?F=Mt[L][X]:F=Mt[L],P=!0):M.samples>0&&N.useMultisampledRTT(M)===!1?F=y.get(M).__webglMultisampledFramebuffer:Array.isArray(Mt)?F=Mt[X]:F=Mt,V.copy(M.viewport),B.copy(M.scissor),tt=M.scissorTest}else V.copy(Z).multiplyScalar(Ut).floor(),B.copy(st).multiplyScalar(Ut).floor(),tt=ot;if(X!==0&&(F=zb),St.bindFramebuffer(D.FRAMEBUFFER,F)&&St.drawBuffers(M,F),St.viewport(V),St.scissor(B),St.setScissorTest(tt),P){let ht=y.get(M.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+L,ht.__webglTexture,X)}else if(ut){let ht=L;for(let xt=0;xt<M.textures.length;xt++){let Mt=y.get(M.textures[xt]);D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0+xt,Mt.__webglTexture,X,ht)}}else if(M!==null&&X!==0){let ht=y.get(M.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,ht.__webglTexture,X)}k=-1},this.readRenderTargetPixels=function(M,L,X,F,P,ut,pt,ht=0){if(!(M&&M.isWebGLRenderTarget)){Rt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let xt=y.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&pt!==void 0&&(xt=xt[pt]),xt){St.bindFramebuffer(D.FRAMEBUFFER,xt);try{let Mt=M.textures[ht],Ot=Mt.format,Gt=Mt.type;if(M.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+ht),!ge.textureFormatReadable(Ot)){Rt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ge.textureTypeReadable(Gt)){Rt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=M.width-F&&X>=0&&X<=M.height-P&&D.readPixels(L,X,F,P,rt.convert(Ot),rt.convert(Gt),ut)}finally{let Mt=z!==null?y.get(z).__webglFramebuffer:null;St.bindFramebuffer(D.FRAMEBUFFER,Mt)}}},this.readRenderTargetPixelsAsync=async function(M,L,X,F,P,ut,pt,ht=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let xt=y.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&pt!==void 0&&(xt=xt[pt]),xt)if(L>=0&&L<=M.width-F&&X>=0&&X<=M.height-P){St.bindFramebuffer(D.FRAMEBUFFER,xt);let Mt=M.textures[ht],Ot=Mt.format,Gt=Mt.type;if(M.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+ht),!ge.textureFormatReadable(Ot))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ge.textureTypeReadable(Gt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Et=D.createBuffer();D.bindBuffer(D.PIXEL_PACK_BUFFER,Et),D.bufferData(D.PIXEL_PACK_BUFFER,ut.byteLength,D.STREAM_READ),D.readPixels(L,X,F,P,rt.convert(Ot),rt.convert(Gt),0);let oe=z!==null?y.get(z).__webglFramebuffer:null;St.bindFramebuffer(D.FRAMEBUFFER,oe);let Ie=D.fenceSync(D.SYNC_GPU_COMMANDS_COMPLETE,0);return D.flush(),await KS(D,Ie,4),D.bindBuffer(D.PIXEL_PACK_BUFFER,Et),D.getBufferSubData(D.PIXEL_PACK_BUFFER,0,ut),D.deleteBuffer(Et),D.deleteSync(Ie),ut}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,L=null,X=0){let F=Math.pow(2,-X),P=Math.floor(M.image.width*F),ut=Math.floor(M.image.height*F),pt=L!==null?L.x:0,ht=L!==null?L.y:0;N.setTexture2D(M,0),D.copyTexSubImage2D(D.TEXTURE_2D,X,0,0,pt,ht,P,ut),St.unbindTexture()};let Vb=D.createFramebuffer(),Hb=D.createFramebuffer();this.copyTextureToTexture=function(M,L,X=null,F=null,P=0,ut=0){let pt,ht,xt,Mt,Ot,Gt,Et,oe,Ie,Ce=M.isCompressedTexture?M.mipmaps[ut]:M.image;if(X!==null)pt=X.max.x-X.min.x,ht=X.max.y-X.min.y,xt=X.isBox3?X.max.z-X.min.z:1,Mt=X.min.x,Ot=X.min.y,Gt=X.isBox3?X.min.z:0;else{let tn=Math.pow(2,-P);pt=Math.floor(Ce.width*tn),ht=Math.floor(Ce.height*tn),M.isDataArrayTexture?xt=Ce.depth:M.isData3DTexture?xt=Math.floor(Ce.depth*tn):xt=1,Mt=0,Ot=0,Gt=0}F!==null?(Et=F.x,oe=F.y,Ie=F.z):(Et=0,oe=0,Ie=0);let le=rt.convert(L.format),cn=rt.convert(L.type),bt;L.isData3DTexture?(N.setTexture3D(L,0),bt=D.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(N.setTexture2DArray(L,0),bt=D.TEXTURE_2D_ARRAY):(N.setTexture2D(L,0),bt=D.TEXTURE_2D),D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,L.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,L.unpackAlignment);let Dn=D.getParameter(D.UNPACK_ROW_LENGTH),Kt=D.getParameter(D.UNPACK_IMAGE_HEIGHT),li=D.getParameter(D.UNPACK_SKIP_PIXELS),Si=D.getParameter(D.UNPACK_SKIP_ROWS),_a=D.getParameter(D.UNPACK_SKIP_IMAGES);D.pixelStorei(D.UNPACK_ROW_LENGTH,Ce.width),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,Ce.height),D.pixelStorei(D.UNPACK_SKIP_PIXELS,Mt),D.pixelStorei(D.UNPACK_SKIP_ROWS,Ot),D.pixelStorei(D.UNPACK_SKIP_IMAGES,Gt);let $a=M.isDataArrayTexture||M.isData3DTexture,fe=L.isDataArrayTexture||L.isData3DTexture;if(M.isDepthTexture){let tn=y.get(M),ys=y.get(L),Je=y.get(tn.__renderTarget),xs=y.get(ys.__renderTarget);St.bindFramebuffer(D.READ_FRAMEBUFFER,Je.__webglFramebuffer),St.bindFramebuffer(D.DRAW_FRAMEBUFFER,xs.__webglFramebuffer);for(let tr=0;tr<xt;tr++)$a&&(D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,y.get(M).__webglTexture,P,Gt+tr),D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,y.get(L).__webglTexture,ut,Ie+tr)),D.blitFramebuffer(Mt,Ot,pt,ht,Et,oe,pt,ht,D.DEPTH_BUFFER_BIT,D.NEAREST);St.bindFramebuffer(D.READ_FRAMEBUFFER,null),St.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else if(P!==0||M.isRenderTargetTexture||y.has(M)){let tn=y.get(M),ys=y.get(L);St.bindFramebuffer(D.READ_FRAMEBUFFER,Vb),St.bindFramebuffer(D.DRAW_FRAMEBUFFER,Hb);for(let Je=0;Je<xt;Je++)$a?D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,tn.__webglTexture,P,Gt+Je):D.framebufferTexture2D(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,tn.__webglTexture,P),fe?D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,ys.__webglTexture,ut,Ie+Je):D.framebufferTexture2D(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,ys.__webglTexture,ut),P!==0?D.blitFramebuffer(Mt,Ot,pt,ht,Et,oe,pt,ht,D.COLOR_BUFFER_BIT,D.NEAREST):fe?D.copyTexSubImage3D(bt,ut,Et,oe,Ie+Je,Mt,Ot,pt,ht):D.copyTexSubImage2D(bt,ut,Et,oe,Mt,Ot,pt,ht);St.bindFramebuffer(D.READ_FRAMEBUFFER,null),St.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else fe?M.isDataTexture||M.isData3DTexture?D.texSubImage3D(bt,ut,Et,oe,Ie,pt,ht,xt,le,cn,Ce.data):L.isCompressedArrayTexture?D.compressedTexSubImage3D(bt,ut,Et,oe,Ie,pt,ht,xt,le,Ce.data):D.texSubImage3D(bt,ut,Et,oe,Ie,pt,ht,xt,le,cn,Ce):M.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,ut,Et,oe,pt,ht,le,cn,Ce.data):M.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,ut,Et,oe,Ce.width,Ce.height,le,Ce.data):D.texSubImage2D(D.TEXTURE_2D,ut,Et,oe,pt,ht,le,cn,Ce);D.pixelStorei(D.UNPACK_ROW_LENGTH,Dn),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,Kt),D.pixelStorei(D.UNPACK_SKIP_PIXELS,li),D.pixelStorei(D.UNPACK_SKIP_ROWS,Si),D.pixelStorei(D.UNPACK_SKIP_IMAGES,_a),ut===0&&L.generateMipmaps&&D.generateMipmap(bt),St.unbindTexture()},this.initRenderTarget=function(M){y.get(M).__webglFramebuffer===void 0&&N.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?N.setTextureCube(M,0):M.isData3DTexture?N.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?N.setTexture2DArray(M,0):N.setTexture2D(M,0),St.unbindTexture()},this.resetState=function(){R=0,O=0,z=null,St.reset(),it.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return mi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let n=this.getContext();n.drawingBufferColorSpace=Jt._getDrawingBufferColorSpace(t),n.unpackColorSpace=Jt._getUnpackColorSpace()}};var Bd=Ss(rc()),o2="/assets/pynqcast-white.png",Zg=class extends fo{constructor(){super();let t=new yn;t.deleteAttribute("uv");let n=new we(t,[new Cn({color:8947848,side:Ne}),new Cn({color:8947848,side:Ne}),new Cn({color:16777215,side:Ne}),new Cn({color:4473924,side:Ne}),new Cn({color:8947848,side:Ne}),new Cn({color:8947848,side:Ne})]);n.scale.setScalar(10),this.add(n);let i=new vi(16729088,2,20);i.position.set(5,5,5),this.add(i);let s=new vi(17663,1,20);s.position.set(-5,5,-5),this.add(s);let a=new vi(16777215,1,20);a.position.set(0,10,0),this.add(a)}};function l2({hostSlot:e}){let t=(0,ma.useRef)(null),n=(0,ma.useRef)(null);return(0,ma.useEffect)(()=>{let i=t.current,s=n.current,a=e?.closest(".about-sprite-wrap");if(!i||!s||!a)return()=>{};a.classList.add("board-ready");let r=Math.max(320,Math.round(i.clientWidth||480)),o=Math.max(280,Math.round(i.clientHeight||280)),l=new Ld({antialias:!1,alpha:!0});l.setSize(Math.floor(r/4),Math.floor(o/4)),l.domElement.style.width=`${r}px`,l.domElement.style.height=`${o}px`,l.domElement.style.imageRendering="pixelated",l.setClearColor(0,0),l.toneMapping=Jl,l.toneMappingExposure=.7,l.setPixelRatio(1),"outputColorSpace"in l&&(l.outputColorSpace=fn),i.appendChild(l.domElement);let c=new bo(l);c.compileEquirectangularShader();let d=c.fromScene(new Zg).texture;c.dispose();let p=new fo;p.environment=d;let u=new on(38,r/o,.1,100);u.position.set(0,.2,6.2),u.lookAt(0,0,0),p.add(new ql(3342336,2.5));let f=new vi(12260608,70,16),v=new vi(16777215,55,7),b=new vi(16772829,40,6),g=new vi(1127338,18,10);f.position.set(2.5,1.8,3),v.position.set(1,1.5,2.5),b.position.set(-1.6,1.1,2),g.position.set(-2.4,1.6,-2.8),p.add(f),p.add(v),p.add(b),p.add(g);let h=new Cn({color:2621440,metalness:.85,roughness:.08,emissive:new kt("#060000"),emissiveIntensity:.3,envMapIntensity:1.8}),m=new Cn({color:1572864,metalness:.8,roughness:.15,envMapIntensity:1.2}),_=new Cn({color:16758784,metalness:1,roughness:.04,emissive:new kt("#221100"),emissiveIntensity:.15,envMapIntensity:2.5}),S=new ps;p.add(S);let A=new we(new yn(3.55,2.3,.16),m);S.add(A);let C=new we(new yn(3.35,2.1,.11),h);C.position.z=.03,S.add(C);let w=new we(new yn(3.35,2.1,.11),h);w.position.z=-.03,S.add(w);let x=(et,lt,Ut,me,he=.012)=>{let Z=new we(new yn(Ut,me,he),_);Z.position.set(et,lt,.09),S.add(Z)};x(-.92,.62,1.12,.08),x(.38,.62,1.32,.08),x(-1.08,.16,.18,.86),x(1.16,.12,.18,.92),x(-.24,-.3,2.12,.08),x(0,-.72,1.52,.08),x(-.78,-.95,.18,.54),x(.84,-.9,.18,.42);let E=new we(new yn(1.22,.92,.16),m);E.position.set(.08,.04,.13),S.add(E);let I=new we(new yn(1.08,.78,.04),h);I.position.set(.08,.04,.21),S.add(I);for(let et=0;et<10;et++){let lt=new we(new yn(.12,.08,.06),_);lt.position.set(-1.54+et*.34,1.23,.04),S.add(lt);let Ut=lt.clone();Ut.position.y=-1.23,S.add(Ut)}let O=new Gl().load(o2,()=>{O.magFilter=Be,O.minFilter=Be,O.generateMipmaps=!1,"colorSpace"in O&&(O.colorSpace=fn),O.needsUpdate=!0}),z=new Cn({map:O,color:16777215,metalness:.18,roughness:.36,emissive:new kt("#220000"),emissiveIntensity:.2,transparent:!0,alphaTest:.08}),k=new we(new oa(2.28,1.28),z);k.position.set(.02,.1,.106),S.add(k);let G=new we(new oa(2.28,1.28),z);G.position.set(.02,.1,-.106),G.rotation.y=Math.PI,S.add(G);let V=[h,m,_,z],B=[A.geometry,C.geometry,w.geometry,E.geometry,I.geometry,k.geometry,G.geometry];S.children.forEach(et=>{[A,C,w,E,I,k,G].includes(et)||B.push(et.geometry)});let tt=0,K=new Yl,dt=()=>{let et=K.getElapsedTime(),lt=(Math.sin(et*1.4)+1)/2;S.rotation.y=et*1.1,S.rotation.x=.25+Math.sin(et*.5)*.08,S.rotation.z=Math.sin(et*.7)*.06,S.position.y=Math.sin(et*1.4)*.18,f.position.x=Math.cos(et*.6)*4,f.position.z=Math.sin(et*.6)*4+2,v.position.x=Math.cos(et*2.2)*2.5,v.position.y=Math.sin(et*1.6)*2,v.position.z=2.5,b.position.x=Math.cos(et*1.8+Math.PI)*2,b.position.y=Math.sin(et*2.1+Math.PI)*1.5,b.position.z=2,s.style.transform=`translateX(-50%) scaleX(${(.88+lt*.28).toFixed(3)}) scaleY(${(.7+lt*.3).toFixed(3)})`,s.style.opacity=(.4+lt*.45).toFixed(3),l.render(p,u),tt=requestAnimationFrame(dt)};return dt(),()=>{a.classList.remove("board-ready"),cancelAnimationFrame(tt),O.dispose(),d.dispose(),V.forEach(et=>et.dispose()),B.forEach(et=>et?.dispose()),l.dispose(),i&&l.domElement.parentNode===i&&i.removeChild(l.domElement)}},[e]),(0,Bd.jsx)("div",{ref:t,style:{width:"100%",height:280,position:"relative"},children:(0,Bd.jsx)("div",{ref:n,style:{position:"absolute",bottom:12,left:"50%",width:200,height:18,background:"radial-gradient(ellipse at center, rgba(180,20,20,0.6) 0%, transparent 70%)",pointerEvents:"none",transformOrigin:"center center"}})})}function Jg({hostRef:e}){let[t,n]=(0,ma.useState)(null);return(0,ma.useEffect)(()=>{let i=e?.current?.querySelector(".about-react-board-slot");n(i||null)},[e]),t?(0,Nb.createPortal)((0,Bd.jsx)(l2,{hostSlot:t}),t):null}var jg={pynq:`<div class="app-shell">
  <header class="topbar">
...
</div>`};var ga=Ss(rc()),Kg=["/monitor-state.js","/monitor-render.js","/monitor-app.js"];function c2(){if(window.__monitorLegacyBootstrapped)return;window.__monitorLegacyBootstrapped=!0;let e=t=>{if(t>=Kg.length){window.dispatchEvent(new Event("monitor:legacy-ready"));return}let n=document.createElement("script");n.src=Kg[t],n.async=!1,n.onload=()=>e(t+1),n.onerror=()=>{console.error(`[monitor-ui] failed to load legacy script: ${Kg[t]}`)},document.body.appendChild(n)};e(0)}function u2({mode:e}){let t=(0,Fd.useRef)(null);return(0,Fd.useEffect)(()=>{c2()},[]),(0,ga.jsxs)(ga.Fragment,{children:[(0,ga.jsx)("div",{ref:t,className:"react-monitor-root",dangerouslySetInnerHTML:{__html:jg[e]||jg.pynq}}),(0,ga.jsx)(Jg,{hostRef:t})]})}var h2=window.__MONITOR_MODE__==="sim"?"sim":"pynq",Ib=document.getElementById("root");if(!Ib)throw new Error("Missing #root for monitor React mount");(0,Lb.createRoot)(Ib).render((0,ga.jsx)(u2,{mode:h2}));})();

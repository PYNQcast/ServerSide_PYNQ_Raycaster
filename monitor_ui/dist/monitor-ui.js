...
`)+`
`+h);let _=m+g+r,S=m+h+o,T=fb(s,s.VERTEX_SHADER,_),C=fb(s,s.FRAGMENT_SHADER,S);s.attachShader(b,T),s.attachShader(b,C),n.index0AttributeName!==void 0?s.bindAttribLocation(b,0,n.index0AttributeName):n.morphTargets===!0&&s.bindAttribLocation(b,0,"position"),s.linkProgram(b);function w(R){if(e.debug.checkShaderErrors){let F=s.getProgramInfoLog(b)||"",V=s.getShaderInfoLog(T)||"",X=s.getShaderInfoLog(C)||"",G=F.trim(),z=V.trim(),P=X.trim(),et=!0,K=!0;if(s.getProgramParameter(b,s.LINK_STATUS)===!1)if(et=!1,typeof e.debug.onShaderError=="function")e.debug.onShaderError(s,b,T,C);else{let lt=mb(s,T,"vertex"),mt=mb(s,C,"fragment");Dt("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(b,s.VALIDATE_STATUS)+`
...
}`,WR=[new H(1,0,0),new H(-1,0,0),new H(0,1,0),new H(0,-1,0),new H(0,0,1),new H(0,0,-1)],qR=[new H(0,-1,0),new H(0,-1,0),new H(0,0,1),new H(0,0,-1),new H(0,-1,0),new H(0,-1,0)],Mb=new Le,sc=new H,Fg=new H;function YR(e,t,n){let i=new mo,s=new $t,a=new $t,r=new Re,o=new wh,l=new Ch,c={},d=n.maxTextureSize,p={[gs]:Ie,[Ie]:gs,[Pi]:Pi},u=new qn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new $t},radius:{value:4}},vertexShader:kR,fragmentShader:XR}),f=u.clone();f.defines.HORIZONTAL_PASS=1;let v=new Oi;v.setAttribute("position",new kn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let b=new jt(v,u),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Zl;let h=this.type;this.render=function(C,w,x){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||C.length===0)return;this.type===yS&&(Ut("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Zl);let E=e.getRenderTarget(),I=e.getActiveCubeFace(),R=e.getActiveMipmapLevel(),F=e.state;F.setBlending(Bi),F.buffers.depth.getReversed()===!0?F.buffers.color.setClear(0,0,0,0):F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);let V=h!==this.type;V&&w.traverse(function(X){X.material&&(Array.isArray(X.material)?X.material.forEach(G=>G.needsUpdate=!0):X.material.needsUpdate=!0)});for(let X=0,G=C.length;X<G;X++){let z=C[X],P=z.shadow;if(P===void 0){Ut("WebGLShadowMap:",z,"has no shadow.");continue}if(P.autoUpdate===!1&&P.needsUpdate===!1)continue;s.copy(P.mapSize);let et=P.getFrameExtents();s.multiply(et),a.copy(P.mapSize),(s.x>d||s.y>d)&&(s.x>d&&(a.x=Math.floor(d/et.x),s.x=a.x*et.x,P.mapSize.x=a.x),s.y>d&&(a.y=Math.floor(d/et.y),s.y=a.y*et.y,P.mapSize.y=a.y));let K=e.state.buffers.depth.getReversed();if(P.camera._reversedDepth=K,P.map===null||V===!0){if(P.map!==null&&(P.map.depthTexture!==null&&(P.map.depthTexture.dispose(),P.map.depthTexture=null),P.map.dispose()),this.type===vo){if(z.isPointLight){Ut("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}P.map=new Xn(s.x,s.y,{format:Za,type:Fi,minFilter:cn,magFilter:cn,generateMipmaps:!1}),P.map.texture.name=z.name+".shadowMap",P.map.depthTexture=new ra(s.x,s.y,xi),P.map.depthTexture.name=z.name+".shadowMapDepth",P.map.depthTexture.format=Li,P.map.depthTexture.compareFunction=null,P.map.depthTexture.minFilter=ze,P.map.depthTexture.magFilter=ze}else z.isPointLight?(P.map=new Nd(s.x),P.map.depthTexture=new Th(s.x,yi)):(P.map=new Xn(s.x,s.y),P.map.depthTexture=new ra(s.x,s.y,yi)),P.map.depthTexture.name=z.name+".shadowMap",P.map.depthTexture.format=Li,this.type===Zl?(P.map.depthTexture.compareFunction=K?Rd:Cd,P.map.depthTexture.minFilter=cn,P.map.depthTexture.magFilter=cn):(P.map.depthTexture.compareFunction=null,P.map.depthTexture.minFilter=ze,P.map.depthTexture.magFilter=ze);P.camera.updateProjectionMatrix()}let lt=P.map.isWebGLCubeRenderTarget?6:1;for(let mt=0;mt<lt;mt++){if(P.map.isWebGLCubeRenderTarget)e.setRenderTarget(P.map,mt),e.clear();else{mt===0&&(e.setRenderTarget(P.map),e.clear());let dt=P.getViewport(mt);r.set(a.x*dt.x,a.y*dt.y,a.x*dt.z,a.y*dt.w),F.viewport(r)}if(z.isPointLight){let dt=P.camera,Nt=P.matrix,ve=z.distance||dt.far;ve!==dt.far&&(dt.far=ve,dt.updateProjectionMatrix()),sc.setFromMatrixPosition(z.matrixWorld),dt.position.copy(sc),Fg.copy(dt.position),Fg.add(WR[mt]),dt.up.copy(qR[mt]),dt.lookAt(Fg),dt.updateMatrixWorld(),Nt.makeTranslation(-sc.x,-sc.y,-sc.z),Mb.multiplyMatrices(dt.projectionMatrix,dt.matrixWorldInverse),P._frustum.setFromProjectionMatrix(Mb,dt.coordinateSystem,dt.reversedDepth)}else P.updateMatrices(z);i=P.getFrustum(),S(w,x,P.camera,z,this.type)}P.isPointLightShadow!==!0&&this.type===vo&&m(P,x),P.needsUpdate=!1}h=this.type,g.needsUpdate=!1,e.setRenderTarget(E,I,R)};function m(C,w){let x=t.update(b);u.defines.VSM_SAMPLES!==C.blurSamples&&(u.defines.VSM_SAMPLES=C.blurSamples,f.defines.VSM_SAMPLES=C.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Xn(s.x,s.y,{format:Za,type:Fi})),u.uniforms.shadow_pass.value=C.map.depthTexture,u.uniforms.resolution.value=C.mapSize,u.uniforms.radius.value=C.radius,e.setRenderTarget(C.mapPass),e.clear(),e.renderBufferDirect(w,null,x,u,b,null),f.uniforms.shadow_pass.value=C.mapPass.texture,f.uniforms.resolution.value=C.mapSize,f.uniforms.radius.value=C.radius,e.setRenderTarget(C.map),e.clear(),e.renderBufferDirect(w,null,x,f,b,null)}function _(C,w,x,E){let I=null,R=x.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(R!==void 0)I=R;else if(I=x.isPointLight===!0?l:o,e.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let F=I.uuid,V=w.uuid,X=c[F];X===void 0&&(X={},c[F]=X);let G=X[V];G===void 0&&(G=I.clone(),X[V]=G,w.addEventListener("dispose",T)),I=G}if(I.visible=w.visible,I.wireframe=w.wireframe,E===vo?I.side=w.shadowSide!==null?w.shadowSide:w.side:I.side=w.shadowSide!==null?w.shadowSide:p[w.side],I.alphaMap=w.alphaMap,I.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,I.map=w.map,I.clipShadows=w.clipShadows,I.clippingPlanes=w.clippingPlanes,I.clipIntersection=w.clipIntersection,I.displacementMap=w.displacementMap,I.displacementScale=w.displacementScale,I.displacementBias=w.displacementBias,I.wireframeLinewidth=w.wireframeLinewidth,I.linewidth=w.linewidth,x.isPointLight===!0&&I.isMeshDistanceMaterial===!0){let F=e.properties.get(I);F.light=x}return I}function S(C,w,x,E,I){if(C.visible===!1)return;if(C.layers.test(w.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&I===vo)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,C.matrixWorld);let V=t.update(C),X=C.material;if(Array.isArray(X)){let G=V.groups;for(let z=0,P=G.length;z<P;z++){let et=G[z],K=X[et.materialIndex];if(K&&K.visible){let lt=_(C,K,E,I);C.onBeforeShadow(e,C,w,x,V,lt,et),e.renderBufferDirect(x,null,V,lt,C,et),C.onAfterShadow(e,C,w,x,V,lt,et)}}}else if(X.visible){let G=_(C,X,E,I);C.onBeforeShadow(e,C,w,x,V,G,null),e.renderBufferDirect(x,null,V,G,C,null),C.onAfterShadow(e,C,w,x,V,G,null)}}let F=C.children;for(let V=0,X=F.length;V<X;V++)S(F[V],w,x,E,I)}function T(C){C.target.removeEventListener("dispose",T);for(let x in c){let E=c[x],I=C.target.uuid;I in E&&(E[I].dispose(),delete E[I])}}}function ZR(e,t){function n(){let U=!1,ot=new Re,st=null,vt=new Re(0,0,0,0);return{setMask:function(tt){st!==tt&&!U&&(e.colorMask(tt,tt,tt,tt),st=tt)},setLocked:function(tt){U=tt},setClear:function(tt,W,xt,It,ye){ye===!0&&(tt*=It,W*=It,xt*=It),ot.set(tt,W,xt,It),vt.equals(ot)===!1&&(e.clearColor(tt,W,xt,It),vt.copy(ot))},reset:function(){U=!1,st=null,vt.set(-1,0,0,0)}}}function i(){let U=!1,ot=!1,st=null,vt=null,tt=null;return{setReversed:function(W){if(ot!==W){let xt=t.get("EXT_clip_control");W?xt.clipControlEXT(xt.LOWER_LEFT_EXT,xt.ZERO_TO_ONE_EXT):xt.clipControlEXT(xt.LOWER_LEFT_EXT,xt.NEGATIVE_ONE_TO_ONE_EXT),ot=W;let It=tt;tt=null,this.setClear(It)}},getReversed:function(){return ot},setTest:function(W){W?nt(e.DEPTH_TEST):at(e.DEPTH_TEST)},setMask:function(W){st!==W&&!U&&(e.depthMask(W),st=W)},setFunc:function(W){if(ot&&(W=QS[W]),vt!==W){switch(W){case ch:e.depthFunc(e.NEVER);break;case uh:e.depthFunc(e.ALWAYS);break;case hh:e.depthFunc(e.LESS);break;case Wa:e.depthFunc(e.LEQUAL);break;case dh:e.depthFunc(e.EQUAL);break;case fh:e.depthFunc(e.GEQUAL);break;case ph:e.depthFunc(e.GREATER);break;case mh:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}vt=W}},setLocked:function(W){U=W},setClear:function(W){tt!==W&&(tt=W,ot&&(W=1-W),e.clearDepth(W))},reset:function(){U=!1,st=null,vt=null,tt=null,ot=!1}}}function s(){let U=!1,ot=null,st=null,vt=null,tt=null,W=null,xt=null,It=null,ye=null;return{setTest:function(re){U||(re?nt(e.STENCIL_TEST):at(e.STENCIL_TEST))},setMask:function(re){ot!==re&&!U&&(e.stencilMask(re),ot=re)},setFunc:function(re,Hi,Gi){(st!==re||vt!==Hi||tt!==Gi)&&(e.stencilFunc(re,Hi,Gi),st=re,vt=Hi,tt=Gi)},setOp:function(re,Hi,Gi){(W!==re||xt!==Hi||It!==Gi)&&(e.stencilOp(re,Hi,Gi),W=re,xt=Hi,It=Gi)},setLocked:function(re){U=re},setClear:function(re){ye!==re&&(e.clearStencil(re),ye=re)},reset:function(){U=!1,ot=null,st=null,vt=null,tt=null,W=null,xt=null,It=null,ye=null}}}let a=new n,r=new i,o=new s,l=new WeakMap,c=new WeakMap,d={},p={},u=new WeakMap,f=[],v=null,b=!1,g=null,h=null,m=null,_=null,S=null,T=null,C=null,w=new kt(0,0,0),x=0,E=!1,I=null,R=null,F=null,V=null,X=null,G=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS),z=!1,P=0,et=e.getParameter(e.VERSION);et.indexOf("WebGL")!==-1?(P=parseFloat(/^WebGL (\d)/.exec(et)[1]),z=P>=1):et.indexOf("OpenGL ES")!==-1&&(P=parseFloat(/^OpenGL ES (\d)/.exec(et)[1]),z=P>=2);let K=null,lt={},mt=e.getParameter(e.SCISSOR_BOX),dt=e.getParameter(e.VIEWPORT),Nt=new Re().fromArray(mt),ve=new Re().fromArray(dt);function ce(U,ot,st,vt){let tt=new Uint8Array(4),W=e.createTexture();e.bindTexture(U,W),e.texParameteri(U,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(U,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let xt=0;xt<st;xt++)U===e.TEXTURE_3D||U===e.TEXTURE_2D_ARRAY?e.texImage3D(ot,0,e.RGBA,1,1,vt,0,e.RGBA,e.UNSIGNED_BYTE,tt):e.texImage2D(ot+xt,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,tt);return W}let Z={};Z[e.TEXTURE_2D]=ce(e.TEXTURE_2D,e.TEXTURE_2D,1),Z[e.TEXTURE_CUBE_MAP]=ce(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[e.TEXTURE_2D_ARRAY]=ce(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),Z[e.TEXTURE_3D]=ce(e.TEXTURE_3D,e.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),nt(e.DEPTH_TEST),r.setFunc(Wa),Vt(!1),Oe(og),nt(e.CULL_FACE),te(Bi);function nt(U){d[U]!==!0&&(e.enable(U),d[U]=!0)}function at(U){d[U]!==!1&&(e.disable(U),d[U]=!1)}function Lt(U,ot){return p[U]!==ot?(e.bindFramebuffer(U,ot),p[U]=ot,U===e.DRAW_FRAMEBUFFER&&(p[e.FRAMEBUFFER]=ot),U===e.FRAMEBUFFER&&(p[e.DRAW_FRAMEBUFFER]=ot),!0):!1}function Q(U,ot){let st=f,vt=!1;if(U){st=u.get(ot),st===void 0&&(st=[],u.set(ot,st));let tt=U.textures;if(st.length!==tt.length||st[0]!==e.COLOR_ATTACHMENT0){for(let W=0,xt=tt.length;W<xt;W++)st[W]=e.COLOR_ATTACHMENT0+W;st.length=tt.length,vt=!0}}else st[0]!==e.BACK&&(st[0]=e.BACK,vt=!0);vt&&e.drawBuffers(st)}function ft(U){return v!==U?(e.useProgram(U),v=U,!0):!1}let Ce={[ia]:e.FUNC_ADD,[SS]:e.FUNC_SUBTRACT,[bS]:e.FUNC_REVERSE_SUBTRACT};Ce[MS]=e.MIN,Ce[ES]=e.MAX;let Yt={[TS]:e.ZERO,[AS]:e.ONE,[wS]:e.SRC_COLOR,[oh]:e.SRC_ALPHA,[LS]:e.SRC_ALPHA_SATURATE,[US]:e.DST_COLOR,[RS]:e.DST_ALPHA,[CS]:e.ONE_MINUS_SRC_COLOR,[lh]:e.ONE_MINUS_SRC_ALPHA,[NS]:e.ONE_MINUS_DST_COLOR,[DS]:e.ONE_MINUS_DST_ALPHA,[IS]:e.CONSTANT_COLOR,[OS]:e.ONE_MINUS_CONSTANT_COLOR,[PS]:e.CONSTANT_ALPHA,[BS]:e.ONE_MINUS_CONSTANT_ALPHA};function te(U,ot,st,vt,tt,W,xt,It,ye,re){if(U===Bi){b===!0&&(at(e.BLEND),b=!1);return}if(b===!1&&(nt(e.BLEND),b=!0),U!==xS){if(U!==g||re!==E){if((h!==ia||S!==ia)&&(e.blendEquation(e.FUNC_ADD),h=ia,S=ia),re)switch(U){case Xa:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case lg:e.blendFunc(e.ONE,e.ONE);break;case cg:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case ug:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:Dt("WebGLState: Invalid blending: ",U);break}else switch(U){case Xa:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case lg:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case cg:Dt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ug:Dt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Dt("WebGLState: Invalid blending: ",U);break}m=null,_=null,T=null,C=null,w.set(0,0,0),x=0,g=U,E=re}return}tt=tt||ot,W=W||st,xt=xt||vt,(ot!==h||tt!==S)&&(e.blendEquationSeparate(Ce[ot],Ce[tt]),h=ot,S=tt),(st!==m||vt!==_||W!==T||xt!==C)&&(e.blendFuncSeparate(Yt[st],Yt[vt],Yt[W],Yt[xt]),m=st,_=vt,T=W,C=xt),(It.equals(w)===!1||ye!==x)&&(e.blendColor(It.r,It.g,It.b,ye),w.copy(It),x=ye),g=U,E=!1}function ie(U,ot){U.side===Pi?at(e.CULL_FACE):nt(e.CULL_FACE);let st=U.side===Ie;ot&&(st=!st),Vt(st),U.blending===Xa&&U.transparent===!1?te(Bi):te(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),r.setFunc(U.depthFunc),r.setTest(U.depthTest),r.setMask(U.depthWrite),a.setMask(U.colorWrite);let vt=U.stencilWrite;o.setTest(vt),vt&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),Ve(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?nt(e.SAMPLE_ALPHA_TO_COVERAGE):at(e.SAMPLE_ALPHA_TO_COVERAGE)}function Vt(U){I!==U&&(U?e.frontFace(e.CW):e.frontFace(e.CCW),I=U)}function Oe(U){U!==vS?(nt(e.CULL_FACE),U!==R&&(U===og?e.cullFace(e.BACK):U===_S?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):at(e.CULL_FACE),R=U}function D(U){U!==F&&(z&&e.lineWidth(U),F=U)}function Ve(U,ot,st){U?(nt(e.POLYGON_OFFSET_FILL),(V!==ot||X!==st)&&(V=ot,X=st,r.getReversed()&&(ot=-ot),e.polygonOffset(ot,st))):at(e.POLYGON_OFFSET_FILL)}function se(U){U?nt(e.SCISSOR_TEST):at(e.SCISSOR_TEST)}function _e(U){U===void 0&&(U=e.TEXTURE0+G-1),K!==U&&(e.activeTexture(U),K=U)}function Mt(U,ot,st){st===void 0&&(K===null?st=e.TEXTURE0+G-1:st=K);let vt=lt[st];vt===void 0&&(vt={type:void 0,texture:void 0},lt[st]=vt),(vt.type!==U||vt.texture!==ot)&&(K!==st&&(e.activeTexture(st),K=st),e.bindTexture(U,ot||Z[U]),vt.type=U,vt.texture=ot)}function A(){let U=lt[K];U!==void 0&&U.type!==void 0&&(e.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function y(){try{e.compressedTexImage2D(...arguments)}catch(U){Dt("WebGLState:",U)}}function N(){try{e.compressedTexImage3D(...arguments)}catch(U){Dt("WebGLState:",U)}}function Y(){try{e.texSubImage2D(...arguments)}catch(U){Dt("WebGLState:",U)}}function j(){try{e.texSubImage3D(...arguments)}catch(U){Dt("WebGLState:",U)}}function q(){try{e.compressedTexSubImage2D(...arguments)}catch(U){Dt("WebGLState:",U)}}function _t(){try{e.compressedTexSubImage3D(...arguments)}catch(U){Dt("WebGLState:",U)}}function rt(){try{e.texStorage2D(...arguments)}catch(U){Dt("WebGLState:",U)}}function wt(){try{e.texStorage3D(...arguments)}catch(U){Dt("WebGLState:",U)}}function Ct(){try{e.texImage2D(...arguments)}catch(U){Dt("WebGLState:",U)}}function $(){try{e.texImage3D(...arguments)}catch(U){Dt("WebGLState:",U)}}function it(U){Nt.equals(U)===!1&&(e.scissor(U.x,U.y,U.z,U.w),Nt.copy(U))}function yt(U){ve.equals(U)===!1&&(e.viewport(U.x,U.y,U.z,U.w),ve.copy(U))}function St(U,ot){let st=c.get(ot);st===void 0&&(st=new WeakMap,c.set(ot,st));let vt=st.get(U);vt===void 0&&(vt=e.getUniformBlockIndex(ot,U.name),st.set(U,vt))}function pt(U,ot){let vt=c.get(ot).get(U);l.get(ot)!==vt&&(e.uniformBlockBinding(ot,vt,U.__bindingPointIndex),l.set(ot,vt))}function Ht(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),r.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),d={},K=null,lt={},p={},u=new WeakMap,f=[],v=null,b=!1,g=null,h=null,m=null,_=null,S=null,T=null,C=null,w=new kt(0,0,0),x=0,E=!1,I=null,R=null,F=null,V=null,X=null,Nt.set(0,0,e.canvas.width,e.canvas.height),ve.set(0,0,e.canvas.width,e.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:nt,disable:at,bindFramebuffer:Lt,drawBuffers:Q,useProgram:ft,setBlending:te,setMaterial:ie,setFlipSided:Vt,setCullFace:Oe,setLineWidth:D,setPolygonOffset:Ve,setScissorTest:se,activeTexture:_e,bindTexture:Mt,unbindTexture:A,compressedTexImage2D:y,compressedTexImage3D:N,texImage2D:Ct,texImage3D:$,updateUBOMapping:St,uniformBlockBinding:pt,texStorage2D:rt,texStorage3D:wt,texSubImage2D:Y,texSubImage3D:j,compressedTexSubImage2D:q,compressedTexSubImage3D:_t,scissor:it,viewport:yt,reset:Ht}}function JR(e,t,n,i,s,a,r){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new $t,d=new WeakMap,p,u=new WeakMap,f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(A,y){return f?new OffscreenCanvas(A,y):lo("canvas")}function b(A,y,N){let Y=1,j=Mt(A);if((j.width>N||j.height>N)&&(Y=N/Math.max(j.width,j.height)),Y<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){let q=Math.floor(Y*j.width),_t=Math.floor(Y*j.height);p===void 0&&(p=v(q,_t));let rt=y?v(q,_t):p;return rt.width=q,rt.height=_t,rt.getContext("2d").drawImage(A,0,0,q,_t),Ut("WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+q+"x"+_t+")."),rt}else return"data"in A&&Ut("WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),A;return A}function g(A){return A.generateMipmaps}function h(A){e.generateMipmap(A)}function m(A){return A.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?e.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function _(A,y,N,Y,j=!1){if(A!==null){if(e[A]!==void 0)return e[A];Ut("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let q=y;if(y===e.RED&&(N===e.FLOAT&&(q=e.R32F),N===e.HALF_FLOAT&&(q=e.R16F),N===e.UNSIGNED_BYTE&&(q=e.R8)),y===e.RED_INTEGER&&(N===e.UNSIGNED_BYTE&&(q=e.R8UI),N===e.UNSIGNED_SHORT&&(q=e.R16UI),N===e.UNSIGNED_INT&&(q=e.R32UI),N===e.BYTE&&(q=e.R8I),N===e.SHORT&&(q=e.R16I),N===e.INT&&(q=e.R32I)),y===e.RG&&(N===e.FLOAT&&(q=e.RG32F),N===e.HALF_FLOAT&&(q=e.RG16F),N===e.UNSIGNED_BYTE&&(q=e.RG8)),y===e.RG_INTEGER&&(N===e.UNSIGNED_BYTE&&(q=e.RG8UI),N===e.UNSIGNED_SHORT&&(q=e.RG16UI),N===e.UNSIGNED_INT&&(q=e.RG32UI),N===e.BYTE&&(q=e.RG8I),N===e.SHORT&&(q=e.RG16I),N===e.INT&&(q=e.RG32I)),y===e.RGB_INTEGER&&(N===e.UNSIGNED_BYTE&&(q=e.RGB8UI),N===e.UNSIGNED_SHORT&&(q=e.RGB16UI),N===e.UNSIGNED_INT&&(q=e.RGB32UI),N===e.BYTE&&(q=e.RGB8I),N===e.SHORT&&(q=e.RGB16I),N===e.INT&&(q=e.RGB32I)),y===e.RGBA_INTEGER&&(N===e.UNSIGNED_BYTE&&(q=e.RGBA8UI),N===e.UNSIGNED_SHORT&&(q=e.RGBA16UI),N===e.UNSIGNED_INT&&(q=e.RGBA32UI),N===e.BYTE&&(q=e.RGBA8I),N===e.SHORT&&(q=e.RGBA16I),N===e.INT&&(q=e.RGBA32I)),y===e.RGB&&(N===e.UNSIGNED_INT_5_9_9_9_REV&&(q=e.RGB9_E5),N===e.UNSIGNED_INT_10F_11F_11F_REV&&(q=e.R11F_G11F_B10F)),y===e.RGBA){let _t=j?Nl:Kt.getTransfer(Y);N===e.FLOAT&&(q=e.RGBA32F),N===e.HALF_FLOAT&&(q=e.RGBA16F),N===e.UNSIGNED_BYTE&&(q=_t===ae?e.SRGB8_ALPHA8:e.RGBA8),N===e.UNSIGNED_SHORT_4_4_4_4&&(q=e.RGBA4),N===e.UNSIGNED_SHORT_5_5_5_1&&(q=e.RGB5_A1)}return(q===e.R16F||q===e.R32F||q===e.RG16F||q===e.RG32F||q===e.RGBA16F||q===e.RGBA32F)&&t.get("EXT_color_buffer_float"),q}function S(A,y){let N;return A?y===null||y===yi||y===yo?N=e.DEPTH24_STENCIL8:y===xi?N=e.DEPTH32F_STENCIL8:y===_o&&(N=e.DEPTH24_STENCIL8,Ut("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===yi||y===yo?N=e.DEPTH_COMPONENT24:y===xi?N=e.DEPTH_COMPONENT32F:y===_o&&(N=e.DEPTH_COMPONENT16),N}function T(A,y){return g(A)===!0||A.isFramebufferTexture&&A.minFilter!==ze&&A.minFilter!==cn?Math.log2(Math.max(y.width,y.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?y.mipmaps.length:1}function C(A){let y=A.target;y.removeEventListener("dispose",C),x(y),y.isVideoTexture&&d.delete(y)}function w(A){let y=A.target;y.removeEventListener("dispose",w),I(y)}function x(A){let y=i.get(A);if(y.__webglInit===void 0)return;let N=A.source,Y=u.get(N);if(Y){let j=Y[y.__cacheKey];j.usedTimes--,j.usedTimes===0&&E(A),Object.keys(Y).length===0&&u.delete(N)}i.remove(A)}function E(A){let y=i.get(A);e.deleteTexture(y.__webglTexture);let N=A.source,Y=u.get(N);delete Y[y.__cacheKey],r.memory.textures--}function I(A){let y=i.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),i.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(y.__webglFramebuffer[Y]))for(let j=0;j<y.__webglFramebuffer[Y].length;j++)e.deleteFramebuffer(y.__webglFramebuffer[Y][j]);else e.deleteFramebuffer(y.__webglFramebuffer[Y]);y.__webglDepthbuffer&&e.deleteRenderbuffer(y.__webglDepthbuffer[Y])}else{if(Array.isArray(y.__webglFramebuffer))for(let Y=0;Y<y.__webglFramebuffer.length;Y++)e.deleteFramebuffer(y.__webglFramebuffer[Y]);else e.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&e.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&e.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let Y=0;Y<y.__webglColorRenderbuffer.length;Y++)y.__webglColorRenderbuffer[Y]&&e.deleteRenderbuffer(y.__webglColorRenderbuffer[Y]);y.__webglDepthRenderbuffer&&e.deleteRenderbuffer(y.__webglDepthRenderbuffer)}let N=A.textures;for(let Y=0,j=N.length;Y<j;Y++){let q=i.get(N[Y]);q.__webglTexture&&(e.deleteTexture(q.__webglTexture),r.memory.textures--),i.remove(N[Y])}i.remove(A)}let R=0;function F(){R=0}function V(){let A=R;return A>=s.maxTextures&&Ut("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),R+=1,A}function X(A){let y=[];return y.push(A.wrapS),y.push(A.wrapT),y.push(A.wrapR||0),y.push(A.magFilter),y.push(A.minFilter),y.push(A.anisotropy),y.push(A.internalFormat),y.push(A.format),y.push(A.type),y.push(A.generateMipmaps),y.push(A.premultiplyAlpha),y.push(A.flipY),y.push(A.unpackAlignment),y.push(A.colorSpace),y.join()}function G(A,y){let N=i.get(A);if(A.isVideoTexture&&se(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&N.__version!==A.version){let Y=A.image;if(Y===null)Ut("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Ut("WebGLRenderer: Texture marked for update but image is incomplete");else{Z(N,A,y);return}}else A.isExternalTexture&&(N.__webglTexture=A.sourceTexture?A.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,N.__webglTexture,e.TEXTURE0+y)}function z(A,y){let N=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&N.__version!==A.version){Z(N,A,y);return}else A.isExternalTexture&&(N.__webglTexture=A.sourceTexture?A.sourceTexture:null);n.bindTexture(e.TEXTURE_2D_ARRAY,N.__webglTexture,e.TEXTURE0+y)}function P(A,y){let N=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&N.__version!==A.version){Z(N,A,y);return}n.bindTexture(e.TEXTURE_3D,N.__webglTexture,e.TEXTURE0+y)}function et(A,y){let N=i.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&N.__version!==A.version){nt(N,A,y);return}n.bindTexture(e.TEXTURE_CUBE_MAP,N.__webglTexture,e.TEXTURE0+y)}let K={[gh]:e.REPEAT,[Ni]:e.CLAMP_TO_EDGE,[vh]:e.MIRRORED_REPEAT},lt={[ze]:e.NEAREST,[VS]:e.NEAREST_MIPMAP_NEAREST,[Kl]:e.NEAREST_MIPMAP_LINEAR,[cn]:e.LINEAR,[kh]:e.LINEAR_MIPMAP_NEAREST,[da]:e.LINEAR_MIPMAP_LINEAR},mt={[kS]:e.NEVER,[ZS]:e.ALWAYS,[XS]:e.LESS,[Cd]:e.LEQUAL,[WS]:e.EQUAL,[Rd]:e.GEQUAL,[qS]:e.GREATER,[YS]:e.NOTEQUAL};function dt(A,y){if(y.type===xi&&t.has("OES_texture_float_linear")===!1&&(y.magFilter===cn||y.magFilter===kh||y.magFilter===Kl||y.magFilter===da||y.minFilter===cn||y.minFilter===kh||y.minFilter===Kl||y.minFilter===da)&&Ut("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(A,e.TEXTURE_WRAP_S,K[y.wrapS]),e.texParameteri(A,e.TEXTURE_WRAP_T,K[y.wrapT]),(A===e.TEXTURE_3D||A===e.TEXTURE_2D_ARRAY)&&e.texParameteri(A,e.TEXTURE_WRAP_R,K[y.wrapR]),e.texParameteri(A,e.TEXTURE_MAG_FILTER,lt[y.magFilter]),e.texParameteri(A,e.TEXTURE_MIN_FILTER,lt[y.minFilter]),y.compareFunction&&(e.texParameteri(A,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(A,e.TEXTURE_COMPARE_FUNC,mt[y.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===ze||y.minFilter!==Kl&&y.minFilter!==da||y.type===xi&&t.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||i.get(y).__currentAnisotropy){let N=t.get("EXT_texture_filter_anisotropic");e.texParameterf(A,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,s.getMaxAnisotropy())),i.get(y).__currentAnisotropy=y.anisotropy}}}function Nt(A,y){let N=!1;A.__webglInit===void 0&&(A.__webglInit=!0,y.addEventListener("dispose",C));let Y=y.source,j=u.get(Y);j===void 0&&(j={},u.set(Y,j));let q=X(y);if(q!==A.__cacheKey){j[q]===void 0&&(j[q]={texture:e.createTexture(),usedTimes:0},r.memory.textures++,N=!0),j[q].usedTimes++;let _t=j[A.__cacheKey];_t!==void 0&&(j[A.__cacheKey].usedTimes--,_t.usedTimes===0&&E(y)),A.__cacheKey=q,A.__webglTexture=j[q].texture}return N}function ve(A,y,N){return Math.floor(Math.floor(A/N)/y)}function ce(A,y,N,Y){let q=A.updateRanges;if(q.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,y.width,y.height,N,Y,y.data);else{q.sort(($,it)=>$.start-it.start);let _t=0;for(let $=1;$<q.length;$++){let it=q[_t],yt=q[$],St=it.start+it.count,pt=ve(yt.start,y.width,4),Ht=ve(it.start,y.width,4);yt.start<=St+1&&pt===Ht&&ve(yt.start+yt.count-1,y.width,4)===pt?it.count=Math.max(it.count,yt.start+yt.count-it.start):(++_t,q[_t]=yt)}q.length=_t+1;let rt=e.getParameter(e.UNPACK_ROW_LENGTH),wt=e.getParameter(e.UNPACK_SKIP_PIXELS),Ct=e.getParameter(e.UNPACK_SKIP_ROWS);e.pixelStorei(e.UNPACK_ROW_LENGTH,y.width);for(let $=0,it=q.length;$<it;$++){let yt=q[$],St=Math.floor(yt.start/4),pt=Math.ceil(yt.count/4),Ht=St%y.width,U=Math.floor(St/y.width),ot=pt,st=1;e.pixelStorei(e.UNPACK_SKIP_PIXELS,Ht),e.pixelStorei(e.UNPACK_SKIP_ROWS,U),n.texSubImage2D(e.TEXTURE_2D,0,Ht,U,ot,st,N,Y,y.data)}A.clearUpdateRanges(),e.pixelStorei(e.UNPACK_ROW_LENGTH,rt),e.pixelStorei(e.UNPACK_SKIP_PIXELS,wt),e.pixelStorei(e.UNPACK_SKIP_ROWS,Ct)}}function Z(A,y,N){let Y=e.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(Y=e.TEXTURE_2D_ARRAY),y.isData3DTexture&&(Y=e.TEXTURE_3D);let j=Nt(A,y),q=y.source;n.bindTexture(Y,A.__webglTexture,e.TEXTURE0+N);let _t=i.get(q);if(q.version!==_t.__version||j===!0){n.activeTexture(e.TEXTURE0+N);let rt=Kt.getPrimaries(Kt.workingColorSpace),wt=y.colorSpace===_s?null:Kt.getPrimaries(y.colorSpace),Ct=y.colorSpace===_s||rt===wt?e.NONE:e.BROWSER_DEFAULT_WEBGL;e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,y.flipY),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),e.pixelStorei(e.UNPACK_ALIGNMENT,y.unpackAlignment),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ct);let $=b(y.image,!1,s.maxTextureSize);$=_e(y,$);let it=a.convert(y.format,y.colorSpace),yt=a.convert(y.type),St=_(y.internalFormat,it,yt,y.colorSpace,y.isVideoTexture);dt(Y,y);let pt,Ht=y.mipmaps,U=y.isVideoTexture!==!0,ot=_t.__version===void 0||j===!0,st=q.dataReady,vt=T(y,$);if(y.isDepthTexture)St=S(y.format===fa,y.type),ot&&(U?n.texStorage2D(e.TEXTURE_2D,1,St,$.width,$.height):n.texImage2D(e.TEXTURE_2D,0,St,$.width,$.height,0,it,yt,null));else if(y.isDataTexture)if(Ht.length>0){U&&ot&&n.texStorage2D(e.TEXTURE_2D,vt,St,Ht[0].width,Ht[0].height);for(let tt=0,W=Ht.length;tt<W;tt++)pt=Ht[tt],U?st&&n.texSubImage2D(e.TEXTURE_2D,tt,0,0,pt.width,pt.height,it,yt,pt.data):n.texImage2D(e.TEXTURE_2D,tt,St,pt.width,pt.height,0,it,yt,pt.data);y.generateMipmaps=!1}else U?(ot&&n.texStorage2D(e.TEXTURE_2D,vt,St,$.width,$.height),st&&ce(y,$,it,yt)):n.texImage2D(e.TEXTURE_2D,0,St,$.width,$.height,0,it,yt,$.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){U&&ot&&n.texStorage3D(e.TEXTURE_2D_ARRAY,vt,St,Ht[0].width,Ht[0].height,$.depth);for(let tt=0,W=Ht.length;tt<W;tt++)if(pt=Ht[tt],y.format!==oi)if(it!==null)if(U){if(st)if(y.layerUpdates.size>0){let xt=Ng(pt.width,pt.height,y.format,y.type);for(let It of y.layerUpdates){let ye=pt.data.subarray(It*xt/pt.data.BYTES_PER_ELEMENT,(It+1)*xt/pt.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,tt,0,0,It,pt.width,pt.height,1,it,ye)}y.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,tt,0,0,0,pt.width,pt.height,$.depth,it,pt.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,tt,St,pt.width,pt.height,$.depth,0,pt.data,0,0);else Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else U?st&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,tt,0,0,0,pt.width,pt.height,$.depth,it,yt,pt.data):n.texImage3D(e.TEXTURE_2D_ARRAY,tt,St,pt.width,pt.height,$.depth,0,it,yt,pt.data)}else{U&&ot&&n.texStorage2D(e.TEXTURE_2D,vt,St,Ht[0].width,Ht[0].height);for(let tt=0,W=Ht.length;tt<W;tt++)pt=Ht[tt],y.format!==oi?it!==null?U?st&&n.compressedTexSubImage2D(e.TEXTURE_2D,tt,0,0,pt.width,pt.height,it,pt.data):n.compressedTexImage2D(e.TEXTURE_2D,tt,St,pt.width,pt.height,0,pt.data):Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?st&&n.texSubImage2D(e.TEXTURE_2D,tt,0,0,pt.width,pt.height,it,yt,pt.data):n.texImage2D(e.TEXTURE_2D,tt,St,pt.width,pt.height,0,it,yt,pt.data)}else if(y.isDataArrayTexture)if(U){if(ot&&n.texStorage3D(e.TEXTURE_2D_ARRAY,vt,St,$.width,$.height,$.depth),st)if(y.layerUpdates.size>0){let tt=Ng($.width,$.height,y.format,y.type);for(let W of y.layerUpdates){let xt=$.data.subarray(W*tt/$.data.BYTES_PER_ELEMENT,(W+1)*tt/$.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,W,$.width,$.height,1,it,yt,xt)}y.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,it,yt,$.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,St,$.width,$.height,$.depth,0,it,yt,$.data);else if(y.isData3DTexture)U?(ot&&n.texStorage3D(e.TEXTURE_3D,vt,St,$.width,$.height,$.depth),st&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,it,yt,$.data)):n.texImage3D(e.TEXTURE_3D,0,St,$.width,$.height,$.depth,0,it,yt,$.data);else if(y.isFramebufferTexture){if(ot)if(U)n.texStorage2D(e.TEXTURE_2D,vt,St,$.width,$.height);else{let tt=$.width,W=$.height;for(let xt=0;xt<vt;xt++)n.texImage2D(e.TEXTURE_2D,xt,St,tt,W,0,it,yt,null),tt>>=1,W>>=1}}else if(Ht.length>0){if(U&&ot){let tt=Mt(Ht[0]);n.texStorage2D(e.TEXTURE_2D,vt,St,tt.width,tt.height)}for(let tt=0,W=Ht.length;tt<W;tt++)pt=Ht[tt],U?st&&n.texSubImage2D(e.TEXTURE_2D,tt,0,0,it,yt,pt):n.texImage2D(e.TEXTURE_2D,tt,St,it,yt,pt);y.generateMipmaps=!1}else if(U){if(ot){let tt=Mt($);n.texStorage2D(e.TEXTURE_2D,vt,St,tt.width,tt.height)}st&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,it,yt,$)}else n.texImage2D(e.TEXTURE_2D,0,St,it,yt,$);g(y)&&h(Y),_t.__version=q.version,y.onUpdate&&y.onUpdate(y)}A.__version=y.version}function nt(A,y,N){if(y.image.length!==6)return;let Y=Nt(A,y),j=y.source;n.bindTexture(e.TEXTURE_CUBE_MAP,A.__webglTexture,e.TEXTURE0+N);let q=i.get(j);if(j.version!==q.__version||Y===!0){n.activeTexture(e.TEXTURE0+N);let _t=Kt.getPrimaries(Kt.workingColorSpace),rt=y.colorSpace===_s?null:Kt.getPrimaries(y.colorSpace),wt=y.colorSpace===_s||_t===rt?e.NONE:e.BROWSER_DEFAULT_WEBGL;e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,y.flipY),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),e.pixelStorei(e.UNPACK_ALIGNMENT,y.unpackAlignment),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,wt);let Ct=y.isCompressedTexture||y.image[0].isCompressedTexture,$=y.image[0]&&y.image[0].isDataTexture,it=[];for(let W=0;W<6;W++)!Ct&&!$?it[W]=b(y.image[W],!0,s.maxCubemapSize):it[W]=$?y.image[W].image:y.image[W],it[W]=_e(y,it[W]);let yt=it[0],St=a.convert(y.format,y.colorSpace),pt=a.convert(y.type),Ht=_(y.internalFormat,St,pt,y.colorSpace),U=y.isVideoTexture!==!0,ot=q.__version===void 0||Y===!0,st=j.dataReady,vt=T(y,yt);dt(e.TEXTURE_CUBE_MAP,y);let tt;if(Ct){U&&ot&&n.texStorage2D(e.TEXTURE_CUBE_MAP,vt,Ht,yt.width,yt.height);for(let W=0;W<6;W++){tt=it[W].mipmaps;for(let xt=0;xt<tt.length;xt++){let It=tt[xt];y.format!==oi?St!==null?U?st&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,xt,0,0,It.width,It.height,St,It.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,xt,Ht,It.width,It.height,0,It.data):Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?st&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,xt,0,0,It.width,It.height,St,pt,It.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,xt,Ht,It.width,It.height,0,St,pt,It.data)}}}else{if(tt=y.mipmaps,U&&ot){tt.length>0&&vt++;let W=Mt(it[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,vt,Ht,W.width,W.height)}for(let W=0;W<6;W++)if($){U?st&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,0,0,0,it[W].width,it[W].height,St,pt,it[W].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,0,Ht,it[W].width,it[W].height,0,St,pt,it[W].data);for(let xt=0;xt<tt.length;xt++){let ye=tt[xt].image[W].image;U?st&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,xt+1,0,0,ye.width,ye.height,St,pt,ye.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,xt+1,Ht,ye.width,ye.height,0,St,pt,ye.data)}}else{U?st&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,0,0,0,St,pt,it[W]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,0,Ht,St,pt,it[W]);for(let xt=0;xt<tt.length;xt++){let It=tt[xt];U?st&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,xt+1,0,0,St,pt,It.image[W]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+W,xt+1,Ht,St,pt,It.image[W])}}}g(y)&&h(e.TEXTURE_CUBE_MAP),q.__version=j.version,y.onUpdate&&y.onUpdate(y)}A.__version=y.version}function at(A,y,N,Y,j,q){let _t=a.convert(N.format,N.colorSpace),rt=a.convert(N.type),wt=_(N.internalFormat,_t,rt,N.colorSpace),Ct=i.get(y),$=i.get(N);if($.__renderTarget=y,!Ct.__hasExternalTextures){let it=Math.max(1,y.width>>q),yt=Math.max(1,y.height>>q);j===e.TEXTURE_3D||j===e.TEXTURE_2D_ARRAY?n.texImage3D(j,q,wt,it,yt,y.depth,0,_t,rt,null):n.texImage2D(j,q,wt,it,yt,0,_t,rt,null)}n.bindFramebuffer(e.FRAMEBUFFER,A),Ve(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,Y,j,$.__webglTexture,0,D(y)):(j===e.TEXTURE_2D||j>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,Y,j,$.__webglTexture,q),n.bindFramebuffer(e.FRAMEBUFFER,null)}function Lt(A,y,N){if(e.bindRenderbuffer(e.RENDERBUFFER,A),y.depthBuffer){let Y=y.depthTexture,j=Y&&Y.isDepthTexture?Y.type:null,q=S(y.stencilBuffer,j),_t=y.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;Ve(y)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,D(y),q,y.width,y.height):N?e.renderbufferStorageMultisample(e.RENDERBUFFER,D(y),q,y.width,y.height):e.renderbufferStorage(e.RENDERBUFFER,q,y.width,y.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,_t,e.RENDERBUFFER,A)}else{let Y=y.textures;for(let j=0;j<Y.length;j++){let q=Y[j],_t=a.convert(q.format,q.colorSpace),rt=a.convert(q.type),wt=_(q.internalFormat,_t,rt,q.colorSpace);Ve(y)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,D(y),wt,y.width,y.height):N?e.renderbufferStorageMultisample(e.RENDERBUFFER,D(y),wt,y.width,y.height):e.renderbufferStorage(e.RENDERBUFFER,wt,y.width,y.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function Q(A,y,N){let Y=y.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(e.FRAMEBUFFER,A),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let j=i.get(y.depthTexture);if(j.__renderTarget=y,(!j.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),Y){if(j.__webglInit===void 0&&(j.__webglInit=!0,y.depthTexture.addEventListener("dispose",C)),j.__webglTexture===void 0){j.__webglTexture=e.createTexture(),n.bindTexture(e.TEXTURE_CUBE_MAP,j.__webglTexture),dt(e.TEXTURE_CUBE_MAP,y.depthTexture);let Ct=a.convert(y.depthTexture.format),$=a.convert(y.depthTexture.type),it;y.depthTexture.format===Li?it=e.DEPTH_COMPONENT24:y.depthTexture.format===fa&&(it=e.DEPTH24_STENCIL8);for(let yt=0;yt<6;yt++)e.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,it,y.width,y.height,0,Ct,$,null)}}else G(y.depthTexture,0);let q=j.__webglTexture,_t=D(y),rt=Y?e.TEXTURE_CUBE_MAP_POSITIVE_X+N:e.TEXTURE_2D,wt=y.depthTexture.format===fa?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;if(y.depthTexture.format===Li)Ve(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,wt,rt,q,0,_t):e.framebufferTexture2D(e.FRAMEBUFFER,wt,rt,q,0);else if(y.depthTexture.format===fa)Ve(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,wt,rt,q,0,_t):e.framebufferTexture2D(e.FRAMEBUFFER,wt,rt,q,0);else throw new Error("Unknown depthTexture format")}function ft(A){let y=i.get(A),N=A.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==A.depthTexture){let Y=A.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),Y){let j=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,Y.removeEventListener("dispose",j)};Y.addEventListener("dispose",j),y.__depthDisposeCallback=j}y.__boundDepthTexture=Y}if(A.depthTexture&&!y.__autoAllocateDepthBuffer)if(N)for(let Y=0;Y<6;Y++)Q(y.__webglFramebuffer[Y],A,Y);else{let Y=A.texture.mipmaps;Y&&Y.length>0?Q(y.__webglFramebuffer[0],A,0):Q(y.__webglFramebuffer,A,0)}else if(N){y.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer[Y]),y.__webglDepthbuffer[Y]===void 0)y.__webglDepthbuffer[Y]=e.createRenderbuffer(),Lt(y.__webglDepthbuffer[Y],A,!1);else{let j=A.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,q=y.__webglDepthbuffer[Y];e.bindRenderbuffer(e.RENDERBUFFER,q),e.framebufferRenderbuffer(e.FRAMEBUFFER,j,e.RENDERBUFFER,q)}}else{let Y=A.texture.mipmaps;if(Y&&Y.length>0?n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=e.createRenderbuffer(),Lt(y.__webglDepthbuffer,A,!1);else{let j=A.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,q=y.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,q),e.framebufferRenderbuffer(e.FRAMEBUFFER,j,e.RENDERBUFFER,q)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function Ce(A,y,N){let Y=i.get(A);y!==void 0&&at(Y.__webglFramebuffer,A,A.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),N!==void 0&&ft(A)}function Yt(A){let y=A.texture,N=i.get(A),Y=i.get(y);A.addEventListener("dispose",w);let j=A.textures,q=A.isWebGLCubeRenderTarget===!0,_t=j.length>1;if(_t||(Y.__webglTexture===void 0&&(Y.__webglTexture=e.createTexture()),Y.__version=y.version,r.memory.textures++),q){N.__webglFramebuffer=[];for(let rt=0;rt<6;rt++)if(y.mipmaps&&y.mipmaps.length>0){N.__webglFramebuffer[rt]=[];for(let wt=0;wt<y.mipmaps.length;wt++)N.__webglFramebuffer[rt][wt]=e.createFramebuffer()}else N.__webglFramebuffer[rt]=e.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){N.__webglFramebuffer=[];for(let rt=0;rt<y.mipmaps.length;rt++)N.__webglFramebuffer[rt]=e.createFramebuffer()}else N.__webglFramebuffer=e.createFramebuffer();if(_t)for(let rt=0,wt=j.length;rt<wt;rt++){let Ct=i.get(j[rt]);Ct.__webglTexture===void 0&&(Ct.__webglTexture=e.createTexture(),r.memory.textures++)}if(A.samples>0&&Ve(A)===!1){N.__webglMultisampledFramebuffer=e.createFramebuffer(),N.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let rt=0;rt<j.length;rt++){let wt=j[rt];N.__webglColorRenderbuffer[rt]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,N.__webglColorRenderbuffer[rt]);let Ct=a.convert(wt.format,wt.colorSpace),$=a.convert(wt.type),it=_(wt.internalFormat,Ct,$,wt.colorSpace,A.isXRRenderTarget===!0),yt=D(A);e.renderbufferStorageMultisample(e.RENDERBUFFER,yt,it,A.width,A.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+rt,e.RENDERBUFFER,N.__webglColorRenderbuffer[rt])}e.bindRenderbuffer(e.RENDERBUFFER,null),A.depthBuffer&&(N.__webglDepthRenderbuffer=e.createRenderbuffer(),Lt(N.__webglDepthRenderbuffer,A,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(q){n.bindTexture(e.TEXTURE_CUBE_MAP,Y.__webglTexture),dt(e.TEXTURE_CUBE_MAP,y);for(let rt=0;rt<6;rt++)if(y.mipmaps&&y.mipmaps.length>0)for(let wt=0;wt<y.mipmaps.length;wt++)at(N.__webglFramebuffer[rt][wt],A,y,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+rt,wt);else at(N.__webglFramebuffer[rt],A,y,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0);g(y)&&h(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(_t){for(let rt=0,wt=j.length;rt<wt;rt++){let Ct=j[rt],$=i.get(Ct),it=e.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(it=A.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(it,$.__webglTexture),dt(it,Ct),at(N.__webglFramebuffer,A,Ct,e.COLOR_ATTACHMENT0+rt,it,0),g(Ct)&&h(it)}n.unbindTexture()}else{let rt=e.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(rt=A.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(rt,Y.__webglTexture),dt(rt,y),y.mipmaps&&y.mipmaps.length>0)for(let wt=0;wt<y.mipmaps.length;wt++)at(N.__webglFramebuffer[wt],A,y,e.COLOR_ATTACHMENT0,rt,wt);else at(N.__webglFramebuffer,A,y,e.COLOR_ATTACHMENT0,rt,0);g(y)&&h(rt),n.unbindTexture()}A.depthBuffer&&ft(A)}function te(A){let y=A.textures;for(let N=0,Y=y.length;N<Y;N++){let j=y[N];if(g(j)){let q=m(A),_t=i.get(j).__webglTexture;n.bindTexture(q,_t),h(q),n.unbindTexture()}}}let ie=[],Vt=[];function Oe(A){if(A.samples>0){if(Ve(A)===!1){let y=A.textures,N=A.width,Y=A.height,j=e.COLOR_BUFFER_BIT,q=A.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,_t=i.get(A),rt=y.length>1;if(rt)for(let Ct=0;Ct<y.length;Ct++)n.bindFramebuffer(e.FRAMEBUFFER,_t.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+Ct,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,_t.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+Ct,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,_t.__webglMultisampledFramebuffer);let wt=A.texture.mipmaps;wt&&wt.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,_t.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,_t.__webglFramebuffer);for(let Ct=0;Ct<y.length;Ct++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(j|=e.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(j|=e.STENCIL_BUFFER_BIT)),rt){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,_t.__webglColorRenderbuffer[Ct]);let $=i.get(y[Ct]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,$,0)}e.blitFramebuffer(0,0,N,Y,0,0,N,Y,j,e.NEAREST),l===!0&&(ie.length=0,Vt.length=0,ie.push(e.COLOR_ATTACHMENT0+Ct),A.depthBuffer&&A.resolveDepthBuffer===!1&&(ie.push(q),Vt.push(q),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,Vt)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,ie))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),rt)for(let Ct=0;Ct<y.length;Ct++){n.bindFramebuffer(e.FRAMEBUFFER,_t.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+Ct,e.RENDERBUFFER,_t.__webglColorRenderbuffer[Ct]);let $=i.get(y[Ct]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,_t.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+Ct,e.TEXTURE_2D,$,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,_t.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){let y=A.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[y])}}}function D(A){return Math.min(s.maxSamples,A.samples)}function Ve(A){let y=i.get(A);return A.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function se(A){let y=r.render.frame;d.get(A)!==y&&(d.set(A,y),A.update())}function _e(A,y){let N=A.colorSpace,Y=A.format,j=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||N!==qa&&N!==_s&&(Kt.getTransfer(N)===ae?(Y!==oi||j!==Rn)&&Ut("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Dt("WebGLTextures: Unsupported texture color space:",N)),y}function Mt(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=V,this.resetTextureUnits=F,this.setTexture2D=G,this.setTexture2DArray=z,this.setTexture3D=P,this.setTextureCube=et,this.rebindTextures=Ce,this.setupRenderTarget=Yt,this.updateRenderTargetMipmap=te,this.updateMultisampleRenderTarget=Oe,this.setupDepthRenderbuffer=ft,this.setupFrameBufferTexture=at,this.useMultisampledRTT=Ve,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function jR(e,t){function n(i,s=_s){let a,r=Kt.getTransfer(s);if(i===Rn)return e.UNSIGNED_BYTE;if(i===Wh)return e.UNSIGNED_SHORT_4_4_4_4;if(i===qh)return e.UNSIGNED_SHORT_5_5_5_1;if(i===Sg)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===bg)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===yg)return e.BYTE;if(i===xg)return e.SHORT;if(i===_o)return e.UNSIGNED_SHORT;if(i===Xh)return e.INT;if(i===yi)return e.UNSIGNED_INT;if(i===xi)return e.FLOAT;if(i===Fi)return e.HALF_FLOAT;if(i===Mg)return e.ALPHA;if(i===Eg)return e.RGB;if(i===oi)return e.RGBA;if(i===Li)return e.DEPTH_COMPONENT;if(i===fa)return e.DEPTH_STENCIL;if(i===Tg)return e.RED;if(i===Yh)return e.RED_INTEGER;if(i===Za)return e.RG;if(i===Zh)return e.RG_INTEGER;if(i===Jh)return e.RGBA_INTEGER;if(i===Ql||i===$l||i===tc||i===ec)if(r===ae)if(a=t.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===Ql)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===$l)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===tc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ec)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=t.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===Ql)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===$l)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===tc)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ec)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===jh||i===Kh||i===Qh||i===$h)if(a=t.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===jh)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Kh)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Qh)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===$h)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===td||i===ed||i===nd||i===id||i===sd||i===ad||i===rd)if(a=t.get("WEBGL_compressed_texture_etc"),a!==null){if(i===td||i===ed)return r===ae?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===nd)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(i===id)return a.COMPRESSED_R11_EAC;if(i===sd)return a.COMPRESSED_SIGNED_R11_EAC;if(i===ad)return a.COMPRESSED_RG11_EAC;if(i===rd)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===od||i===ld||i===cd||i===ud||i===hd||i===dd||i===fd||i===pd||i===md||i===gd||i===vd||i===_d||i===yd||i===xd)if(a=t.get("WEBGL_compressed_texture_astc"),a!==null){if(i===od)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ld)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===cd)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ud)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===hd)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===dd)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===fd)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===pd)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===md)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===gd)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===vd)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===_d)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===yd)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===xd)return r===ae?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Sd||i===bd||i===Md)if(a=t.get("EXT_texture_compression_bptc"),a!==null){if(i===Sd)return r===ae?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===bd)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Md)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Ed||i===Td||i===Ad||i===wd)if(a=t.get("EXT_texture_compression_rgtc"),a!==null){if(i===Ed)return a.COMPRESSED_RED_RGTC1_EXT;if(i===Td)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Ad)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===wd)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===yo?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}var KR=`
void main() {
...
}`,qg=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,n){if(this.texture===null){let i=new Vl(t.texture);(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){let n=t.cameras[0].viewport,i=new qn({vertexShader:KR,fragmentShader:QR,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new jt(new oa(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Yg=class extends vs{constructor(t,n){super();let i=this,s=null,a=1,r=null,o="local-floor",l=1,c=null,d=null,p=null,u=null,f=null,v=null,b=typeof XRWebGLBinding<"u",g=new qg,h={},m=n.getContextAttributes(),_=null,S=null,T=[],C=[],w=new $t,x=null,E=new ln;E.viewport=new Re;let I=new ln;I.viewport=new Re;let R=[E,I],F=new Vh,V=null,X=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let nt=T[Z];return nt===void 0&&(nt=new ho,T[Z]=nt),nt.getTargetRaySpace()},this.getControllerGrip=function(Z){let nt=T[Z];return nt===void 0&&(nt=new ho,T[Z]=nt),nt.getGripSpace()},this.getHand=function(Z){let nt=T[Z];return nt===void 0&&(nt=new ho,T[Z]=nt),nt.getHandSpace()};function G(Z){let nt=C.indexOf(Z.inputSource);if(nt===-1)return;let at=T[nt];at!==void 0&&(at.update(Z.inputSource,Z.frame,c||r),at.dispatchEvent({type:Z.type,data:Z.inputSource}))}function z(){s.removeEventListener("select",G),s.removeEventListener("selectstart",G),s.removeEventListener("selectend",G),s.removeEventListener("squeeze",G),s.removeEventListener("squeezestart",G),s.removeEventListener("squeezeend",G),s.removeEventListener("end",z),s.removeEventListener("inputsourceschange",P);for(let Z=0;Z<T.length;Z++){let nt=C[Z];nt!==null&&(C[Z]=null,T[Z].disconnect(nt))}V=null,X=null,g.reset();for(let Z in h)delete h[Z];t.setRenderTarget(_),f=null,u=null,p=null,s=null,S=null,ce.stop(),i.isPresenting=!1,t.setPixelRatio(x),t.setSize(w.width,w.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){a=Z,i.isPresenting===!0&&Ut("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,i.isPresenting===!0&&Ut("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||r},this.setReferenceSpace=function(Z){c=Z},this.getBaseLayer=function(){return u!==null?u:f},this.getBinding=function(){return p===null&&b&&(p=new XRWebGLBinding(s,n)),p},this.getFrame=function(){return v},this.getSession=function(){return s},this.setSession=async function(Z){if(s=Z,s!==null){if(_=t.getRenderTarget(),s.addEventListener("select",G),s.addEventListener("selectstart",G),s.addEventListener("selectend",G),s.addEventListener("squeeze",G),s.addEventListener("squeezestart",G),s.addEventListener("squeezeend",G),s.addEventListener("end",z),s.addEventListener("inputsourceschange",P),m.xrCompatible!==!0&&await n.makeXRCompatible(),x=t.getPixelRatio(),t.getSize(w),b&&"createProjectionLayer"in XRWebGLBinding.prototype){let at=null,Lt=null,Q=null;m.depth&&(Q=m.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,at=m.stencil?fa:Li,Lt=m.stencil?yo:yi);let ft={colorFormat:n.RGBA8,depthFormat:Q,scaleFactor:a};p=this.getBinding(),u=p.createProjectionLayer(ft),s.updateRenderState({layers:[u]}),t.setPixelRatio(1),t.setSize(u.textureWidth,u.textureHeight,!1),S=new Xn(u.textureWidth,u.textureHeight,{format:oi,type:Rn,depthTexture:new ra(u.textureWidth,u.textureHeight,Lt,void 0,void 0,void 0,void 0,void 0,void 0,at),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{let at={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:a};f=new XRWebGLLayer(s,n,at),s.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),S=new Xn(f.framebufferWidth,f.framebufferHeight,{format:oi,type:Rn,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(l),c=null,r=await s.requestReferenceSpace(o),ce.setContext(s),ce.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function P(Z){for(let nt=0;nt<Z.removed.length;nt++){let at=Z.removed[nt],Lt=C.indexOf(at);Lt>=0&&(C[Lt]=null,T[Lt].disconnect(at))}for(let nt=0;nt<Z.added.length;nt++){let at=Z.added[nt],Lt=C.indexOf(at);if(Lt===-1){for(let ft=0;ft<T.length;ft++)if(ft>=C.length){C.push(at),Lt=ft;break}else if(C[ft]===null){C[ft]=at,Lt=ft;break}if(Lt===-1)break}let Q=T[Lt];Q&&Q.connect(at)}}let et=new H,K=new H;function lt(Z,nt,at){et.setFromMatrixPosition(nt.matrixWorld),K.setFromMatrixPosition(at.matrixWorld);let Lt=et.distanceTo(K),Q=nt.projectionMatrix.elements,ft=at.projectionMatrix.elements,Ce=Q[14]/(Q[10]-1),Yt=Q[14]/(Q[10]+1),te=(Q[9]+1)/Q[5],ie=(Q[9]-1)/Q[5],Vt=(Q[8]-1)/Q[0],Oe=(ft[8]+1)/ft[0],D=Ce*Vt,Ve=Ce*Oe,se=Lt/(-Vt+Oe),_e=se*-Vt;if(nt.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(_e),Z.translateZ(se),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),Q[10]===-1)Z.projectionMatrix.copy(nt.projectionMatrix),Z.projectionMatrixInverse.copy(nt.projectionMatrixInverse);else{let Mt=Ce+se,A=Yt+se,y=D-_e,N=Ve+(Lt-_e),Y=te*Yt/A*Mt,j=ie*Yt/A*Mt;Z.projectionMatrix.makePerspective(y,N,Y,j,Mt,A),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function mt(Z,nt){nt===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(nt.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(s===null)return;let nt=Z.near,at=Z.far;g.texture!==null&&(g.depthNear>0&&(nt=g.depthNear),g.depthFar>0&&(at=g.depthFar)),F.near=I.near=E.near=nt,F.far=I.far=E.far=at,(V!==F.near||X!==F.far)&&(s.updateRenderState({depthNear:F.near,depthFar:F.far}),V=F.near,X=F.far),F.layers.mask=Z.layers.mask|6,E.layers.mask=F.layers.mask&-5,I.layers.mask=F.layers.mask&-3;let Lt=Z.parent,Q=F.cameras;mt(F,Lt);for(let ft=0;ft<Q.length;ft++)mt(Q[ft],Lt);Q.length===2?lt(F,E,I):F.projectionMatrix.copy(E.projectionMatrix),dt(Z,F,Lt)};function dt(Z,nt,at){at===null?Z.matrix.copy(nt.matrixWorld):(Z.matrix.copy(at.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(nt.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(nt.projectionMatrix),Z.projectionMatrixInverse.copy(nt.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=yh*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return F},this.getFoveation=function(){if(!(u===null&&f===null))return l},this.setFoveation=function(Z){l=Z,u!==null&&(u.fixedFoveation=Z),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=Z)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(F)},this.getCameraTexture=function(Z){return h[Z]};let Nt=null;function ve(Z,nt){if(d=nt.getViewerPose(c||r),v=nt,d!==null){let at=d.views;f!==null&&(t.setRenderTargetFramebuffer(S,f.framebuffer),t.setRenderTarget(S));let Lt=!1;at.length!==F.cameras.length&&(F.cameras.length=0,Lt=!0);for(let Yt=0;Yt<at.length;Yt++){let te=at[Yt],ie=null;if(f!==null)ie=f.getViewport(te);else{let Oe=p.getViewSubImage(u,te);ie=Oe.viewport,Yt===0&&(t.setRenderTargetTextures(S,Oe.colorTexture,Oe.depthStencilTexture),t.setRenderTarget(S))}let Vt=R[Yt];Vt===void 0&&(Vt=new ln,Vt.layers.enable(Yt),Vt.viewport=new Re,R[Yt]=Vt),Vt.matrix.fromArray(te.transform.matrix),Vt.matrix.decompose(Vt.position,Vt.quaternion,Vt.scale),Vt.projectionMatrix.fromArray(te.projectionMatrix),Vt.projectionMatrixInverse.copy(Vt.projectionMatrix).invert(),Vt.viewport.set(ie.x,ie.y,ie.width,ie.height),Yt===0&&(F.matrix.copy(Vt.matrix),F.matrix.decompose(F.position,F.quaternion,F.scale)),Lt===!0&&F.cameras.push(Vt)}let Q=s.enabledFeatures;if(Q&&Q.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&b){p=i.getBinding();let Yt=p.getDepthInformation(at[0]);Yt&&Yt.isValid&&Yt.texture&&g.init(Yt,s.renderState)}if(Q&&Q.includes("camera-access")&&b){t.state.unbindTexture(),p=i.getBinding();for(let Yt=0;Yt<at.length;Yt++){let te=at[Yt].camera;if(te){let ie=h[te];ie||(ie=new Vl,h[te]=ie);let Vt=p.getCameraImage(te);ie.sourceTexture=Vt}}}}for(let at=0;at<T.length;at++){let Lt=C[at],Q=T[at];Lt!==null&&Q!==void 0&&Q.update(Lt,nt,c||r)}Nt&&Nt(Z,nt),nt.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:nt}),v=null}let ce=new Eb;ce.setAnimationLoop(ve),this.setAnimationLoop=function(Z){Nt=Z},this.dispose=function(){}}},Ka=new gi,$R=new Le;function t2(e,t){function n(g,h){g.matrixAutoUpdate===!0&&g.updateMatrix(),h.value.copy(g.matrix)}function i(g,h){h.color.getRGB(g.fogColor.value,Rg(e)),h.isFog?(g.fogNear.value=h.near,g.fogFar.value=h.far):h.isFogExp2&&(g.fogDensity.value=h.density)}function s(g,h,m,_,S){h.isMeshBasicMaterial?a(g,h):h.isMeshLambertMaterial?(a(g,h),h.envMap&&(g.envMapIntensity.value=h.envMapIntensity)):h.isMeshToonMaterial?(a(g,h),p(g,h)):h.isMeshPhongMaterial?(a(g,h),d(g,h),h.envMap&&(g.envMapIntensity.value=h.envMapIntensity)):h.isMeshStandardMaterial?(a(g,h),u(g,h),h.isMeshPhysicalMaterial&&f(g,h,S)):h.isMeshMatcapMaterial?(a(g,h),v(g,h)):h.isMeshDepthMaterial?a(g,h):h.isMeshDistanceMaterial?(a(g,h),b(g,h)):h.isMeshNormalMaterial?a(g,h):h.isLineBasicMaterial?(r(g,h),h.isLineDashedMaterial&&o(g,h)):h.isPointsMaterial?l(g,h,m,_):h.isSpriteMaterial?c(g,h):h.isShadowMaterial?(g.color.value.copy(h.color),g.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function a(g,h){g.opacity.value=h.opacity,h.color&&g.diffuse.value.copy(h.color),h.emissive&&g.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(g.map.value=h.map,n(h.map,g.mapTransform)),h.alphaMap&&(g.alphaMap.value=h.alphaMap,n(h.alphaMap,g.alphaMapTransform)),h.bumpMap&&(g.bumpMap.value=h.bumpMap,n(h.bumpMap,g.bumpMapTransform),g.bumpScale.value=h.bumpScale,h.side===Ie&&(g.bumpScale.value*=-1)),h.normalMap&&(g.normalMap.value=h.normalMap,n(h.normalMap,g.normalMapTransform),g.normalScale.value.copy(h.normalScale),h.side===Ie&&g.normalScale.value.negate()),h.displacementMap&&(g.displacementMap.value=h.displacementMap,n(h.displacementMap,g.displacementMapTransform),g.displacementScale.value=h.displacementScale,g.displacementBias.value=h.displacementBias),h.emissiveMap&&(g.emissiveMap.value=h.emissiveMap,n(h.emissiveMap,g.emissiveMapTransform)),h.specularMap&&(g.specularMap.value=h.specularMap,n(h.specularMap,g.specularMapTransform)),h.alphaTest>0&&(g.alphaTest.value=h.alphaTest);let m=t.get(h),_=m.envMap,S=m.envMapRotation;_&&(g.envMap.value=_,Ka.copy(S),Ka.x*=-1,Ka.y*=-1,Ka.z*=-1,_.isCubeTexture&&_.isRenderTargetTexture===!1&&(Ka.y*=-1,Ka.z*=-1),g.envMapRotation.value.setFromMatrix4($R.makeRotationFromEuler(Ka)),g.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,g.reflectivity.value=h.reflectivity,g.ior.value=h.ior,g.refractionRatio.value=h.refractionRatio),h.lightMap&&(g.lightMap.value=h.lightMap,g.lightMapIntensity.value=h.lightMapIntensity,n(h.lightMap,g.lightMapTransform)),h.aoMap&&(g.aoMap.value=h.aoMap,g.aoMapIntensity.value=h.aoMapIntensity,n(h.aoMap,g.aoMapTransform))}function r(g,h){g.diffuse.value.copy(h.color),g.opacity.value=h.opacity,h.map&&(g.map.value=h.map,n(h.map,g.mapTransform))}function o(g,h){g.dashSize.value=h.dashSize,g.totalSize.value=h.dashSize+h.gapSize,g.scale.value=h.scale}function l(g,h,m,_){g.diffuse.value.copy(h.color),g.opacity.value=h.opacity,g.size.value=h.size*m,g.scale.value=_*.5,h.map&&(g.map.value=h.map,n(h.map,g.uvTransform)),h.alphaMap&&(g.alphaMap.value=h.alphaMap,n(h.alphaMap,g.alphaMapTransform)),h.alphaTest>0&&(g.alphaTest.value=h.alphaTest)}function c(g,h){g.diffuse.value.copy(h.color),g.opacity.value=h.opacity,g.rotation.value=h.rotation,h.map&&(g.map.value=h.map,n(h.map,g.mapTransform)),h.alphaMap&&(g.alphaMap.value=h.alphaMap,n(h.alphaMap,g.alphaMapTransform)),h.alphaTest>0&&(g.alphaTest.value=h.alphaTest)}function d(g,h){g.specular.value.copy(h.specular),g.shininess.value=Math.max(h.shininess,1e-4)}function p(g,h){h.gradientMap&&(g.gradientMap.value=h.gradientMap)}function u(g,h){g.metalness.value=h.metalness,h.metalnessMap&&(g.metalnessMap.value=h.metalnessMap,n(h.metalnessMap,g.metalnessMapTransform)),g.roughness.value=h.roughness,h.roughnessMap&&(g.roughnessMap.value=h.roughnessMap,n(h.roughnessMap,g.roughnessMapTransform)),h.envMap&&(g.envMapIntensity.value=h.envMapIntensity)}function f(g,h,m){g.ior.value=h.ior,h.sheen>0&&(g.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),g.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(g.sheenColorMap.value=h.sheenColorMap,n(h.sheenColorMap,g.sheenColorMapTransform)),h.sheenRoughnessMap&&(g.sheenRoughnessMap.value=h.sheenRoughnessMap,n(h.sheenRoughnessMap,g.sheenRoughnessMapTransform))),h.clearcoat>0&&(g.clearcoat.value=h.clearcoat,g.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(g.clearcoatMap.value=h.clearcoatMap,n(h.clearcoatMap,g.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,n(h.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(g.clearcoatNormalMap.value=h.clearcoatNormalMap,n(h.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Ie&&g.clearcoatNormalScale.value.negate())),h.dispersion>0&&(g.dispersion.value=h.dispersion),h.iridescence>0&&(g.iridescence.value=h.iridescence,g.iridescenceIOR.value=h.iridescenceIOR,g.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(g.iridescenceMap.value=h.iridescenceMap,n(h.iridescenceMap,g.iridescenceMapTransform)),h.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=h.iridescenceThicknessMap,n(h.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),h.transmission>0&&(g.transmission.value=h.transmission,g.transmissionSamplerMap.value=m.texture,g.transmissionSamplerSize.value.set(m.width,m.height),h.transmissionMap&&(g.transmissionMap.value=h.transmissionMap,n(h.transmissionMap,g.transmissionMapTransform)),g.thickness.value=h.thickness,h.thicknessMap&&(g.thicknessMap.value=h.thicknessMap,n(h.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=h.attenuationDistance,g.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(g.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(g.anisotropyMap.value=h.anisotropyMap,n(h.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=h.specularIntensity,g.specularColor.value.copy(h.specularColor),h.specularColorMap&&(g.specularColorMap.value=h.specularColorMap,n(h.specularColorMap,g.specularColorMapTransform)),h.specularIntensityMap&&(g.specularIntensityMap.value=h.specularIntensityMap,n(h.specularIntensityMap,g.specularIntensityMapTransform))}function v(g,h){h.matcap&&(g.matcap.value=h.matcap)}function b(g,h){let m=t.get(h).light;g.referencePosition.value.setFromMatrixPosition(m.matrixWorld),g.nearDistance.value=m.shadow.camera.near,g.farDistance.value=m.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function e2(e,t,n,i){let s={},a={},r=[],o=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function l(m,_){let S=_.program;i.uniformBlockBinding(m,S)}function c(m,_){let S=s[m.id];S===void 0&&(v(m),S=d(m),s[m.id]=S,m.addEventListener("dispose",g));let T=_.program;i.updateUBOMapping(m,T);let C=t.render.frame;a[m.id]!==C&&(u(m),a[m.id]=C)}function d(m){let _=p();m.__bindingPointIndex=_;let S=e.createBuffer(),T=m.__size,C=m.usage;return e.bindBuffer(e.UNIFORM_BUFFER,S),e.bufferData(e.UNIFORM_BUFFER,T,C),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,_,S),S}function p(){for(let m=0;m<o;m++)if(r.indexOf(m)===-1)return r.push(m),m;return Dt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(m){let _=s[m.id],S=m.uniforms,T=m.__cache;e.bindBuffer(e.UNIFORM_BUFFER,_);for(let C=0,w=S.length;C<w;C++){let x=Array.isArray(S[C])?S[C]:[S[C]];for(let E=0,I=x.length;E<I;E++){let R=x[E];if(f(R,C,E,T)===!0){let F=R.__offset,V=Array.isArray(R.value)?R.value:[R.value],X=0;for(let G=0;G<V.length;G++){let z=V[G],P=b(z);typeof z=="number"||typeof z=="boolean"?(R.__data[0]=z,e.bufferSubData(e.UNIFORM_BUFFER,F+X,R.__data)):z.isMatrix3?(R.__data[0]=z.elements[0],R.__data[1]=z.elements[1],R.__data[2]=z.elements[2],R.__data[3]=0,R.__data[4]=z.elements[3],R.__data[5]=z.elements[4],R.__data[6]=z.elements[5],R.__data[7]=0,R.__data[8]=z.elements[6],R.__data[9]=z.elements[7],R.__data[10]=z.elements[8],R.__data[11]=0):(z.toArray(R.__data,X),X+=P.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,F,R.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function f(m,_,S,T){let C=m.value,w=_+"_"+S;if(T[w]===void 0)return typeof C=="number"||typeof C=="boolean"?T[w]=C:T[w]=C.clone(),!0;{let x=T[w];if(typeof C=="number"||typeof C=="boolean"){if(x!==C)return T[w]=C,!0}else if(x.equals(C)===!1)return x.copy(C),!0}return!1}function v(m){let _=m.uniforms,S=0,T=16;for(let w=0,x=_.length;w<x;w++){let E=Array.isArray(_[w])?_[w]:[_[w]];for(let I=0,R=E.length;I<R;I++){let F=E[I],V=Array.isArray(F.value)?F.value:[F.value];for(let X=0,G=V.length;X<G;X++){let z=V[X],P=b(z),et=S%T,K=et%P.boundary,lt=et+K;S+=K,lt!==0&&T-lt<P.storage&&(S+=T-lt),F.__data=new Float32Array(P.storage/Float32Array.BYTES_PER_ELEMENT),F.__offset=S,S+=P.storage}}}let C=S%T;return C>0&&(S+=T-C),m.__size=S,m.__cache={},this}function b(m){let _={boundary:0,storage:0};return typeof m=="number"||typeof m=="boolean"?(_.boundary=4,_.storage=4):m.isVector2?(_.boundary=8,_.storage=8):m.isVector3||m.isColor?(_.boundary=16,_.storage=12):m.isVector4?(_.boundary=16,_.storage=16):m.isMatrix3?(_.boundary=48,_.storage=48):m.isMatrix4?(_.boundary=64,_.storage=64):m.isTexture?Ut("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Ut("WebGLRenderer: Unsupported uniform value type.",m),_}function g(m){let _=m.target;_.removeEventListener("dispose",g);let S=r.indexOf(_.__bindingPointIndex);r.splice(S,1),e.deleteBuffer(s[_.id]),delete s[_.id],delete a[_.id]}function h(){for(let m in s)e.deleteBuffer(s[m]);r=[],s={},a={}}return{bind:l,update:c,dispose:h}}var n2=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),zi=null;function i2(){return zi===null&&(zi=new Eh(n2,16,16,Za,Fi),zi.name="DFG_LUT",zi.minFilter=cn,zi.magFilter=cn,zi.wrapS=Ni,zi.wrapT=Ni,zi.generateMipmaps=!1,zi.needsUpdate=!0),zi}var Ld=class{constructor(t={}){let{canvas:n=JS(),context:i=null,depth:s=!0,stencil:a=!1,alpha:r=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:u=!1,outputBufferType:f=Rn}=t;this.isWebGLRenderer=!0;let v;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=i.getContextAttributes().alpha}else v=r;let b=f,g=new Set([Jh,Zh,Yh]),h=new Set([Rn,yi,_o,yo,Wh,qh]),m=new Uint32Array(4),_=new Int32Array(4),S=null,T=null,C=[],w=[],x=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=_i,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let E=this,I=!1;this._outputColorSpace=pn;let R=0,F=0,V=null,X=-1,G=null,z=new Re,P=new Re,et=null,K=new kt(0),lt=0,mt=n.width,dt=n.height,Nt=1,ve=null,ce=null,Z=new Re(0,0,mt,dt),nt=new Re(0,0,mt,dt),at=!1,Lt=new mo,Q=!1,ft=!1,Ce=new Le,Yt=new H,te=new Re,ie={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Vt=!1;function Oe(){return V===null?Nt:1}let D=i;function Ve(M,L){return n.getContext(M,L)}try{let M={alpha:!0,depth:s,stencil:a,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:p};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${"183"}`),n.addEventListener("webglcontextlost",xt,!1),n.addEventListener("webglcontextrestored",It,!1),n.addEventListener("webglcontextcreationerror",ye,!1),D===null){let L="webgl2";if(D=Ve(L,M),D===null)throw Ve(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw Dt("WebGLRenderer: "+M.message),M}let se,_e,Mt,A,y,N,Y,j,q,_t,rt,wt,Ct,$,it,yt,St,pt,Ht,U,ot,st,vt;function tt(){se=new hC(D),se.init(),ot=new jR(D,se),_e=new iC(D,se,t,ot),Mt=new ZR(D,se),_e.reversedDepthBuffer&&u&&Mt.buffers.depth.setReversed(!0),A=new pC(D),y=new IR,N=new JR(D,se,Mt,y,_e,ot,A),Y=new uC(E),j=new yT(D),st=new eC(D,j),q=new dC(D,j,A,st),_t=new gC(D,q,j,st,A),pt=new mC(D,_e,N),it=new sC(y),rt=new LR(E,Y,se,_e,st,it),wt=new t2(E,y),Ct=new PR,$=new GR(se),St=new tC(E,Y,Mt,_t,v,l),yt=new YR(E,_t,_e),vt=new e2(D,A,_e,Mt),Ht=new nC(D,se,A),U=new fC(D,se,A),A.programs=rt.programs,E.capabilities=_e,E.extensions=se,E.properties=y,E.renderLists=Ct,E.shadowMap=yt,E.state=Mt,E.info=A}tt(),b!==Rn&&(x=new _C(b,n.width,n.height,s,a));let W=new Yg(E,D);this.xr=W,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){let M=se.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){let M=se.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return Nt},this.setPixelRatio=function(M){M!==void 0&&(Nt=M,this.setSize(mt,dt,!1))},this.getSize=function(M){return M.set(mt,dt)},this.setSize=function(M,L,k=!0){if(W.isPresenting){Ut("WebGLRenderer: Can't change size while VR device is presenting.");return}mt=M,dt=L,n.width=Math.floor(M*Nt),n.height=Math.floor(L*Nt),k===!0&&(n.style.width=M+"px",n.style.height=L+"px"),x!==null&&x.setSize(n.width,n.height),this.setViewport(0,0,M,L)},this.getDrawingBufferSize=function(M){return M.set(mt*Nt,dt*Nt).floor()},this.setDrawingBufferSize=function(M,L,k){mt=M,dt=L,Nt=k,n.width=Math.floor(M*k),n.height=Math.floor(L*k),this.setViewport(0,0,M,L)},this.setEffects=function(M){if(b===Rn){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let L=0;L<M.length;L++)if(M[L].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}x.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(z)},this.getViewport=function(M){return M.copy(Z)},this.setViewport=function(M,L,k,B){M.isVector4?Z.set(M.x,M.y,M.z,M.w):Z.set(M,L,k,B),Mt.viewport(z.copy(Z).multiplyScalar(Nt).round())},this.getScissor=function(M){return M.copy(nt)},this.setScissor=function(M,L,k,B){M.isVector4?nt.set(M.x,M.y,M.z,M.w):nt.set(M,L,k,B),Mt.scissor(P.copy(nt).multiplyScalar(Nt).round())},this.getScissorTest=function(){return at},this.setScissorTest=function(M){Mt.setScissorTest(at=M)},this.setOpaqueSort=function(M){ve=M},this.setTransparentSort=function(M){ce=M},this.getClearColor=function(M){return M.copy(St.getClearColor())},this.setClearColor=function(){St.setClearColor(...arguments)},this.getClearAlpha=function(){return St.getClearAlpha()},this.setClearAlpha=function(){St.setClearAlpha(...arguments)},this.clear=function(M=!0,L=!0,k=!0){let B=0;if(M){let O=!1;if(V!==null){let ut=V.texture.format;O=g.has(ut)}if(O){let ut=V.texture.type,gt=h.has(ut),ht=St.getClearColor(),bt=St.getClearAlpha(),Tt=ht.r,Pt=ht.g,Gt=ht.b;gt?(m[0]=Tt,m[1]=Pt,m[2]=Gt,m[3]=bt,D.clearBufferuiv(D.COLOR,0,m)):(_[0]=Tt,_[1]=Pt,_[2]=Gt,_[3]=bt,D.clearBufferiv(D.COLOR,0,_))}else B|=D.COLOR_BUFFER_BIT}L&&(B|=D.DEPTH_BUFFER_BIT),k&&(B|=D.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B!==0&&D.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",xt,!1),n.removeEventListener("webglcontextrestored",It,!1),n.removeEventListener("webglcontextcreationerror",ye,!1),St.dispose(),Ct.dispose(),$.dispose(),y.dispose(),Y.dispose(),_t.dispose(),st.dispose(),vt.dispose(),rt.dispose(),W.dispose(),W.removeEventListener("sessionstart",$g),W.removeEventListener("sessionend",t0),va.stop()};function xt(M){M.preventDefault(),Cg("WebGLRenderer: Context Lost."),I=!0}function It(){Cg("WebGLRenderer: Context Restored."),I=!1;let M=A.autoReset,L=yt.enabled,k=yt.autoUpdate,B=yt.needsUpdate,O=yt.type;tt(),A.autoReset=M,yt.enabled=L,yt.autoUpdate=k,yt.needsUpdate=B,yt.type=O}function ye(M){Dt("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function re(M){let L=M.target;L.removeEventListener("dispose",re),Hi(L)}function Hi(M){Gi(M),y.remove(M)}function Gi(M){let L=y.get(M).programs;L!==void 0&&(L.forEach(function(k){rt.releaseProgram(k)}),M.isShaderMaterial&&rt.releaseShaderCache(M))}this.renderBufferDirect=function(M,L,k,B,O,ut){L===null&&(L=ie);let gt=O.isMesh&&O.matrixWorld.determinant()<0,ht=Pb(M,L,k,B,O);Mt.setMaterial(B,gt);let bt=k.index,Tt=1;if(B.wireframe===!0){if(bt=q.getWireframeAttribute(k),bt===void 0)return;Tt=2}let Pt=k.drawRange,Gt=k.attributes.position,At=Pt.start*Tt,ue=(Pt.start+Pt.count)*Tt;ut!==null&&(At=Math.max(At,ut.start*Tt),ue=Math.min(ue,(ut.start+ut.count)*Tt)),bt!==null?(At=Math.max(At,0),ue=Math.min(ue,bt.count)):Gt!=null&&(At=Math.max(At,0),ue=Math.min(ue,Gt.count));let Pe=ue-At;if(Pe<0||Pe===1/0)return;st.setup(O,B,ht,k,bt);let De,he=Ht;if(bt!==null&&(De=j.get(bt),he=U,he.setIndex(De)),O.isMesh)B.wireframe===!0?(Mt.setLineWidth(B.wireframeLinewidth*Oe()),he.setMode(D.LINES)):he.setMode(D.TRIANGLES);else if(O.isLine){let un=B.linewidth;un===void 0&&(un=1),Mt.setLineWidth(un*Oe()),O.isLineSegments?he.setMode(D.LINES):O.isLineLoop?he.setMode(D.LINE_LOOP):he.setMode(D.LINE_STRIP)}else O.isPoints?he.setMode(D.POINTS):O.isSprite&&he.setMode(D.TRIANGLES);if(O.isBatchedMesh)if(O._multiDrawInstances!==null)Ll("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),he.renderMultiDrawInstances(O._multiDrawStarts,O._multiDrawCounts,O._multiDrawCount,O._multiDrawInstances);else if(se.get("WEBGL_multi_draw"))he.renderMultiDraw(O._multiDrawStarts,O._multiDrawCounts,O._multiDrawCount);else{let un=O._multiDrawStarts,Et=O._multiDrawCounts,Dn=O._multiDrawCount,Qt=bt?j.get(bt).bytesPerElement:1,li=y.get(B).currentProgram.getUniforms();for(let Si=0;Si<Dn;Si++)li.setValue(D,"_gl_DrawID",Si),he.render(un[Si]/Qt,Et[Si])}else if(O.isInstancedMesh)he.renderInstances(At,Pe,O.count);else if(k.isInstancedBufferGeometry){let un=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,Et=Math.min(k.instanceCount,un);he.renderInstances(At,Pe,Et)}else he.render(At,Pe)};function Qg(M,L,k){M.transparent===!0&&M.side===Pi&&M.forceSinglePass===!1?(M.side=Ie,M.needsUpdate=!0,lc(M,L,k),M.side=gs,M.needsUpdate=!0,lc(M,L,k),M.side=Pi):lc(M,L,k)}this.compile=function(M,L,k=null){k===null&&(k=M),T=$.get(k),T.init(L),w.push(T),k.traverseVisible(function(O){O.isLight&&O.layers.test(L.layers)&&(T.pushLight(O),O.castShadow&&T.pushShadow(O))}),M!==k&&M.traverseVisible(function(O){O.isLight&&O.layers.test(L.layers)&&(T.pushLight(O),O.castShadow&&T.pushShadow(O))}),T.setupLights();let B=new Set;return M.traverse(function(O){if(!(O.isMesh||O.isPoints||O.isLine||O.isSprite))return;let ut=O.material;if(ut)if(Array.isArray(ut))for(let gt=0;gt<ut.length;gt++){let ht=ut[gt];Qg(ht,k,O),B.add(ht)}else Qg(ut,k,O),B.add(ut)}),T=w.pop(),B},this.compileAsync=function(M,L,k=null){let B=this.compile(M,L,k);return new Promise(O=>{function ut(){if(B.forEach(function(gt){y.get(gt).currentProgram.isReady()&&B.delete(gt)}),B.size===0){O(M);return}setTimeout(ut,10)}se.get("KHR_parallel_shader_compile")!==null?ut():setTimeout(ut,10)})};let zd=null;function Ob(M){zd&&zd(M)}function $g(){va.stop()}function t0(){va.start()}let va=new Eb;va.setAnimationLoop(Ob),typeof self<"u"&&va.setContext(self),this.setAnimationLoop=function(M){zd=M,W.setAnimationLoop(M),M===null?va.stop():va.start()},W.addEventListener("sessionstart",$g),W.addEventListener("sessionend",t0),this.render=function(M,L){if(L!==void 0&&L.isCamera!==!0){Dt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;let k=W.enabled===!0&&W.isPresenting===!0,B=x!==null&&(V===null||k)&&x.begin(E,V);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),W.enabled===!0&&W.isPresenting===!0&&(x===null||x.isCompositing()===!1)&&(W.cameraAutoUpdate===!0&&W.updateCamera(L),L=W.getCamera()),M.isScene===!0&&M.onBeforeRender(E,M,L,V),T=$.get(M,w.length),T.init(L),w.push(T),Ce.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),Lt.setFromProjectionMatrix(Ce,mi,L.reversedDepth),ft=this.localClippingEnabled,Q=it.init(this.clippingPlanes,ft),S=Ct.get(M,C.length),S.init(),C.push(S),W.enabled===!0&&W.isPresenting===!0){let gt=E.xr.getDepthSensingMesh();gt!==null&&Vd(gt,L,-1/0,E.sortObjects)}Vd(M,L,0,E.sortObjects),S.finish(),E.sortObjects===!0&&S.sort(ve,ce),Vt=W.enabled===!1||W.isPresenting===!1||W.hasDepthSensing()===!1,Vt&&St.addToRenderList(S,M),this.info.render.frame++,Q===!0&&it.beginShadows();let O=T.state.shadowsArray;if(yt.render(O,M,L),Q===!0&&it.endShadows(),this.info.autoReset===!0&&this.info.reset(),(B&&x.hasRenderPass())===!1){let gt=S.opaque,ht=S.transmissive;if(T.setupLights(),L.isArrayCamera){let bt=L.cameras;if(ht.length>0)for(let Tt=0,Pt=bt.length;Tt<Pt;Tt++){let Gt=bt[Tt];n0(gt,ht,M,Gt)}Vt&&St.render(M);for(let Tt=0,Pt=bt.length;Tt<Pt;Tt++){let Gt=bt[Tt];e0(S,M,Gt,Gt.viewport)}}else ht.length>0&&n0(gt,ht,M,L),Vt&&St.render(M),e0(S,M,L)}V!==null&&F===0&&(N.updateMultisampleRenderTarget(V),N.updateRenderTargetMipmap(V)),B&&x.end(E),M.isScene===!0&&M.onAfterRender(E,M,L),st.resetDefaultState(),X=-1,G=null,w.pop(),w.length>0?(T=w[w.length-1],Q===!0&&it.setGlobalState(E.clippingPlanes,T.state.camera)):T=null,C.pop(),C.length>0?S=C[C.length-1]:S=null};function Vd(M,L,k,B){if(M.visible===!1)return;if(M.layers.test(L.layers)){if(M.isGroup)k=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(L);else if(M.isLight)T.pushLight(M),M.castShadow&&T.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||Lt.intersectsSprite(M)){B&&te.setFromMatrixPosition(M.matrixWorld).applyMatrix4(Ce);let gt=_t.update(M),ht=M.material;ht.visible&&S.push(M,gt,ht,k,te.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||Lt.intersectsObject(M))){let gt=_t.update(M),ht=M.material;if(B&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),te.copy(M.boundingSphere.center)):(gt.boundingSphere===null&&gt.computeBoundingSphere(),te.copy(gt.boundingSphere.center)),te.applyMatrix4(M.matrixWorld).applyMatrix4(Ce)),Array.isArray(ht)){let bt=gt.groups;for(let Tt=0,Pt=bt.length;Tt<Pt;Tt++){let Gt=bt[Tt],At=ht[Gt.materialIndex];At&&At.visible&&S.push(M,gt,At,k,te.z,Gt)}}else ht.visible&&S.push(M,gt,ht,k,te.z,null)}}let ut=M.children;for(let gt=0,ht=ut.length;gt<ht;gt++)Vd(ut[gt],L,k,B)}function e0(M,L,k,B){let{opaque:O,transmissive:ut,transparent:gt}=M;T.setupLightsView(k),Q===!0&&it.setGlobalState(E.clippingPlanes,k),B&&Mt.viewport(z.copy(B)),O.length>0&&oc(O,L,k),ut.length>0&&oc(ut,L,k),gt.length>0&&oc(gt,L,k),Mt.buffers.depth.setTest(!0),Mt.buffers.depth.setMask(!0),Mt.buffers.color.setMask(!0),Mt.setPolygonOffset(!1)}function n0(M,L,k,B){if((k.isScene===!0?k.overrideMaterial:null)!==null)return;if(T.state.transmissionRenderTarget[B.id]===void 0){let At=se.has("EXT_color_buffer_half_float")||se.has("EXT_color_buffer_float");T.state.transmissionRenderTarget[B.id]=new Xn(1,1,{generateMipmaps:!0,type:At?Fi:Rn,minFilter:da,samples:Math.max(4,_e.samples),stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Kt.workingColorSpace})}let ut=T.state.transmissionRenderTarget[B.id],gt=B.viewport||z;ut.setSize(gt.z*E.transmissionResolutionScale,gt.w*E.transmissionResolutionScale);let ht=E.getRenderTarget(),bt=E.getActiveCubeFace(),Tt=E.getActiveMipmapLevel();E.setRenderTarget(ut),E.getClearColor(K),lt=E.getClearAlpha(),lt<1&&E.setClearColor(16777215,.5),E.clear(),Vt&&St.render(k);let Pt=E.toneMapping;E.toneMapping=_i;let Gt=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),T.setupLightsView(B),Q===!0&&it.setGlobalState(E.clippingPlanes,B),oc(M,k,B),N.updateMultisampleRenderTarget(ut),N.updateRenderTargetMipmap(ut),se.has("WEBGL_multisampled_render_to_texture")===!1){let At=!1;for(let ue=0,Pe=L.length;ue<Pe;ue++){let De=L[ue],{object:he,geometry:un,material:Et,group:Dn}=De;if(Et.side===Pi&&he.layers.test(B.layers)){let Qt=Et.side;Et.side=Ie,Et.needsUpdate=!0,i0(he,k,B,un,Et,Dn),Et.side=Qt,Et.needsUpdate=!0,At=!0}}At===!0&&(N.updateMultisampleRenderTarget(ut),N.updateRenderTargetMipmap(ut))}E.setRenderTarget(ht,bt,Tt),E.setClearColor(K,lt),Gt!==void 0&&(B.viewport=Gt),E.toneMapping=Pt}function oc(M,L,k){let B=L.isScene===!0?L.overrideMaterial:null;for(let O=0,ut=M.length;O<ut;O++){let gt=M[O],{object:ht,geometry:bt,group:Tt}=gt,Pt=gt.material;Pt.allowOverride===!0&&B!==null&&(Pt=B),ht.layers.test(k.layers)&&i0(ht,L,k,bt,Pt,Tt)}}function i0(M,L,k,B,O,ut){M.onBeforeRender(E,L,k,B,O,ut),M.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),O.onBeforeRender(E,L,k,B,M,ut),O.transparent===!0&&O.side===Pi&&O.forceSinglePass===!1?(O.side=Ie,O.needsUpdate=!0,E.renderBufferDirect(k,L,B,O,M,ut),O.side=gs,O.needsUpdate=!0,E.renderBufferDirect(k,L,B,O,M,ut),O.side=Pi):E.renderBufferDirect(k,L,B,O,M,ut),M.onAfterRender(E,L,k,B,O,ut)}function lc(M,L,k){L.isScene!==!0&&(L=ie);let B=y.get(M),O=T.state.lights,ut=T.state.shadowsArray,gt=O.state.version,ht=rt.getParameters(M,O.state,ut,L,k),bt=rt.getProgramCacheKey(ht),Tt=B.programs;B.environment=M.isMeshStandardMaterial||M.isMeshLambertMaterial||M.isMeshPhongMaterial?L.environment:null,B.fog=L.fog;let Pt=M.isMeshStandardMaterial||M.isMeshLambertMaterial&&!M.envMap||M.isMeshPhongMaterial&&!M.envMap;B.envMap=Y.get(M.envMap||B.environment,Pt),B.envMapRotation=B.environment!==null&&M.envMap===null?L.environmentRotation:M.envMapRotation,Tt===void 0&&(M.addEventListener("dispose",re),Tt=new Map,B.programs=Tt);let Gt=Tt.get(bt);if(Gt!==void 0){if(B.currentProgram===Gt&&B.lightsStateVersion===gt)return a0(M,ht),Gt}else ht.uniforms=rt.getUniforms(M),M.onBeforeCompile(ht,E),Gt=rt.acquireProgram(ht,bt),Tt.set(bt,Gt),B.uniforms=ht.uniforms;let At=B.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(At.clippingPlanes=it.uniform),a0(M,ht),B.needsLights=Fb(M),B.lightsStateVersion=gt,B.needsLights&&(At.ambientLightColor.value=O.state.ambient,At.lightProbe.value=O.state.probe,At.directionalLights.value=O.state.directional,At.directionalLightShadows.value=O.state.directionalShadow,At.spotLights.value=O.state.spot,At.spotLightShadows.value=O.state.spotShadow,At.rectAreaLights.value=O.state.rectArea,At.ltc_1.value=O.state.rectAreaLTC1,At.ltc_2.value=O.state.rectAreaLTC2,At.pointLights.value=O.state.point,At.pointLightShadows.value=O.state.pointShadow,At.hemisphereLights.value=O.state.hemi,At.directionalShadowMatrix.value=O.state.directionalShadowMatrix,At.spotLightMatrix.value=O.state.spotLightMatrix,At.spotLightMap.value=O.state.spotLightMap,At.pointShadowMatrix.value=O.state.pointShadowMatrix),B.currentProgram=Gt,B.uniformsList=null,Gt}function s0(M){if(M.uniformsList===null){let L=M.currentProgram.getUniforms();M.uniformsList=So.seqWithValue(L.seq,M.uniforms)}return M.uniformsList}function a0(M,L){let k=y.get(M);k.outputColorSpace=L.outputColorSpace,k.batching=L.batching,k.batchingColor=L.batchingColor,k.instancing=L.instancing,k.instancingColor=L.instancingColor,k.instancingMorph=L.instancingMorph,k.skinning=L.skinning,k.morphTargets=L.morphTargets,k.morphNormals=L.morphNormals,k.morphColors=L.morphColors,k.morphTargetsCount=L.morphTargetsCount,k.numClippingPlanes=L.numClippingPlanes,k.numIntersection=L.numClipIntersection,k.vertexAlphas=L.vertexAlphas,k.vertexTangents=L.vertexTangents,k.toneMapping=L.toneMapping}function Pb(M,L,k,B,O){L.isScene!==!0&&(L=ie),N.resetTextureUnits();let ut=L.fog,gt=B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial?L.environment:null,ht=V===null?E.outputColorSpace:V.isXRRenderTarget===!0?V.texture.colorSpace:qa,bt=B.isMeshStandardMaterial||B.isMeshLambertMaterial&&!B.envMap||B.isMeshPhongMaterial&&!B.envMap,Tt=Y.get(B.envMap||gt,bt),Pt=B.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,Gt=!!k.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),At=!!k.morphAttributes.position,ue=!!k.morphAttributes.normal,Pe=!!k.morphAttributes.color,De=_i;B.toneMapped&&(V===null||V.isXRRenderTarget===!0)&&(De=E.toneMapping);let he=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,un=he!==void 0?he.length:0,Et=y.get(B),Dn=T.state.lights;if(Q===!0&&(ft===!0||M!==G)){let je=M===G&&B.id===X;it.setState(B,M,je)}let Qt=!1;B.version===Et.__version?(Et.needsLights&&Et.lightsStateVersion!==Dn.state.version||Et.outputColorSpace!==ht||O.isBatchedMesh&&Et.batching===!1||!O.isBatchedMesh&&Et.batching===!0||O.isBatchedMesh&&Et.batchingColor===!0&&O.colorTexture===null||O.isBatchedMesh&&Et.batchingColor===!1&&O.colorTexture!==null||O.isInstancedMesh&&Et.instancing===!1||!O.isInstancedMesh&&Et.instancing===!0||O.isSkinnedMesh&&Et.skinning===!1||!O.isSkinnedMesh&&Et.skinning===!0||O.isInstancedMesh&&Et.instancingColor===!0&&O.instanceColor===null||O.isInstancedMesh&&Et.instancingColor===!1&&O.instanceColor!==null||O.isInstancedMesh&&Et.instancingMorph===!0&&O.morphTexture===null||O.isInstancedMesh&&Et.instancingMorph===!1&&O.morphTexture!==null||Et.envMap!==Tt||B.fog===!0&&Et.fog!==ut||Et.numClippingPlanes!==void 0&&(Et.numClippingPlanes!==it.numPlanes||Et.numIntersection!==it.numIntersection)||Et.vertexAlphas!==Pt||Et.vertexTangents!==Gt||Et.morphTargets!==At||Et.morphNormals!==ue||Et.morphColors!==Pe||Et.toneMapping!==De||Et.morphTargetsCount!==un)&&(Qt=!0):(Qt=!0,Et.__version=B.version);let li=Et.currentProgram;Qt===!0&&(li=lc(B,L,O));let Si=!1,_a=!1,$a=!1,pe=li.getUniforms(),en=Et.uniforms;if(Mt.useProgram(li.program)&&(Si=!0,_a=!0,$a=!0),B.id!==X&&(X=B.id,_a=!0),Si||G!==M){Mt.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),pe.setValue(D,"projectionMatrix",M.projectionMatrix),pe.setValue(D,"viewMatrix",M.matrixWorldInverse);let xs=pe.map.cameraPosition;xs!==void 0&&xs.setValue(D,Yt.setFromMatrixPosition(M.matrixWorld)),_e.logarithmicDepthBuffer&&pe.setValue(D,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&pe.setValue(D,"isOrthographic",M.isOrthographicCamera===!0),G!==M&&(G=M,_a=!0,$a=!0)}if(Et.needsLights&&(Dn.state.directionalShadowMap.length>0&&pe.setValue(D,"directionalShadowMap",Dn.state.directionalShadowMap,N),Dn.state.spotShadowMap.length>0&&pe.setValue(D,"spotShadowMap",Dn.state.spotShadowMap,N),Dn.state.pointShadowMap.length>0&&pe.setValue(D,"pointShadowMap",Dn.state.pointShadowMap,N)),O.isSkinnedMesh){pe.setOptional(D,O,"bindMatrix"),pe.setOptional(D,O,"bindMatrixInverse");let je=O.skeleton;je&&(je.boneTexture===null&&je.computeBoneTexture(),pe.setValue(D,"boneTexture",je.boneTexture,N))}O.isBatchedMesh&&(pe.setOptional(D,O,"batchingTexture"),pe.setValue(D,"batchingTexture",O._matricesTexture,N),pe.setOptional(D,O,"batchingIdTexture"),pe.setValue(D,"batchingIdTexture",O._indirectTexture,N),pe.setOptional(D,O,"batchingColorTexture"),O._colorsTexture!==null&&pe.setValue(D,"batchingColorTexture",O._colorsTexture,N));let ys=k.morphAttributes;if((ys.position!==void 0||ys.normal!==void 0||ys.color!==void 0)&&pt.update(O,k,li),(_a||Et.receiveShadow!==O.receiveShadow)&&(Et.receiveShadow=O.receiveShadow,pe.setValue(D,"receiveShadow",O.receiveShadow)),(B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial)&&B.envMap===null&&L.environment!==null&&(en.envMapIntensity.value=L.environmentIntensity),en.dfgLUT!==void 0&&(en.dfgLUT.value=i2()),_a&&(pe.setValue(D,"toneMappingExposure",E.toneMappingExposure),Et.needsLights&&Bb(en,$a),ut&&B.fog===!0&&wt.refreshFogUniforms(en,ut),wt.refreshMaterialUniforms(en,B,Nt,dt,T.state.transmissionRenderTarget[M.id]),So.upload(D,s0(Et),en,N)),B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(So.upload(D,s0(Et),en,N),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&pe.setValue(D,"center",O.center),pe.setValue(D,"modelViewMatrix",O.modelViewMatrix),pe.setValue(D,"normalMatrix",O.normalMatrix),pe.setValue(D,"modelMatrix",O.matrixWorld),B.isShaderMaterial||B.isRawShaderMaterial){let je=B.uniformsGroups;for(let xs=0,tr=je.length;xs<tr;xs++){let r0=je[xs];vt.update(r0,li),vt.bind(r0,li)}}return li}function Bb(M,L){M.ambientLightColor.needsUpdate=L,M.lightProbe.needsUpdate=L,M.directionalLights.needsUpdate=L,M.directionalLightShadows.needsUpdate=L,M.pointLights.needsUpdate=L,M.pointLightShadows.needsUpdate=L,M.spotLights.needsUpdate=L,M.spotLightShadows.needsUpdate=L,M.rectAreaLights.needsUpdate=L,M.hemisphereLights.needsUpdate=L}function Fb(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return R},this.getActiveMipmapLevel=function(){return F},this.getRenderTarget=function(){return V},this.setRenderTargetTextures=function(M,L,k){let B=y.get(M);B.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),y.get(M.texture).__webglTexture=L,y.get(M.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:k,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,L){let k=y.get(M);k.__webglFramebuffer=L,k.__useDefaultFramebuffer=L===void 0};let zb=D.createFramebuffer();this.setRenderTarget=function(M,L=0,k=0){V=M,R=L,F=k;let B=null,O=!1,ut=!1;if(M){let ht=y.get(M);if(ht.__useDefaultFramebuffer!==void 0){Mt.bindFramebuffer(D.FRAMEBUFFER,ht.__webglFramebuffer),z.copy(M.viewport),P.copy(M.scissor),et=M.scissorTest,Mt.viewport(z),Mt.scissor(P),Mt.setScissorTest(et),X=-1;return}else if(ht.__webglFramebuffer===void 0)N.setupRenderTarget(M);else if(ht.__hasExternalTextures)N.rebindTextures(M,y.get(M.texture).__webglTexture,y.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){let Pt=M.depthTexture;if(ht.__boundDepthTexture!==Pt){if(Pt!==null&&y.has(Pt)&&(M.width!==Pt.image.width||M.height!==Pt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");N.setupDepthRenderbuffer(M)}}let bt=M.texture;(bt.isData3DTexture||bt.isDataArrayTexture||bt.isCompressedArrayTexture)&&(ut=!0);let Tt=y.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Tt[L])?B=Tt[L][k]:B=Tt[L],O=!0):M.samples>0&&N.useMultisampledRTT(M)===!1?B=y.get(M).__webglMultisampledFramebuffer:Array.isArray(Tt)?B=Tt[k]:B=Tt,z.copy(M.viewport),P.copy(M.scissor),et=M.scissorTest}else z.copy(Z).multiplyScalar(Nt).floor(),P.copy(nt).multiplyScalar(Nt).floor(),et=at;if(k!==0&&(B=zb),Mt.bindFramebuffer(D.FRAMEBUFFER,B)&&Mt.drawBuffers(M,B),Mt.viewport(z),Mt.scissor(P),Mt.setScissorTest(et),O){let ht=y.get(M.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+L,ht.__webglTexture,k)}else if(ut){let ht=L;for(let bt=0;bt<M.textures.length;bt++){let Tt=y.get(M.textures[bt]);D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0+bt,Tt.__webglTexture,k,ht)}}else if(M!==null&&k!==0){let ht=y.get(M.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,ht.__webglTexture,k)}X=-1},this.readRenderTargetPixels=function(M,L,k,B,O,ut,gt,ht=0){if(!(M&&M.isWebGLRenderTarget)){Dt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let bt=y.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&gt!==void 0&&(bt=bt[gt]),bt){Mt.bindFramebuffer(D.FRAMEBUFFER,bt);try{let Tt=M.textures[ht],Pt=Tt.format,Gt=Tt.type;if(M.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+ht),!_e.textureFormatReadable(Pt)){Dt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!_e.textureTypeReadable(Gt)){Dt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=M.width-B&&k>=0&&k<=M.height-O&&D.readPixels(L,k,B,O,ot.convert(Pt),ot.convert(Gt),ut)}finally{let Tt=V!==null?y.get(V).__webglFramebuffer:null;Mt.bindFramebuffer(D.FRAMEBUFFER,Tt)}}},this.readRenderTargetPixelsAsync=async function(M,L,k,B,O,ut,gt,ht=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let bt=y.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&gt!==void 0&&(bt=bt[gt]),bt)if(L>=0&&L<=M.width-B&&k>=0&&k<=M.height-O){Mt.bindFramebuffer(D.FRAMEBUFFER,bt);let Tt=M.textures[ht],Pt=Tt.format,Gt=Tt.type;if(M.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+ht),!_e.textureFormatReadable(Pt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!_e.textureTypeReadable(Gt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let At=D.createBuffer();D.bindBuffer(D.PIXEL_PACK_BUFFER,At),D.bufferData(D.PIXEL_PACK_BUFFER,ut.byteLength,D.STREAM_READ),D.readPixels(L,k,B,O,ot.convert(Pt),ot.convert(Gt),0);let ue=V!==null?y.get(V).__webglFramebuffer:null;Mt.bindFramebuffer(D.FRAMEBUFFER,ue);let Pe=D.fenceSync(D.SYNC_GPU_COMMANDS_COMPLETE,0);return D.flush(),await KS(D,Pe,4),D.bindBuffer(D.PIXEL_PACK_BUFFER,At),D.getBufferSubData(D.PIXEL_PACK_BUFFER,0,ut),D.deleteBuffer(At),D.deleteSync(Pe),ut}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,L=null,k=0){let B=Math.pow(2,-k),O=Math.floor(M.image.width*B),ut=Math.floor(M.image.height*B),gt=L!==null?L.x:0,ht=L!==null?L.y:0;N.setTexture2D(M,0),D.copyTexSubImage2D(D.TEXTURE_2D,k,0,0,gt,ht,O,ut),Mt.unbindTexture()};let Vb=D.createFramebuffer(),Hb=D.createFramebuffer();this.copyTextureToTexture=function(M,L,k=null,B=null,O=0,ut=0){let gt,ht,bt,Tt,Pt,Gt,At,ue,Pe,De=M.isCompressedTexture?M.mipmaps[ut]:M.image;if(k!==null)gt=k.max.x-k.min.x,ht=k.max.y-k.min.y,bt=k.isBox3?k.max.z-k.min.z:1,Tt=k.min.x,Pt=k.min.y,Gt=k.isBox3?k.min.z:0;else{let en=Math.pow(2,-O);gt=Math.floor(De.width*en),ht=Math.floor(De.height*en),M.isDataArrayTexture?bt=De.depth:M.isData3DTexture?bt=Math.floor(De.depth*en):bt=1,Tt=0,Pt=0,Gt=0}B!==null?(At=B.x,ue=B.y,Pe=B.z):(At=0,ue=0,Pe=0);let he=ot.convert(L.format),un=ot.convert(L.type),Et;L.isData3DTexture?(N.setTexture3D(L,0),Et=D.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(N.setTexture2DArray(L,0),Et=D.TEXTURE_2D_ARRAY):(N.setTexture2D(L,0),Et=D.TEXTURE_2D),D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,L.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,L.unpackAlignment);let Dn=D.getParameter(D.UNPACK_ROW_LENGTH),Qt=D.getParameter(D.UNPACK_IMAGE_HEIGHT),li=D.getParameter(D.UNPACK_SKIP_PIXELS),Si=D.getParameter(D.UNPACK_SKIP_ROWS),_a=D.getParameter(D.UNPACK_SKIP_IMAGES);D.pixelStorei(D.UNPACK_ROW_LENGTH,De.width),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,De.height),D.pixelStorei(D.UNPACK_SKIP_PIXELS,Tt),D.pixelStorei(D.UNPACK_SKIP_ROWS,Pt),D.pixelStorei(D.UNPACK_SKIP_IMAGES,Gt);let $a=M.isDataArrayTexture||M.isData3DTexture,pe=L.isDataArrayTexture||L.isData3DTexture;if(M.isDepthTexture){let en=y.get(M),ys=y.get(L),je=y.get(en.__renderTarget),xs=y.get(ys.__renderTarget);Mt.bindFramebuffer(D.READ_FRAMEBUFFER,je.__webglFramebuffer),Mt.bindFramebuffer(D.DRAW_FRAMEBUFFER,xs.__webglFramebuffer);for(let tr=0;tr<bt;tr++)$a&&(D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,y.get(M).__webglTexture,O,Gt+tr),D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,y.get(L).__webglTexture,ut,Pe+tr)),D.blitFramebuffer(Tt,Pt,gt,ht,At,ue,gt,ht,D.DEPTH_BUFFER_BIT,D.NEAREST);Mt.bindFramebuffer(D.READ_FRAMEBUFFER,null),Mt.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else if(O!==0||M.isRenderTargetTexture||y.has(M)){let en=y.get(M),ys=y.get(L);Mt.bindFramebuffer(D.READ_FRAMEBUFFER,Vb),Mt.bindFramebuffer(D.DRAW_FRAMEBUFFER,Hb);for(let je=0;je<bt;je++)$a?D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,en.__webglTexture,O,Gt+je):D.framebufferTexture2D(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,en.__webglTexture,O),pe?D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,ys.__webglTexture,ut,Pe+je):D.framebufferTexture2D(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,ys.__webglTexture,ut),O!==0?D.blitFramebuffer(Tt,Pt,gt,ht,At,ue,gt,ht,D.COLOR_BUFFER_BIT,D.NEAREST):pe?D.copyTexSubImage3D(Et,ut,At,ue,Pe+je,Tt,Pt,gt,ht):D.copyTexSubImage2D(Et,ut,At,ue,Tt,Pt,gt,ht);Mt.bindFramebuffer(D.READ_FRAMEBUFFER,null),Mt.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else pe?M.isDataTexture||M.isData3DTexture?D.texSubImage3D(Et,ut,At,ue,Pe,gt,ht,bt,he,un,De.data):L.isCompressedArrayTexture?D.compressedTexSubImage3D(Et,ut,At,ue,Pe,gt,ht,bt,he,De.data):D.texSubImage3D(Et,ut,At,ue,Pe,gt,ht,bt,he,un,De):M.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,ut,At,ue,gt,ht,he,un,De.data):M.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,ut,At,ue,De.width,De.height,he,De.data):D.texSubImage2D(D.TEXTURE_2D,ut,At,ue,gt,ht,he,un,De);D.pixelStorei(D.UNPACK_ROW_LENGTH,Dn),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,Qt),D.pixelStorei(D.UNPACK_SKIP_PIXELS,li),D.pixelStorei(D.UNPACK_SKIP_ROWS,Si),D.pixelStorei(D.UNPACK_SKIP_IMAGES,_a),ut===0&&L.generateMipmaps&&D.generateMipmap(Et),Mt.unbindTexture()},this.initRenderTarget=function(M){y.get(M).__webglFramebuffer===void 0&&N.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?N.setTextureCube(M,0):M.isData3DTexture?N.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?N.setTexture2DArray(M,0):N.setTexture2D(M,0),Mt.unbindTexture()},this.resetState=function(){R=0,F=0,V=null,Mt.reset(),st.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return mi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let n=this.getContext();n.drawingBufferColorSpace=Kt._getDrawingBufferColorSpace(t),n.unpackColorSpace=Kt._getUnpackColorSpace()}};var Bd=Ss(rc()),o2="/assets/pynqcast-white.png",Zg=class extends fo{constructor(){super();let t=new ge;t.deleteAttribute("uv");let n=new jt(t,[new xn({color:8947848,side:Ie}),new xn({color:8947848,side:Ie}),new xn({color:16777215,side:Ie}),new xn({color:4473924,side:Ie}),new xn({color:8947848,side:Ie}),new xn({color:8947848,side:Ie})]);n.scale.setScalar(10),this.add(n);let i=new vi(16729088,2,20);i.position.set(5,5,5),this.add(i);let s=new vi(17663,1,20);s.position.set(-5,5,-5),this.add(s);let a=new vi(16777215,1,20);a.position.set(0,10,0),this.add(a)}};function l2({hostSlot:e}){let t=(0,ma.useRef)(null),n=(0,ma.useRef)(null);return(0,ma.useEffect)(()=>{let i=t.current,s=n.current,a=e?.closest(".about-sprite-wrap");if(!i||!s||!a)return()=>{};a.classList.add("board-ready");let r=Math.max(420,Math.round(i.clientWidth||620)),o=Math.max(360,Math.round(i.clientHeight||360)),l=new Ld({antialias:!1,alpha:!0});l.setSize(Math.floor(r/4),Math.floor(o/4)),l.domElement.style.width=`${r}px`,l.domElement.style.height=`${o}px`,l.domElement.style.imageRendering="pixelated",l.setClearColor(0,0),l.toneMapping=Jl,l.toneMappingExposure=1.2,l.setPixelRatio(1),l.outputColorSpace=pn,i.appendChild(l.domElement);let c=new bo(l);c.compileEquirectangularShader();let d=c.fromScene(new Zg).texture;c.dispose();let p=new fo;p.environment=d;let u=new ln(38,r/o,.1,100);u.position.set(0,.2,6.2),u.lookAt(0,0,0),p.add(new ql(3342336,8));let f=new vi(12260608,600,16),v=new vi(16777215,400,7),b=new vi(16772829,300,6),g=new vi(1127338,150,10);f.position.set(2.5,1.8,3),v.position.set(1,1.5,2.5),b.position.set(-1.6,1.1,2),g.position.set(-2.4,1.6,-2.8),p.add(f),p.add(v),p.add(b),p.add(g);let h=new xn({color:4523014,metalness:.85,roughness:.08,emissive:new kt("#120002"),emissiveIntensity:.38,envMapIntensity:1.8}),m=new xn({color:2752514,metalness:.8,roughness:.15,envMapIntensity:1.2}),_=new xn({color:16758784,metalness:1,roughness:.04,emissive:new kt("#221100"),emissiveIntensity:.15,envMapIntensity:2.5}),S=new xn({color:65348,emissive:new kt("#00ff44"),emissiveIntensity:.8,metalness:0,roughness:.5}),T=new ps;T.scale.setScalar(1.22),p.add(T);let C=new jt(new ge(3.55,2.3,.16),m);T.add(C);let w=new jt(new ge(3.35,2.1,.11),h);w.position.z=.03,T.add(w);let x=new jt(new ge(3.35,2.1,.11),h);x.position.z=-.03,T.add(x);let E=(Q,ft,Ce,Yt,te=.012)=>{let ie=new jt(new ge(Ce,Yt,te),_);ie.position.set(Q,ft,.09),T.add(ie)};E(-.3,.55,.9,.04),E(.4,.55,.9,.04),E(-.3,-.35,.04,.8),E(-.85,.1,.7,.04),E(.3,.1,.8,.04),E(0,-.55,1.6,.04),E(-1.1,.1,.04,1.2),E(1.1,.1,.04,1),E(-.3,-.1,.04,.5),E(.6,-.2,.6,.04);let I=new jt(new ge(.85,.85,.12),m);I.position.set(-.3,.1,.14),T.add(I);let R=new jt(new ge(.75,.75,.03),h);R.position.set(-.3,.1,.21),T.add(R);let F=new jt(new ge(.55,.38,.08),m);F.position.set(.95,.55,.12),T.add(F);for(let Q=0;Q<3;Q++){let ft=new jt(new ge(.18,.22,.1),m);ft.position.set(-1.2+Q*.26,-.7,.13),T.add(ft)}let V=new jt(new ge(.22,.18,.2),m);V.position.set(1.6,.2,.14),T.add(V);let X=new jt(new ge(.28,.16,.18),m);X.position.set(1.6,-.15,.14),T.add(X);let G=new jt(new ge(.24,.22,.22),m);G.position.set(1.6,.6,.14),T.add(G);for(let Q=0;Q<2;Q++){let ft=new jt(new ge(.14,.48,.1),m);ft.position.set(-1.6,.3-Q*.6,.12),T.add(ft)}let z=new jt(new ge(1.8,.1,.08),m);z.position.set(.1,1.08,.12),T.add(z);let P=new jt(new ge(.22,.22,.24),m);P.position.set(-1.45,-.95,.16),T.add(P);let et=new jt(new ge(.32,.18,.1),_);et.position.set(.9,-1.02,.1),T.add(et);for(let Q=0;Q<4;Q++){let ft=new jt(new ge(.06,.06,.05),S);ft.position.set(.3+Q*.12,.75,.18),T.add(ft)}for(let Q=0;Q<2;Q++){let ft=new jt(new ge(.1,.1,.08),m);ft.position.set(.55+Q*.18,-.55,.14),T.add(ft)}for(let Q=0;Q<14;Q++){let ft=new jt(new ge(.06,.06,.12),_);ft.position.set(-1.1+Q*.18,1.1,.1),T.add(ft);let Ce=ft.clone();Ce.position.y=1.18,T.add(Ce)}for(let Q=0;Q<18;Q++){let ft=new jt(new ge(.055,.18,.04),_);ft.position.set(-1.28+Q*.145,-1.08,.06),T.add(ft)}let lt=new Gl().load(o2,()=>{lt.magFilter=ze,lt.minFilter=ze,lt.generateMipmaps=!1,lt.colorSpace=pn,lt.needsUpdate=!0}),mt=new xn({map:lt,color:16777215,metalness:.18,roughness:.36,emissive:new kt("#220000"),emissiveIntensity:.2,transparent:!0,alphaTest:.08}),dt=new jt(new oa(2.7,1.52),mt);dt.position.set(.02,.1,.106),T.add(dt);let Nt=new jt(new oa(3.02,1.7),mt);Nt.position.set(.02,.1,-.106),Nt.rotation.y=Math.PI,T.add(Nt);let ve=[h,m,_,S,mt],ce=[C.geometry,w.geometry,x.geometry,dt.geometry,Nt.geometry],Z=[C,w,x,dt,Nt];T.children.forEach(Q=>{Z.includes(Q)||ce.push(Q.geometry)});let nt=0,at=new Yl,Lt=()=>{let Q=at.getElapsedTime(),ft=(Math.sin(Q*1.4)+1)/2;T.rotation.y=Q*1.1,T.rotation.x=.25+Math.sin(Q*.5)*.08,T.rotation.z=Math.sin(Q*.7)*.06,T.position.y=Math.sin(Q*1.4)*.18,f.position.x=Math.cos(Q*.6)*4,f.position.z=Math.sin(Q*.6)*4+2,v.position.x=Math.cos(Q*2.2)*2.5,v.position.y=Math.sin(Q*1.6)*2,v.position.z=2.5,b.position.x=Math.cos(Q*1.8+Math.PI)*2,b.position.y=Math.sin(Q*2.1+Math.PI)*1.5,b.position.z=2,s.style.transform=`translateX(-50%) scaleX(${(.88+ft*.28).toFixed(3)}) scaleY(${(.7+ft*.3).toFixed(3)})`,s.style.opacity=(.4+ft*.45).toFixed(3),l.render(p,u),nt=requestAnimationFrame(Lt)};return Lt(),()=>{a.classList.remove("board-ready"),cancelAnimationFrame(nt),lt.dispose(),d.dispose(),ve.forEach(Q=>Q.dispose()),ce.forEach(Q=>Q?.dispose()),l.dispose(),i&&l.domElement.parentNode===i&&i.removeChild(l.domElement)}},[e]),(0,Bd.jsx)("div",{ref:t,style:{width:"100%",height:360,position:"relative"},children:(0,Bd.jsx)("div",{ref:n,style:{position:"absolute",bottom:12,left:"50%",width:240,height:22,background:"radial-gradient(ellipse at center, rgba(180,20,20,0.6) 0%, transparent 70%)",pointerEvents:"none",transformOrigin:"center center"}})})}function Jg({hostRef:e}){let[t,n]=(0,ma.useState)(null);return(0,ma.useEffect)(()=>{let i=e?.current?.querySelector(".about-react-board-slot");n(i||null)},[e]),t?(0,Nb.createPortal)((0,Bd.jsx)(l2,{hostSlot:t}),t):null}var jg={pynq:`<div class="app-shell">
  <header class="topbar">

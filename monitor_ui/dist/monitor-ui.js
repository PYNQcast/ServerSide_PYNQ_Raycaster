...
</div>`};var Es=Kn(rr()),a0=["/monitor-state.js","/monitor-render.js","/monitor-app.js"];function I2(){if(window.__monitorLegacyBootstrapped)return;window.__monitorLegacyBootstrapped=!0;let e=t=>{if(t>=a0.length){window.dispatchEvent(new Event("monitor:legacy-ready"));return}let n=document.createElement("script");n.src=a0[t],n.async=!1,n.onload=()=>e(t+1),n.onerror=()=>{console.error(`[monitor-ui] failed to load legacy script: ${a0[t]}`)},document.body.appendChild(n)};e(0)}function O2({mode:e}){let t=(0,or.useRef)(null),[n,i]=(0,or.useState)(null);return(0,or.useEffect)(()=>{I2()},[]),(0,or.useEffect)(()=>{i(t.current?.querySelector("#player-stats-react-slot")||null)},[]),(0,Es.jsxs)(Es.Fragment,{children:[(0,Es.jsx)("div",{ref:t,className:"react-monitor-root",dangerouslySetInnerHTML:{__html:s0[e]||s0.pynq}}),(0,Es.jsx)(t0,{hostRef:t}),n?(0,qb.createPortal)((0,Es.jsx)(i0,{}),n):null]})}var P2=window.__MONITOR_MODE__==="sim"?"sim":"pynq",Yb=document.getElementById("root");if(!Yb)throw new Error("Missing #root for monitor React mount");(0,Wb.createRoot)(Yb).render((0,Es.jsx)(O2,{mode:P2}));})();

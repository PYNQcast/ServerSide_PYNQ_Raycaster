...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Fi,depthTest:!1,depthWrite:!1})}function SC(e,t,n){let i=new Float32Array(Ka),s=new V(0,1,0);return new Wn({name:"SphericalGaussianBlur",defines:{n:Ka,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Wd(),fragmentShader:`
